...
/// Also all the fields of the component parameter name must be lowercase name with low dash for multiple words to santisfy blazor custom elements conventions.
