...
type authorizeViewCore<'FunBlazorGeneric> =
    ...
    static member inline create (nodes: FunBlazorNode list) = nodes |> html.blazor<Microsoft.AspNetCore.Components.Authorization.AuthorizeViewCore>
    static member inline create (node: FunBlazorNode) = [ node ] |> html.blazor<Microsoft.AspNetCore.Components.Authorization.AuthorizeViewCore>
    ...
    static member inline childContent (render: Microsoft.AspNetCore.Components.Authorization.AuthenticationState -> FunBlazorNode) = Bolero.Html.attr.fragmentWith "ChildContent" (fun x -> render x |> html.toBolero) |> BoleroAttr |> GenericFunBlazorNode<'FunBlazorGeneric>.create
    static member inline notAuthorized (render: Microsoft.AspNetCore.Components.Authorization.AuthenticationState -> FunBlazorNode) = Bolero.Html.attr.fragmentWith "NotAuthorized" (fun x -> render x |> html.toBolero) |> BoleroAttr |> GenericFunBlazorNode<'FunBlazorGeneric>.create
    static member inline authorized (render: Microsoft.AspNetCore.Components.Authorization.AuthenticationState -> FunBlazorNode) = Bolero.Html.attr.fragmentWith "Authorized" (fun x -> render x |> html.toBolero) |> BoleroAttr |> GenericFunBlazorNode<'FunBlazorGeneric>.create
...
type authorizeView<'FunBlazorGeneric> =
    ...
    static member inline create (nodes: FunBlazorNode list) = nodes |> html.blazor<Microsoft.AspNetCore.Components.Authorization.AuthorizeView>
    static member inline create (node: FunBlazorNode) = [ node ] |> html.blazor<Microsoft.AspNetCore.Components.Authorization.AuthorizeView>
...
type cascadingAuthenticationState<'FunBlazorGeneric> =
    ...
    static member inline create (nodes: FunBlazorNode list) = nodes |> html.blazor<Microsoft.AspNetCore.Components.Authorization.CascadingAuthenticationState>
    static member inline create (node: FunBlazorNode) = [ node ] |> html.blazor<Microsoft.AspNetCore.Components.Authorization.CascadingAuthenticationState>
