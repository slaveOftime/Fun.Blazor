...
type NoticeListBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnClear")>] member _.OnClear (render: AttrRenderFragment, fn) = render ==> html.callback("OnClear", fn)
    [<CustomOperation("OnClear")>] member _.OnClear (render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnClear", fn)
    [<CustomOperation("OnViewMore")>] member _.OnViewMore (render: AttrRenderFragment, fn) = render ==> html.callback("OnViewMore", fn)
    [<CustomOperation("OnViewMore")>] member _.OnViewMore (render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnViewMore", fn)
