...
type AntProComponentBaseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("FooterRender")>] member inline _.FooterRender ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render >>> html.renderChild("FooterRender", fragment)
    [<CustomOperation("FooterRender")>] member inline _.FooterRender ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render >>> html.renderChild("FooterRender", fragment { yield! fragments })
    [<CustomOperation("FooterRender")>] member inline _.FooterRender ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render >>> html.renderChild("FooterRender", html.text x)
    [<CustomOperation("FooterRender")>] member inline _.FooterRender ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render >>> html.renderChild("FooterRender", html.text x)
    [<CustomOperation("FooterRender")>] member inline _.FooterRender ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("FooterRender", html.text x)
...
type BasicLayoutBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("MenuExtraRender")>] member inline _.MenuExtraRender ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render >>> html.renderChild("MenuExtraRender", fragment)
    [<CustomOperation("MenuExtraRender")>] member inline _.MenuExtraRender ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render >>> html.renderChild("MenuExtraRender", fragment { yield! fragments })
    [<CustomOperation("MenuExtraRender")>] member inline _.MenuExtraRender ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render >>> html.renderChild("MenuExtraRender", html.text x)
    [<CustomOperation("MenuExtraRender")>] member inline _.MenuExtraRender ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render >>> html.renderChild("MenuExtraRender", html.text x)
    [<CustomOperation("MenuExtraRender")>] member inline _.MenuExtraRender ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("MenuExtraRender", html.text x)
    ...
    [<CustomOperation("RightContentRender")>] member inline _.RightContentRender ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render >>> html.renderChild("RightContentRender", fragment)
    [<CustomOperation("RightContentRender")>] member inline _.RightContentRender ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render >>> html.renderChild("RightContentRender", fragment { yield! fragments })
    [<CustomOperation("RightContentRender")>] member inline _.RightContentRender ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render >>> html.renderChild("RightContentRender", html.text x)
    [<CustomOperation("RightContentRender")>] member inline _.RightContentRender ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render >>> html.renderChild("RightContentRender", html.text x)
    [<CustomOperation("RightContentRender")>] member inline _.RightContentRender ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("RightContentRender", html.text x)
...
type GlobalHeaderBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnCollapse")>] member inline _.OnCollapse ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnCollapse", fn)
    [<CustomOperation("CollapsedButtonRender")>] member inline _.CollapsedButtonRender ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render >>> html.renderChild("CollapsedButtonRender", fragment)
    [<CustomOperation("CollapsedButtonRender")>] member inline _.CollapsedButtonRender ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render >>> html.renderChild("CollapsedButtonRender", fragment { yield! fragments })
    [<CustomOperation("CollapsedButtonRender")>] member inline _.CollapsedButtonRender ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render >>> html.renderChild("CollapsedButtonRender", html.text x)
    [<CustomOperation("CollapsedButtonRender")>] member inline _.CollapsedButtonRender ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render >>> html.renderChild("CollapsedButtonRender", html.text x)
    [<CustomOperation("CollapsedButtonRender")>] member inline _.CollapsedButtonRender ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("CollapsedButtonRender", html.text x)
    [<CustomOperation("Collapsed")>] member inline _.Collapsed ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Collapsed" => x)
    [<CustomOperation("IsMobile")>] member inline _.IsMobile ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsMobile" => x)
    [<CustomOperation("Logo")>] member inline _.Logo ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<System.String, Microsoft.AspNetCore.Components.RenderFragment>) = render ==> ("Logo" => x)
...
type HeaderViewBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("SiderWidth")>] member inline _.SiderWidth ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("SiderWidth" => x)
    [<CustomOperation("HeaderContentRender")>] member inline _.HeaderContentRender ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render >>> html.renderChild("HeaderContentRender", fragment)
    [<CustomOperation("HeaderContentRender")>] member inline _.HeaderContentRender ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render >>> html.renderChild("HeaderContentRender", fragment { yield! fragments })
    [<CustomOperation("HeaderContentRender")>] member inline _.HeaderContentRender ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render >>> html.renderChild("HeaderContentRender", html.text x)
    [<CustomOperation("HeaderContentRender")>] member inline _.HeaderContentRender ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render >>> html.renderChild("HeaderContentRender", html.text x)
    [<CustomOperation("HeaderContentRender")>] member inline _.HeaderContentRender ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("HeaderContentRender", html.text x)
    [<CustomOperation("MenuData")>] member inline _.MenuData ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ProLayout.MenuDataItem[]) = render ==> ("MenuData" => x)
...
type GlobalFooterBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Copyright")>] member inline _.Copyright ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render >>> html.renderChild("Copyright", fragment)
    [<CustomOperation("Copyright")>] member inline _.Copyright ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render >>> html.renderChild("Copyright", fragment { yield! fragments })
    [<CustomOperation("Copyright")>] member inline _.Copyright ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render >>> html.renderChild("Copyright", html.text x)
    [<CustomOperation("Copyright")>] member inline _.Copyright ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render >>> html.renderChild("Copyright", html.text x)
    [<CustomOperation("Copyright")>] member inline _.Copyright ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("Copyright", html.text x)
    [<CustomOperation("Links")>] member inline _.Links ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ProLayout.LinkItem[]) = render ==> ("Links" => x)
...
type PageContainerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Extra")>] member inline _.Extra ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render >>> html.renderChild("Extra", fragment)
    [<CustomOperation("Extra")>] member inline _.Extra ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render >>> html.renderChild("Extra", fragment { yield! fragments })
    [<CustomOperation("Extra")>] member inline _.Extra ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render >>> html.renderChild("Extra", html.text x)
    [<CustomOperation("Extra")>] member inline _.Extra ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render >>> html.renderChild("Extra", html.text x)
    [<CustomOperation("Extra")>] member inline _.Extra ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("Extra", html.text x)
    [<CustomOperation("ExtraContent")>] member inline _.ExtraContent ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render >>> html.renderChild("ExtraContent", fragment)
    [<CustomOperation("ExtraContent")>] member inline _.ExtraContent ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render >>> html.renderChild("ExtraContent", fragment { yield! fragments })
    [<CustomOperation("ExtraContent")>] member inline _.ExtraContent ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render >>> html.renderChild("ExtraContent", html.text x)
    [<CustomOperation("ExtraContent")>] member inline _.ExtraContent ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render >>> html.renderChild("ExtraContent", html.text x)
    [<CustomOperation("ExtraContent")>] member inline _.ExtraContent ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("ExtraContent", html.text x)
    ...
    [<CustomOperation("childContent")>] member inline _.childContent ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("ChildContent", html.text x)
    [<CustomOperation("Title")>] member inline _.Title ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Title" => x)
    [<CustomOperation("Breadcrumb")>] member inline _.Breadcrumb ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render >>> html.renderChild("Breadcrumb", fragment)
    [<CustomOperation("Breadcrumb")>] member inline _.Breadcrumb ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render >>> html.renderChild("Breadcrumb", fragment { yield! fragments })
    [<CustomOperation("Breadcrumb")>] member inline _.Breadcrumb ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render >>> html.renderChild("Breadcrumb", html.text x)
    [<CustomOperation("Breadcrumb")>] member inline _.Breadcrumb ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render >>> html.renderChild("Breadcrumb", html.text x)
    [<CustomOperation("Breadcrumb")>] member inline _.Breadcrumb ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render >>> html.renderChild("Breadcrumb", html.text x)
