...
type fluentDesignSystemProvider<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentDesignSystemProvider>
...
type fluentInputBase<'FunBlazorGeneric, 'TValue> =
    ...
    static member inline create () = [] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentInputBase<'TValue>>
    static member inline create (nodes: GenericFunBlazorNode<'FunBlazorGeneric> list) = nodes |> List.map (fun x -> x.Node) |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentInputBase<'TValue>>

    static member inline ref x = attr.ref<Microsoft.Fast.Components.FluentUI.FluentInputBase<'TValue>> x |> GenericFunBlazorNode<'FunBlazorGeneric>.create
    static member inline additionalAttributes (x: System.Collections.Generic.IReadOnlyDictionary<System.String, System.Object>) = "AdditionalAttributes" => x |> BoleroAttr |> GenericFunBlazorNode<'FunBlazorGeneric>.create
...
type fluentCheckbox<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentCheckbox>
...
type fluentCombobox<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentCombobox>
...
type fluentRadioGroup<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentRadioGroup>
...
type fluentSelect<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentSelect>
...
type fluentSlider<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentSlider>
...
type fluentTextArea<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentTextArea>
...
type fluentTextField<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentTextField>
...
type fluentAccordion<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentAccordion>
...
type fluentAccordionItem<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentAccordionItem>
...
type fluentAnchor<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentAnchor>
...
type fluentBadge<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentBadge>
...
type fluentBreadcrumb<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentBreadcrumb>
...
type fluentBreadcrumbItem<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentBreadcrumbItem>
...
type fluentButton<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentButton>
...
type fluentCard<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentCard>
...
type fluentDialog<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentDialog>
...
type fluentDivider<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentDivider>
...
type fluentFlipper<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentFlipper>
...
type fluentListbox<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentListbox>
...
type fluentMenu<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentMenu>
...
type fluentMenuItem<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentMenuItem>
...
type fluentOption<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentOption>
...
type fluentProgress<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentProgress>
...
type fluentProgressRing<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentProgressRing>
...
type fluentRadio<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentRadio>
...
type fluentSkeleton<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentSkeleton>
...
type fluentSliderLabel<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentSliderLabel>
...
type fluentSwitch<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentSwitch>
...
type fluentTab<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentTab>
...
type fluentTabPanel<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentTabPanel>
...
type fluentTabs<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentTabs>
...
type fluentTreeItem<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentTreeItem>
...
type fluentTreeView<'FunBlazorGeneric> =
    ...
    static member inline create (x: string) = [ html.text x ] |> html.blazor<Microsoft.Fast.Components.FluentUI.FluentTreeView>
