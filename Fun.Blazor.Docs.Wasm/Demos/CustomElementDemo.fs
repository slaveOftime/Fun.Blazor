...
let entry = div {
    ...
    html.customElement<DemoCounter> (renderAfter = RenderAfter.Delay 3000, preRenderContainerAttrs = domAttr { style { backgroundColor "green" } })
    div { style { height "100vh" } }
    html.customElement<DemoCounter> (
