...
namespace rec Blazor.Diagrams.DslInternals.Components
...
type DiagramCanvasBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit ComponentWithDomAndChildAttrBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Widgets")>] member inline _.Widgets ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render ==> html.renderFragment("Widgets", fragment)
    [<CustomOperation("Widgets")>] member inline _.Widgets ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render ==> html.renderFragment("Widgets", fragment { yield! fragments })
    ...
    [<CustomOperation("AdditionalSvg")>] member inline _.AdditionalSvg ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render ==> html.renderFragment("AdditionalSvg", fragment)
    [<CustomOperation("AdditionalSvg")>] member inline _.AdditionalSvg ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render ==> html.renderFragment("AdditionalSvg", fragment { yield! fragments })
    ...
    [<CustomOperation("AdditionalHtml")>] member inline _.AdditionalHtml ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render ==> html.renderFragment("AdditionalHtml", fragment)
    [<CustomOperation("AdditionalHtml")>] member inline _.AdditionalHtml ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render ==> html.renderFragment("AdditionalHtml", fragment { yield! fragments })
...
namespace rec Blazor.Diagrams.DslInternals.Components.Widgets
...
type NavigatorWidgetBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit ComponentWithDomAndChildAttrBuilder<'FunBlazorGeneric>()
    [<CustomOperation("UseNodeShape")>] member inline _.UseNodeShape ([<InlineIfLambda>] render: AttrRenderFragment, ?x: bool) = render ==> ("UseNodeShape" => (defaultArg x true))
...
namespace rec Blazor.Diagrams.DslInternals.Components.Renderers
...
namespace rec Blazor.Diagrams.DslInternals.Components.Controls
...
type ControlsLayerRendererBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit ComponentWithDomAndChildAttrBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Svg")>] member inline _.Svg ([<InlineIfLambda>] render: AttrRenderFragment, ?x: bool) = render ==> ("Svg" => (defaultArg x true))
...
module DslCE =
    ...
    type _Imports' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof<Blazor.Diagrams._Imports>)>] () = inherit _ImportsBuilder<Blazor.Diagrams._Imports>()
...
module DslCE =
    ...
    open System.Diagnostics.CodeAnalysis
    open Blazor.Diagrams.DslInternals.Components
...
module DslCE =
    ...
    open System.Diagnostics.CodeAnalysis
    open Blazor.Diagrams.DslInternals.Components.Widgets
...
module DslCE =
    ...
    open System.Diagnostics.CodeAnalysis
    open Blazor.Diagrams.DslInternals.Components.Renderers
...
module DslCE =
    ...
    open System.Diagnostics.CodeAnalysis
    open Blazor.Diagrams.DslInternals.Components.Controls
