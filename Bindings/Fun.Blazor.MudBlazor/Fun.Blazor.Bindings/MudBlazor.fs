...
type MudTableBaseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("TableAttributes")>] member inline _.TableAttributes ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.Dictionary<System.String, System.Object>) = render ==> ("TableAttributes" => x)
    ...
    [<CustomOperation("PagerPosition")>] member inline _.PagerPosition ([<InlineIfLambda>] render: AttrRenderFragment, x: MudBlazor.PagerPosition) = render ==> ("PagerPosition" => x)
...
type MudTabsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("LazyLoadPanels")>] member inline _.LazyLoadPanels ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("LazyLoadPanels" =>>> true)
    [<CustomOperation("LazyLoadPanels")>] member inline _.LazyLoadPanels ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("LazyLoadPanels" =>>> x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
...
type MudBaseDatePickerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowAdjacentMonthDays")>] member inline _.ShowAdjacentMonthDays ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowAdjacentMonthDays" =>>> true)
    [<CustomOperation("ShowAdjacentMonthDays")>] member inline _.ShowAdjacentMonthDays ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowAdjacentMonthDays" =>>> x)
...
type FooterCellBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("GroupItems")>] member inline _.GroupItems ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.IEnumerable<'T>) = render ==> ("GroupItems" => x)
...
type MudDataGridBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("CellClick")>] member inline _.CellClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.DataGridCellClickEventArgs<'T> -> unit) = render ==> html.callback("CellClick", fn)
    [<CustomOperation("CellClick")>] member inline _.CellClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.DataGridCellClickEventArgs<'T> -> Task<unit>) = render ==> html.callbackTask("CellClick", fn)
    [<CustomOperation("CellContextMenuClick")>] member inline _.CellContextMenuClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.DataGridCellClickEventArgs<'T> -> unit) = render ==> html.callback("CellContextMenuClick", fn)
    [<CustomOperation("CellContextMenuClick")>] member inline _.CellContextMenuClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.DataGridCellClickEventArgs<'T> -> Task<unit>) = render ==> html.callbackTask("CellContextMenuClick", fn)
    ...
    [<CustomOperation("Comparer")>] member inline _.Comparer ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.IEqualityComparer<'T>) = render ==> ("Comparer" => x)
    [<CustomOperation("GroupTemplate")>] member inline _.GroupTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.GroupDefinition<'T> -> NodeRenderFragment) = render ==> html.renderFragment("GroupTemplate", fn)
    [<CustomOperation("ColumnReorderMode")>] member inline _.ColumnReorderMode ([<InlineIfLambda>] render: AttrRenderFragment, x: MudBlazor.DataGridDragAndDropColumnReorderMode) = render ==> ("ColumnReorderMode" => x)
    [<CustomOperation("AllowUnsorted")>] member inline _.AllowUnsorted ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AllowUnsorted" =>>> true)
    [<CustomOperation("AllowUnsorted")>] member inline _.AllowUnsorted ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AllowUnsorted" =>>> x)
...
type MudHotkeyBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnHotkeyPressed")>] member inline _.OnHotkeyPressed ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.HotkeyEventArgs -> unit) = render ==> html.callback("OnHotkeyPressed", fn)
    [<CustomOperation("OnHotkeyPressed")>] member inline _.OnHotkeyPressed ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.HotkeyEventArgs -> Task<unit>) = render ==> html.callbackTask("OnHotkeyPressed", fn)
...
type MudTabPanelBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("BadgeMax")>] member inline _.BadgeMax ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("BadgeMax" => x)
...
type BaseAxisChartBuilder<'FunBlazorGeneric, 'T, 'TChartOptions when 'T : struct and 'T : (new : unit -> 'T) and System.Numerics.INumber<'T> and System.Numerics.IMinMaxValue<'T> and 'T :> System.IFormattable and 'T :> System.ValueType and 'TChartOptions : (new : unit -> 'TChartOptions) and 'TChartOptions :> MudBlazor.Charts.IAxisChartOptions and 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit MudComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("YAxisLabelSize")>] member inline _.YAxisLabelSize ([<InlineIfLambda>] render: AttrRenderFragment, x: MudBlazor.Interop.ElementSize) = render ==> ("YAxisLabelSize" => x)
    [<CustomOperation("YAxisLabelSize'")>] member inline _.YAxisLabelSize' ([<InlineIfLambda>] render: AttrRenderFragment, valueFn: MudBlazor.Interop.ElementSize * (MudBlazor.Interop.ElementSize -> unit)) = render ==> html.bind("YAxisLabelSize", valueFn)
    [<CustomOperation("YAxisLabelSizeChanged")>] member inline _.YAxisLabelSizeChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.Interop.ElementSize -> unit) = render ==> html.callback("YAxisLabelSizeChanged", fn)
    [<CustomOperation("YAxisLabelSizeChanged")>] member inline _.YAxisLabelSizeChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.Interop.ElementSize -> Task<unit>) = render ==> html.callbackTask("YAxisLabelSizeChanged", fn)
    [<CustomOperation("XAxisLabelSize")>] member inline _.XAxisLabelSize ([<InlineIfLambda>] render: AttrRenderFragment, x: MudBlazor.Interop.ElementSize) = render ==> ("XAxisLabelSize" => x)
    [<CustomOperation("XAxisLabelSize'")>] member inline _.XAxisLabelSize' ([<InlineIfLambda>] render: AttrRenderFragment, valueFn: MudBlazor.Interop.ElementSize * (MudBlazor.Interop.ElementSize -> unit)) = render ==> html.bind("XAxisLabelSize", valueFn)
    [<CustomOperation("XAxisLabelSizeChanged")>] member inline _.XAxisLabelSizeChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.Interop.ElementSize -> unit) = render ==> html.callback("XAxisLabelSizeChanged", fn)
    [<CustomOperation("XAxisLabelSizeChanged")>] member inline _.XAxisLabelSizeChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: MudBlazor.Interop.ElementSize -> Task<unit>) = render ==> html.callbackTask("XAxisLabelSizeChanged", fn)
    [<CustomOperation("Width")>] member inline _.Width ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Width" => x)
    [<CustomOperation("Height")>] member inline _.Height ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Height" => x)
