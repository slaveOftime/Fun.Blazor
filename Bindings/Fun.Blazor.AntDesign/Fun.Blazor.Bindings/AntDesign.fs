...
type OverlayTriggerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ComplexAutoCloseAndVisible")>] member inline _.ComplexAutoCloseAndVisible ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ComplexAutoCloseAndVisible" =>>> true)
    [<CustomOperation("ComplexAutoCloseAndVisible")>] member inline _.ComplexAutoCloseAndVisible ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ComplexAutoCloseAndVisible" =>>> x)
    ...
    [<CustomOperation("HiddenMode")>] member inline _.HiddenMode ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("HiddenMode" =>>> true)
    [<CustomOperation("HiddenMode")>] member inline _.HiddenMode ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("HiddenMode" =>>> x)
    [<CustomOperation("InlineFlexMode")>] member inline _.InlineFlexMode ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("InlineFlexMode" =>>> true)
    [<CustomOperation("InlineFlexMode")>] member inline _.InlineFlexMode ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("InlineFlexMode" =>>> x)
    [<CustomOperation("IsButton")>] member inline _.IsButton ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsButton" =>>> true)
    [<CustomOperation("IsButton")>] member inline _.IsButton ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsButton" =>>> x)
    ...
    [<CustomOperation("OnMaskClick")>] member inline _.OnMaskClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnMaskClick", fn)
    [<CustomOperation("OnMaskClick")>] member inline _.OnMaskClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnMaskClick", fn)
    [<CustomOperation("OnMouseEnter")>] member inline _.OnMouseEnter ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnMouseEnter", fn)
    [<CustomOperation("OnMouseEnter")>] member inline _.OnMouseEnter ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnMouseEnter", fn)
    ...
    [<CustomOperation("OnOverlayHiding")>] member inline _.OnOverlayHiding ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnOverlayHiding", fn)
    [<CustomOperation("OnOverlayHiding")>] member inline _.OnOverlayHiding ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnOverlayHiding", fn)
    [<CustomOperation("OnVisibleChange")>] member inline _.OnVisibleChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnVisibleChange", fn)
    [<CustomOperation("OnVisibleChange")>] member inline _.OnVisibleChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnVisibleChange", fn)
    [<CustomOperation("Overlay")>] member inline _.Overlay ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Overlay", fragment)
    [<CustomOperation("Overlay")>] member inline _.Overlay ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Overlay", fragment { yield! fragments })
    ...
    [<CustomOperation("Unbound")>] member inline _.Unbound ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.ForwardRef -> NodeRenderFragment) = render ==> html.renderFragment("Unbound", fn)
...
type DropdownBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ArrowPointAtCenter")>] member inline _.ArrowPointAtCenter ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ArrowPointAtCenter" =>>> true)
    [<CustomOperation("ArrowPointAtCenter")>] member inline _.ArrowPointAtCenter ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ArrowPointAtCenter" =>>> x)
...
type DropdownButtonBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Block")>] member inline _.Block ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Block" =>>> true)
    [<CustomOperation("Block")>] member inline _.Block ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Block" =>>> x)
    ...
    [<CustomOperation("Danger")>] member inline _.Danger ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Danger" =>>> true)
    [<CustomOperation("Danger")>] member inline _.Danger ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Danger" =>>> x)
    [<CustomOperation("Ghost")>] member inline _.Ghost ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Ghost" =>>> true)
    ...
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ButtonSize) = render ==> ("Size" => x)
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.ButtonType, System.ValueTuple<AntDesign.ButtonType, AntDesign.ButtonType>>) = render ==> ("Type" => x)
...
type PopconfirmBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OkType")>] member inline _.OkType ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ButtonType) = render ==> ("OkType" => x)
    ...
    [<CustomOperation("IconTemplate")>] member inline _.IconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("IconTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("OnCancel")>] member inline _.OnCancel ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("OnCancel", fn)
    [<CustomOperation("OnCancel")>] member inline _.OnCancel ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("OnCancel", fn)
    [<CustomOperation("OnConfirm")>] member inline _.OnConfirm ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("OnConfirm", fn)
    [<CustomOperation("OnConfirm")>] member inline _.OnConfirm ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("OnConfirm", fn)
    [<CustomOperation("ArrowPointAtCenter")>] member inline _.ArrowPointAtCenter ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ArrowPointAtCenter" =>>> true)
    [<CustomOperation("ArrowPointAtCenter")>] member inline _.ArrowPointAtCenter ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ArrowPointAtCenter" =>>> x)
...
type PopoverBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ContentTemplate")>] member inline _.ContentTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("ContentTemplate", fragment)
    [<CustomOperation("ContentTemplate")>] member inline _.ContentTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("ContentTemplate", fragment { yield! fragments })
...
type ColumnBaseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ColIndex")>] member inline _.ColIndex ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("ColIndex" => x)
...
type ActionColumnBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("CellRender")>] member inline _.CellRender ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.CellData -> NodeRenderFragment) = render ==> html.renderFragment("CellRender", fn)
...
type ColumnBuilder<'FunBlazorGeneric, 'TData when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("FieldChanged")>] member inline _.FieldChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TData -> Task<unit>) = render ==> html.callbackTask("FieldChanged", fn)
    ...
    [<CustomOperation("ShowSorterTooltip")>] member inline _.ShowSorterTooltip ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowSorterTooltip" =>>> true)
    [<CustomOperation("ShowSorterTooltip")>] member inline _.ShowSorterTooltip ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowSorterTooltip" =>>> x)
    ...
    [<CustomOperation("DefaultSortOrder")>] member inline _.DefaultSortOrder ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Nullable<AntDesign.SortDirection>) = render ==> ("DefaultSortOrder" => x)
    ...
    [<CustomOperation("RelationContent")>] member inline _.RelationContent ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("RelationContent", fragment)
    [<CustomOperation("RelationContent")>] member inline _.RelationContent ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("RelationContent", fragment { yield! fragments })
    [<CustomOperation("RelationContent")>] member inline _.RelationContent ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render ==> html.renderFragment("RelationContent", html.text x)
    [<CustomOperation("RelationContent")>] member inline _.RelationContent ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("RelationContent", html.text x)
    [<CustomOperation("RelationContent")>] member inline _.RelationContent ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("RelationContent", html.text x)
    ...
    [<CustomOperation("FilterMultiple")>] member inline _.FilterMultiple ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("FilterMultiple" =>>> true)
    [<CustomOperation("FilterMultiple")>] member inline _.FilterMultiple ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("FilterMultiple" =>>> x)
    ...
    [<CustomOperation("Filtered")>] member inline _.Filtered ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Filtered" =>>> true)
    [<CustomOperation("Filtered")>] member inline _.Filtered ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Filtered" =>>> x)
    [<CustomOperation("CellRender")>] member inline _.CellRender ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.CellData<'TData> -> NodeRenderFragment) = render ==> html.renderFragment("CellRender", fn)
...
type SelectionBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit ColumnBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.SelectionType) = render ==> ("Type" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
    [<CustomOperation("Key")>] member inline _.Key ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Key" => x)
    [<CustomOperation("CheckStrictly")>] member inline _.CheckStrictly ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("CheckStrictly" =>>> true)
    [<CustomOperation("CheckStrictly")>] member inline _.CheckStrictly ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("CheckStrictly" =>>> x)
    [<CustomOperation("CellRender")>] member inline _.CellRender ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.CellData -> NodeRenderFragment) = render ==> html.renderFragment("CellRender", fn)
...
type DatePickerPanelBaseBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("IsRange")>] member inline _.IsRange ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsRange" =>>> true)
    [<CustomOperation("IsRange")>] member inline _.IsRange ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsRange" =>>> x)
    [<CustomOperation("IsCalendar")>] member inline _.IsCalendar ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsCalendar" =>>> true)
    [<CustomOperation("IsCalendar")>] member inline _.IsCalendar ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsCalendar" =>>> x)
    [<CustomOperation("IsShowHeader")>] member inline _.IsShowHeader ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsShowHeader" =>>> true)
    [<CustomOperation("IsShowHeader")>] member inline _.IsShowHeader ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsShowHeader" =>>> x)
    [<CustomOperation("IsShowTime")>] member inline _.IsShowTime ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsShowTime" =>>> true)
    [<CustomOperation("IsShowTime")>] member inline _.IsShowTime ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsShowTime" =>>> x)
    ...
    [<CustomOperation("RenderExtraFooter")>] member inline _.RenderExtraFooter ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("RenderExtraFooter", fragment)
    [<CustomOperation("RenderExtraFooter")>] member inline _.RenderExtraFooter ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("RenderExtraFooter", fragment { yield! fragments })
...
type DatePickerDatetimePanelBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowToday")>] member inline _.ShowToday ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowToday" =>>> true)
    [<CustomOperation("ShowToday")>] member inline _.ShowToday ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowToday" =>>> x)
    ...
    [<CustomOperation("OnOkClick")>] member inline _.OnOkClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnOkClick", fn)
    [<CustomOperation("OnOkClick")>] member inline _.OnOkClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnOkClick", fn)
    [<CustomOperation("OnNowClick")>] member inline _.OnNowClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnNowClick", fn)
    [<CustomOperation("OnNowClick")>] member inline _.OnNowClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnNowClick", fn)
    [<CustomOperation("OnRangeItemOver")>] member inline _.OnRangeItemOver ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Nullable<System.DateTime>[] -> unit) = render ==> html.callback("OnRangeItemOver", fn)
    [<CustomOperation("OnRangeItemOver")>] member inline _.OnRangeItemOver ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Nullable<System.DateTime>[] -> Task<unit>) = render ==> html.callbackTask("OnRangeItemOver", fn)
    [<CustomOperation("OnRangeItemOut")>] member inline _.OnRangeItemOut ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Nullable<System.DateTime>[] -> unit) = render ==> html.callback("OnRangeItemOut", fn)
    [<CustomOperation("OnRangeItemOut")>] member inline _.OnRangeItemOut ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Nullable<System.DateTime>[] -> Task<unit>) = render ==> html.callbackTask("OnRangeItemOut", fn)
    [<CustomOperation("OnRangeItemClicked")>] member inline _.OnRangeItemClicked ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Nullable<System.DateTime>[] -> unit) = render ==> html.callback("OnRangeItemClicked", fn)
    [<CustomOperation("OnRangeItemClicked")>] member inline _.OnRangeItemClicked ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Nullable<System.DateTime>[] -> Task<unit>) = render ==> html.callbackTask("OnRangeItemClicked", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnOpenChange", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnOpenChange", fn)

type DatePickerTemplateBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit DatePickerPanelBaseBuilder<'FunBlazorGeneric, 'TValue>()
    [<CustomOperation("RenderPickerHeader")>] member inline _.RenderPickerHeader ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("RenderPickerHeader", fragment)
    [<CustomOperation("RenderPickerHeader")>] member inline _.RenderPickerHeader ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("RenderPickerHeader", fragment { yield! fragments })
    ...
    [<CustomOperation("RenderTableHeader")>] member inline _.RenderTableHeader ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("RenderTableHeader", fragment)
    [<CustomOperation("RenderTableHeader")>] member inline _.RenderTableHeader ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("RenderTableHeader", fragment { yield! fragments })
    ...
    [<CustomOperation("RenderFirstCol")>] member inline _.RenderFirstCol ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.DateTime -> NodeRenderFragment) = render ==> html.renderFragment("RenderFirstCol", fn)
    [<CustomOperation("RenderColValue")>] member inline _.RenderColValue ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.DateTime -> NodeRenderFragment) = render ==> html.renderFragment("RenderColValue", fn)
    [<CustomOperation("RenderLastCol")>] member inline _.RenderLastCol ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.DateTime -> NodeRenderFragment) = render ==> html.renderFragment("RenderLastCol", fn)
    ...
    [<CustomOperation("ShowFooter")>] member inline _.ShowFooter ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowFooter" =>>> true)
    [<CustomOperation("ShowFooter")>] member inline _.ShowFooter ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowFooter" =>>> x)
...
type DatePickerDatePanelBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit DatePickerPanelBaseBuilder<'FunBlazorGeneric, 'TValue>()
    [<CustomOperation("IsWeek")>] member inline _.IsWeek ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsWeek" =>>> true)
    [<CustomOperation("IsWeek")>] member inline _.IsWeek ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsWeek" =>>> x)
    [<CustomOperation("ShowToday")>] member inline _.ShowToday ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowToday" =>>> true)
    [<CustomOperation("ShowToday")>] member inline _.ShowToday ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowToday" =>>> x)
...
type DatePickerHeaderBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowSuperPreChange")>] member inline _.ShowSuperPreChange ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowSuperPreChange" =>>> true)
    [<CustomOperation("ShowSuperPreChange")>] member inline _.ShowSuperPreChange ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowSuperPreChange" =>>> x)
    [<CustomOperation("ShowPreChange")>] member inline _.ShowPreChange ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowPreChange" =>>> true)
    [<CustomOperation("ShowPreChange")>] member inline _.ShowPreChange ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowPreChange" =>>> x)
    [<CustomOperation("ShowNextChange")>] member inline _.ShowNextChange ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowNextChange" =>>> true)
    [<CustomOperation("ShowNextChange")>] member inline _.ShowNextChange ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowNextChange" =>>> x)
    [<CustomOperation("ShowSuperNextChange")>] member inline _.ShowSuperNextChange ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowSuperNextChange" =>>> true)
    [<CustomOperation("ShowSuperNextChange")>] member inline _.ShowSuperNextChange ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowSuperNextChange" =>>> x)
...
type ButtonBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AutoLoading")>] member inline _.AutoLoading ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoLoading" =>>> x)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("OnClick", fn)
    [<CustomOperation("OnClickStopPropagation")>] member inline _.OnClickStopPropagation ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("OnClickStopPropagation" =>>> true)
    [<CustomOperation("OnClickStopPropagation")>] member inline _.OnClickStopPropagation ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("OnClickStopPropagation" =>>> x)
    [<CustomOperation("Shape")>] member inline _.Shape ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ButtonShape) = render ==> ("Shape" => x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ButtonSize) = render ==> ("Size" => x)
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Nullable<AntDesign.ButtonType>) = render ==> ("Type" => x)
    [<CustomOperation("NoSpanWrap")>] member inline _.NoSpanWrap ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("NoSpanWrap" =>>> true)
    [<CustomOperation("NoSpanWrap")>] member inline _.NoSpanWrap ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("NoSpanWrap" =>>> x)
...
type RowBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Align")>] member inline _.Align ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.RowAlign) = render ==> ("Align" => x)
    [<CustomOperation("Justify")>] member inline _.Justify ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.RowJustify) = render ==> ("Justify" => x)
    ...
    [<CustomOperation("OnBreakpoint")>] member inline _.OnBreakpoint ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.BreakpointType -> unit) = render ==> html.callback("OnBreakpoint", fn)
    [<CustomOperation("OnBreakpoint")>] member inline _.OnBreakpoint ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.BreakpointType -> Task<unit>) = render ==> html.callbackTask("OnBreakpoint", fn)
...
type IconBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AriaLabel")>] member inline _.AriaLabel ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("AriaLabel" => x)
    [<CustomOperation("Spin")>] member inline _.Spin ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Spin" =>>> true)
    [<CustomOperation("Spin")>] member inline _.Spin ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Spin" =>>> x)
    [<CustomOperation("Rotate")>] member inline _.Rotate ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("Rotate" => x)
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Type" => x)
    [<CustomOperation("Theme")>] member inline _.Theme ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.IconThemeType) = render ==> ("Theme" => x)
    ...
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("OnClick", fn)
    [<CustomOperation("Component")>] member inline _.Component ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Component", fragment)
    [<CustomOperation("Component")>] member inline _.Component ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Component", fragment { yield! fragments })
...
type TabsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ActiveKeyChanged")>] member inline _.ActiveKeyChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> unit) = render ==> html.callback("ActiveKeyChanged", fn)
    [<CustomOperation("ActiveKeyChanged")>] member inline _.ActiveKeyChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> Task<unit>) = render ==> html.callbackTask("ActiveKeyChanged", fn)
    ...
    [<CustomOperation("InkBarAnimated")>] member inline _.InkBarAnimated ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("InkBarAnimated" =>>> true)
    [<CustomOperation("InkBarAnimated")>] member inline _.InkBarAnimated ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("InkBarAnimated" =>>> x)
    ...
    [<CustomOperation("HideAdd")>] member inline _.HideAdd ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("HideAdd" =>>> true)
    [<CustomOperation("HideAdd")>] member inline _.HideAdd ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("HideAdd" =>>> x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.TabSize) = render ==> ("Size" => x)
    [<CustomOperation("TabBarExtraContent")>] member inline _.TabBarExtraContent ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("TabBarExtraContent", fragment)
    [<CustomOperation("TabBarExtraContent")>] member inline _.TabBarExtraContent ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("TabBarExtraContent", fragment { yield! fragments })
    ...
    [<CustomOperation("TabBarExtraContentLeft")>] member inline _.TabBarExtraContentLeft ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("TabBarExtraContentLeft", fragment)
    [<CustomOperation("TabBarExtraContentLeft")>] member inline _.TabBarExtraContentLeft ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("TabBarExtraContentLeft", fragment { yield! fragments })
    ...
    [<CustomOperation("TabBarExtraContentRight")>] member inline _.TabBarExtraContentRight ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("TabBarExtraContentRight", fragment)
    [<CustomOperation("TabBarExtraContentRight")>] member inline _.TabBarExtraContentRight ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("TabBarExtraContentRight", fragment { yield! fragments })
    ...
    [<CustomOperation("OnClose")>] member inline _.OnClose ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> unit) = render ==> html.callback("OnClose", fn)
    [<CustomOperation("OnClose")>] member inline _.OnClose ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> Task<unit>) = render ==> html.callbackTask("OnClose", fn)
    [<CustomOperation("OnAddClick")>] member inline _.OnAddClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnAddClick", fn)
    [<CustomOperation("OnAddClick")>] member inline _.OnAddClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnAddClick", fn)
    [<CustomOperation("AfterTabCreated")>] member inline _.AfterTabCreated ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> unit) = render ==> html.callback("AfterTabCreated", fn)
    [<CustomOperation("AfterTabCreated")>] member inline _.AfterTabCreated ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> Task<unit>) = render ==> html.callbackTask("AfterTabCreated", fn)
    [<CustomOperation("OnTabClick")>] member inline _.OnTabClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> unit) = render ==> html.callback("OnTabClick", fn)
    [<CustomOperation("OnTabClick")>] member inline _.OnTabClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> Task<unit>) = render ==> html.callbackTask("OnTabClick", fn)
...
type ReuseTabsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("TabPaneTemplate")>] member inline _.TabPaneTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.ReuseTabsPageItem -> NodeRenderFragment) = render ==> html.renderFragment("TabPaneTemplate", fn)
...
type TypographyBaseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Code")>] member inline _.Code ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Code" =>>> true)
    [<CustomOperation("Code")>] member inline _.Code ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Code" =>>> x)
    [<CustomOperation("Copyable")>] member inline _.Copyable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Copyable" =>>> true)
    [<CustomOperation("Copyable")>] member inline _.Copyable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Copyable" =>>> x)
    ...
    [<CustomOperation("Delete")>] member inline _.Delete ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Delete" =>>> true)
    [<CustomOperation("Delete")>] member inline _.Delete ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Delete" =>>> x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
    ...
    [<CustomOperation("Mark")>] member inline _.Mark ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Mark" =>>> true)
    [<CustomOperation("Mark")>] member inline _.Mark ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Mark" =>>> x)
    ...
    [<CustomOperation("Strong")>] member inline _.Strong ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Strong" =>>> true)
    [<CustomOperation("Strong")>] member inline _.Strong ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Strong" =>>> x)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Nullable<AntDesign.TextElementType>) = render ==> ("Type" => x)
...
type LinkBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Keyboard")>] member inline _.Keyboard ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Keyboard" =>>> true)
    [<CustomOperation("Keyboard")>] member inline _.Keyboard ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Keyboard" =>>> x)
...
type AffixBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)

type AlertBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("AfterClose")>] member inline _.AfterClose ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("AfterClose", fn)
    [<CustomOperation("AfterClose")>] member inline _.AfterClose ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("AfterClose", fn)
    [<CustomOperation("Banner")>] member inline _.Banner ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Banner" =>>> true)
    [<CustomOperation("Banner")>] member inline _.Banner ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Banner" =>>> x)
    [<CustomOperation("Closable")>] member inline _.Closable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Closable" =>>> true)
    [<CustomOperation("Closable")>] member inline _.Closable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Closable" =>>> x)
    ...
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Icon", fragment)
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Icon", fragment { yield! fragments })
    ...
    [<CustomOperation("MessageTemplate")>] member inline _.MessageTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("MessageTemplate", fragment)
    [<CustomOperation("MessageTemplate")>] member inline _.MessageTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("MessageTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Nullable<AntDesign.AlertType>) = render ==> ("Type" => x)
...
type AnchorBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Key")>] member inline _.Key ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Key" => x)
    [<CustomOperation("Affix")>] member inline _.Affix ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Affix" =>>> true)
    [<CustomOperation("Affix")>] member inline _.Affix ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Affix" =>>> x)
    ...
    [<CustomOperation("ShowInkInFixed")>] member inline _.ShowInkInFixed ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowInkInFixed" =>>> true)
    [<CustomOperation("ShowInkInFixed")>] member inline _.ShowInkInFixed ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowInkInFixed" =>>> x)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Tuple<Microsoft.AspNetCore.Components.Web.MouseEventArgs, AntDesign.AnchorLink> -> unit) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Tuple<Microsoft.AspNetCore.Components.Web.MouseEventArgs, AntDesign.AnchorLink> -> Task<unit>) = render ==> html.callbackTask("OnClick", fn)
...
type AutoCompleteOptGroupBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("LabelFragment")>] member inline _.LabelFragment ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("LabelFragment", fragment)
    [<CustomOperation("LabelFragment")>] member inline _.LabelFragment ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("LabelFragment", fragment { yield! fragments })
...
type AvatarBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Shape")>] member inline _.Shape ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Nullable<AntDesign.AvatarShape>) = render ==> ("Shape" => x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.AvatarSize, System.String>) = render ==> ("Size" => x)
    ...
    [<CustomOperation("Alt")>] member inline _.Alt ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Alt" => x)
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Icon" => x)
    [<CustomOperation("OnError")>] member inline _.OnError ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.ErrorEventArgs -> unit) = render ==> html.callback("OnError", fn)
    [<CustomOperation("OnError")>] member inline _.OnError ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.ErrorEventArgs -> Task<unit>) = render ==> html.callbackTask("OnError", fn)
...
type BadgeBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("CountTemplate")>] member inline _.CountTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("CountTemplate", fragment)
    [<CustomOperation("CountTemplate")>] member inline _.CountTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("CountTemplate", fragment { yield! fragments })
...
type BreadcrumbBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("AutoGenerate")>] member inline _.AutoGenerate ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoGenerate" =>>> true)
    [<CustomOperation("AutoGenerate")>] member inline _.AutoGenerate ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoGenerate" =>>> x)
...
type ButtonGroupBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Nullable<AntDesign.ButtonGroupSize>) = render ==> ("Size" => x)
...
type CalendarBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnSelect")>] member inline _.OnSelect ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.DateTime -> unit) = render ==> html.callback("OnSelect", fn)
    [<CustomOperation("OnSelect")>] member inline _.OnSelect ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.DateTime -> Task<unit>) = render ==> html.callbackTask("OnSelect", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.DateTime -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.DateTime -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)
    ...
    [<CustomOperation("OnPanelChange")>] member inline _.OnPanelChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("OnPanelChange" => (System.Action<System.DateTime, AntDesign.DatePickerType>fn))
    [<CustomOperation("DisabledDate")>] member inline _.DisabledDate ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledDate" => (System.Func<System.DateTime, System.Boolean>fn))
    [<CustomOperation("Locale")>] member inline _.Locale ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.DatePickerLocale) = render ==> ("Locale" => x)
    [<CustomOperation("CultureInfo")>] member inline _.CultureInfo ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Globalization.CultureInfo) = render ==> ("CultureInfo" => x)
...
type CardBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Body")>] member inline _.Body ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("Body", html.text x)
    [<CustomOperation("Body")>] member inline _.Body ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("Body", html.text x)
    [<CustomOperation("ActionTemplate")>] member inline _.ActionTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("ActionTemplate", fragment)
    [<CustomOperation("ActionTemplate")>] member inline _.ActionTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("ActionTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("Hoverable")>] member inline _.Hoverable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Hoverable" =>>> true)
    [<CustomOperation("Hoverable")>] member inline _.Hoverable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Hoverable" =>>> x)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Loading" =>>> true)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Loading" =>>> x)
    ...
    [<CustomOperation("Cover")>] member inline _.Cover ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Cover", fragment)
    [<CustomOperation("Cover")>] member inline _.Cover ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Cover", fragment { yield! fragments })
    ...
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.CardType) = render ==> ("Type" => x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.CardSize) = render ==> ("Size" => x)
    [<CustomOperation("Title")>] member inline _.Title ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Title" => x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("TitleTemplate", fragment)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("TitleTemplate", fragment { yield! fragments })
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render ==> html.renderFragment("TitleTemplate", html.text x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("TitleTemplate", html.text x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("TitleTemplate", html.text x)
    [<CustomOperation("Extra")>] member inline _.Extra ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Extra", fragment)
    [<CustomOperation("Extra")>] member inline _.Extra ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Extra", fragment { yield! fragments })
...
type CarouselBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("DotPosition")>] member inline _.DotPosition ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.CarouselDotPosition) = render ==> ("DotPosition" => x)
    ...
    [<CustomOperation("Effect")>] member inline _.Effect ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.CarouselEffect) = render ==> ("Effect" => x)
...
type CollapseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Accordion")>] member inline _.Accordion ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Accordion" =>>> true)
    [<CustomOperation("Accordion")>] member inline _.Accordion ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Accordion" =>>> x)
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Bordered" =>>> true)
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Bordered" =>>> x)
    ...
    [<CustomOperation("ExpandIconTemplate")>] member inline _.ExpandIconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> NodeRenderFragment) = render ==> html.renderFragment("ExpandIconTemplate", fn)
    [<CustomOperation("Animation")>] member inline _.Animation ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Animation" =>>> true)
    [<CustomOperation("Animation")>] member inline _.Animation ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Animation" =>>> x)

type PanelBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Active")>] member inline _.Active ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Active" =>>> true)
    [<CustomOperation("Active")>] member inline _.Active ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Active" =>>> x)
    [<CustomOperation("Key")>] member inline _.Key ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Key" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
    ...
    [<CustomOperation("ExtraTemplate")>] member inline _.ExtraTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("ExtraTemplate", fragment)
    [<CustomOperation("ExtraTemplate")>] member inline _.ExtraTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("ExtraTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("OnActiveChange")>] member inline _.OnActiveChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnActiveChange", fn)
    [<CustomOperation("OnActiveChange")>] member inline _.OnActiveChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnActiveChange", fn)
...
type CommentBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AuthorTemplate")>] member inline _.AuthorTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("AuthorTemplate", fragment)
    [<CustomOperation("AuthorTemplate")>] member inline _.AuthorTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("AuthorTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("AvatarTemplate")>] member inline _.AvatarTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("AvatarTemplate", fragment)
    [<CustomOperation("AvatarTemplate")>] member inline _.AvatarTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("AvatarTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("DatetimeTemplate")>] member inline _.DatetimeTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("DatetimeTemplate", fragment)
    [<CustomOperation("DatetimeTemplate")>] member inline _.DatetimeTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("DatetimeTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("Actions")>] member inline _.Actions ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.IList<Microsoft.AspNetCore.Components.RenderFragment>) = render ==> ("Actions" => x)
    [<CustomOperation("Placement")>] member inline _.Placement ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.CommentPlacement) = render ==> ("Placement" => x)
...
type AntInputComponentBaseBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.InputSize) = render ==> ("Size" => x)
    [<CustomOperation("CultureInfo")>] member inline _.CultureInfo ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Globalization.CultureInfo) = render ==> ("CultureInfo" => x)
...
type CheckboxBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("CheckedChange")>] member inline _.CheckedChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("CheckedChange", fn)
    [<CustomOperation("CheckedChange")>] member inline _.CheckedChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("CheckedChange", fn)
...
type SwitchBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("CheckedChildrenTemplate")>] member inline _.CheckedChildrenTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("CheckedChildrenTemplate", fragment)
    [<CustomOperation("CheckedChildrenTemplate")>] member inline _.CheckedChildrenTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("CheckedChildrenTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("Control")>] member inline _.Control ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Control" =>>> true)
    [<CustomOperation("Control")>] member inline _.Control ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Control" =>>> x)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnClick", fn)
    ...
    [<CustomOperation("UnCheckedChildrenTemplate")>] member inline _.UnCheckedChildrenTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("UnCheckedChildrenTemplate", fragment)
    [<CustomOperation("UnCheckedChildrenTemplate")>] member inline _.UnCheckedChildrenTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("UnCheckedChildrenTemplate", fragment { yield! fragments })
...
type AutoCompleteBuilder<'FunBlazorGeneric, 'TOption when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Backfill")>] member inline _.Backfill ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Backfill" =>>> true)
    [<CustomOperation("Backfill")>] member inline _.Backfill ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Backfill" =>>> x)
    ...
    [<CustomOperation("OnSelectionChange")>] member inline _.OnSelectionChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.AutoCompleteOption -> unit) = render ==> html.callback("OnSelectionChange", fn)
    [<CustomOperation("OnSelectionChange")>] member inline _.OnSelectionChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.AutoCompleteOption -> Task<unit>) = render ==> html.callbackTask("OnSelectionChange", fn)
    [<CustomOperation("OnActiveChange")>] member inline _.OnActiveChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.AutoCompleteOption -> unit) = render ==> html.callback("OnActiveChange", fn)
    [<CustomOperation("OnActiveChange")>] member inline _.OnActiveChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.AutoCompleteOption -> Task<unit>) = render ==> html.callbackTask("OnActiveChange", fn)
    [<CustomOperation("OnInput")>] member inline _.OnInput ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.ChangeEventArgs -> unit) = render ==> html.callback("OnInput", fn)
    [<CustomOperation("OnInput")>] member inline _.OnInput ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.ChangeEventArgs -> Task<unit>) = render ==> html.callbackTask("OnInput", fn)
    [<CustomOperation("OnPanelVisibleChange")>] member inline _.OnPanelVisibleChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnPanelVisibleChange", fn)
    [<CustomOperation("OnPanelVisibleChange")>] member inline _.OnPanelVisibleChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnPanelVisibleChange", fn)
    [<CustomOperation("OptionTemplate")>] member inline _.OptionTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.AutoCompleteDataItem<'TOption> -> NodeRenderFragment) = render ==> html.renderFragment("OptionTemplate", fn)
    ...
    [<CustomOperation("OverlayTemplate")>] member inline _.OverlayTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("OverlayTemplate", fragment)
    [<CustomOperation("OverlayTemplate")>] member inline _.OverlayTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("OverlayTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("AllowFilter")>] member inline _.AllowFilter ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AllowFilter" =>>> true)
    [<CustomOperation("AllowFilter")>] member inline _.AllowFilter ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AllowFilter" =>>> x)
    ...
    [<CustomOperation("BoundaryAdjustMode")>] member inline _.BoundaryAdjustMode ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.TriggerBoundaryAdjustMode) = render ==> ("BoundaryAdjustMode" => x)
    [<CustomOperation("ShowPanel")>] member inline _.ShowPanel ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowPanel" =>>> true)
    [<CustomOperation("ShowPanel")>] member inline _.ShowPanel ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowPanel" =>>> x)
...
type CheckboxGroupBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TValue[] -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TValue[] -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
...
type DatePickerBaseBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntInputComponentBaseBuilder<'FunBlazorGeneric, 'TValue>()
    [<CustomOperation("ChangeOnClose")>] member inline _.ChangeOnClose ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ChangeOnClose" =>>> true)
    ...
    [<CustomOperation("InputReadOnly")>] member inline _.InputReadOnly ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("InputReadOnly" =>>> true)
    [<CustomOperation("InputReadOnly")>] member inline _.InputReadOnly ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("InputReadOnly" =>>> x)
    [<CustomOperation("ShowToday")>] member inline _.ShowToday ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowToday" =>>> true)
    [<CustomOperation("ShowToday")>] member inline _.ShowToday ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowToday" =>>> x)
    ...
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("SuffixIcon", fragment)
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("SuffixIcon", fragment { yield! fragments })
    ...
    [<CustomOperation("RenderExtraFooter")>] member inline _.RenderExtraFooter ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("RenderExtraFooter", html.text x)
    [<CustomOperation("RenderExtraFooter")>] member inline _.RenderExtraFooter ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("RenderExtraFooter", html.text x)
    [<CustomOperation("OnClearClick")>] member inline _.OnClearClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnClearClick", fn)
    [<CustomOperation("OnClearClick")>] member inline _.OnClearClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnClearClick", fn)
    [<CustomOperation("OnClear")>] member inline _.OnClear ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnClear", fn)
    [<CustomOperation("OnClear")>] member inline _.OnClear ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnClear", fn)
    [<CustomOperation("OnOk")>] member inline _.OnOk ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnOk", fn)
    [<CustomOperation("OnOk")>] member inline _.OnOk ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnOk", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnOpenChange", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnOpenChange", fn)
    [<CustomOperation("OnPanelChange")>] member inline _.OnPanelChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.DateTimeChangedEventArgs<'TValue> -> unit) = render ==> html.callback("OnPanelChange", fn)
    [<CustomOperation("OnPanelChange")>] member inline _.OnPanelChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.DateTimeChangedEventArgs<'TValue> -> Task<unit>) = render ==> html.callbackTask("OnPanelChange", fn)
    [<CustomOperation("DisabledDate")>] member inline _.DisabledDate ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledDate" => (System.Func<System.DateTime, System.Boolean>fn))
    [<CustomOperation("DisabledHours")>] member inline _.DisabledHours ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledHours" => (System.Func<System.DateTime, System.Int32[]>fn))
    [<CustomOperation("DisabledMinutes")>] member inline _.DisabledMinutes ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledMinutes" => (System.Func<System.DateTime, System.Int32[]>fn))
    [<CustomOperation("DisabledSeconds")>] member inline _.DisabledSeconds ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledSeconds" => (System.Func<System.DateTime, System.Int32[]>fn))
...
type InputNumberBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TValue -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TValue -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)
    [<CustomOperation("OnFocus")>] member inline _.OnFocus ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.FocusEventArgs -> unit) = render ==> html.callback("OnFocus", fn)
    [<CustomOperation("OnFocus")>] member inline _.OnFocus ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.FocusEventArgs -> Task<unit>) = render ==> html.callbackTask("OnFocus", fn)
    [<CustomOperation("PlaceHolder")>] member inline _.PlaceHolder ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("PlaceHolder" => x)
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Bordered" =>>> true)
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Bordered" =>>> x)
...
type InputBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntInputComponentBaseBuilder<'FunBlazorGeneric, 'TValue>()
    [<CustomOperation("AddOnBefore")>] member inline _.AddOnBefore ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("AddOnBefore", fragment)
    [<CustomOperation("AddOnBefore")>] member inline _.AddOnBefore ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("AddOnBefore", fragment { yield! fragments })
    ...
    [<CustomOperation("AddOnAfter")>] member inline _.AddOnAfter ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("AddOnAfter", fragment)
    [<CustomOperation("AddOnAfter")>] member inline _.AddOnAfter ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("AddOnAfter", fragment { yield! fragments })
    ...
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AllowClear" =>>> true)
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AllowClear" =>>> x)
    [<CustomOperation("ShowClear")>] member inline _.ShowClear ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Nullable<System.Boolean>) = render ==> ("ShowClear" => x)
    [<CustomOperation("OnClear")>] member inline _.OnClear ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnClear", fn)
    [<CustomOperation("OnClear")>] member inline _.OnClear ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnClear", fn)
    ...
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Bordered" =>>> true)
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Bordered" =>>> x)
    [<CustomOperation("BindOnInput")>] member inline _.BindOnInput ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("BindOnInput" =>>> true)
    [<CustomOperation("BindOnInput")>] member inline _.BindOnInput ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("BindOnInput" =>>> x)
    [<CustomOperation("DebounceMilliseconds")>] member inline _.DebounceMilliseconds ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("DebounceMilliseconds" => x)
    [<CustomOperation("DefaultValue")>] member inline _.DefaultValue ([<InlineIfLambda>] render: AttrRenderFragment, x: 'TValue) = render ==> ("DefaultValue" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
    ...
    [<CustomOperation("StopPropagation")>] member inline _.StopPropagation ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("StopPropagation" =>>> true)
    [<CustomOperation("StopPropagation")>] member inline _.StopPropagation ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("StopPropagation" =>>> x)
    [<CustomOperation("Suffix")>] member inline _.Suffix ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Suffix", fragment)
    [<CustomOperation("Suffix")>] member inline _.Suffix ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Suffix", fragment { yield! fragments })
    ...
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.InputType) = render ==> ("Type" => x)
    ...
    [<CustomOperation("WrapperClass")>] member inline _.WrapperClass ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("WrapperClass" => x)
...
type SearchBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ClassicSearchIcon")>] member inline _.ClassicSearchIcon ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ClassicSearchIcon" =>>> true)
    [<CustomOperation("ClassicSearchIcon")>] member inline _.ClassicSearchIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ClassicSearchIcon" =>>> x)
    ...
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Loading" =>>> true)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Loading" =>>> x)
    [<CustomOperation("OnSearch")>] member inline _.OnSearch ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> unit) = render ==> html.callback("OnSearch", fn)
    [<CustomOperation("OnSearch")>] member inline _.OnSearch ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> Task<unit>) = render ==> html.callbackTask("OnSearch", fn)
...
type InputPasswordBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit InputBuilder<'FunBlazorGeneric, System.String>()
    [<CustomOperation("IconRender")>] member inline _.IconRender ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("IconRender", fragment)
    [<CustomOperation("IconRender")>] member inline _.IconRender ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("IconRender", fragment { yield! fragments })
    ...
    [<CustomOperation("ShowPassword")>] member inline _.ShowPassword ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowPassword" =>>> true)
    [<CustomOperation("ShowPassword")>] member inline _.ShowPassword ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowPassword" =>>> x)
    [<CustomOperation("VisibilityToggle")>] member inline _.VisibilityToggle ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("VisibilityToggle" =>>> true)
    [<CustomOperation("VisibilityToggle")>] member inline _.VisibilityToggle ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("VisibilityToggle" =>>> x)
...
type TextAreaBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnResize")>] member inline _.OnResize ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.OnResizeEventArgs -> unit) = render ==> html.callback("OnResize", fn)
    [<CustomOperation("OnResize")>] member inline _.OnResize ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.OnResizeEventArgs -> Task<unit>) = render ==> html.callbackTask("OnResize", fn)
...
type SelectBaseBuilder<'FunBlazorGeneric, 'TItemValue, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AllowClear" =>>> true)
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AllowClear" =>>> x)
    [<CustomOperation("AutoClearSearchValue")>] member inline _.AutoClearSearchValue ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoClearSearchValue" =>>> true)
    [<CustomOperation("AutoClearSearchValue")>] member inline _.AutoClearSearchValue ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoClearSearchValue" =>>> x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
    [<CustomOperation("Mode")>] member inline _.Mode ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.SelectMode) = render ==> ("Mode" => x)
    [<CustomOperation("EnableSearch")>] member inline _.EnableSearch ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("EnableSearch" =>>> true)
    [<CustomOperation("EnableSearch")>] member inline _.EnableSearch ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("EnableSearch" =>>> x)
    ...
    [<CustomOperation("Placeholder")>] member inline _.Placeholder ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Placeholder" => x)
    [<CustomOperation("OnFocus")>] member inline _.OnFocus ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnFocus", fn)
    [<CustomOperation("OnFocus")>] member inline _.OnFocus ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnFocus", fn)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoFocus" =>>> true)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoFocus" =>>> x)
    ...
    [<CustomOperation("HideSelected")>] member inline _.HideSelected ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("HideSelected" =>>> true)
    [<CustomOperation("HideSelected")>] member inline _.HideSelected ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("HideSelected" =>>> x)
    [<CustomOperation("ValueChanged")>] member inline _.ValueChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItemValue -> unit) = render ==> html.callback("ValueChanged", fn)
    [<CustomOperation("ValueChanged")>] member inline _.ValueChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItemValue -> Task<unit>) = render ==> html.callbackTask("ValueChanged", fn)
    [<CustomOperation("ValuesChanged")>] member inline _.ValuesChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Collections.Generic.IEnumerable<'TItemValue> -> unit) = render ==> html.callback("ValuesChanged", fn)
    [<CustomOperation("ValuesChanged")>] member inline _.ValuesChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Collections.Generic.IEnumerable<'TItemValue> -> Task<unit>) = render ==> html.callbackTask("ValuesChanged", fn)
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("SuffixIcon", fragment)
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("SuffixIcon", fragment { yield! fragments })
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render ==> html.renderFragment("SuffixIcon", html.text x)
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("SuffixIcon", html.text x)
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("SuffixIcon", html.text x)
    [<CustomOperation("PrefixIcon")>] member inline _.PrefixIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PrefixIcon", fragment)
    [<CustomOperation("PrefixIcon")>] member inline _.PrefixIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PrefixIcon", fragment { yield! fragments })
    ...
    [<CustomOperation("OnClearSelected")>] member inline _.OnClearSelected ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnClearSelected", fn)
    [<CustomOperation("OnClearSelected")>] member inline _.OnClearSelected ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnClearSelected", fn)
    [<CustomOperation("Unbound")>] member inline _.Unbound ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.ForwardRef -> NodeRenderFragment) = render ==> html.renderFragment("Unbound", fn)
    [<CustomOperation("OnSelectedItemChanged")>] member inline _.OnSelectedItemChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem -> unit) = render ==> html.callback("OnSelectedItemChanged", fn)
    [<CustomOperation("OnSelectedItemChanged")>] member inline _.OnSelectedItemChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem -> Task<unit>) = render ==> html.callbackTask("OnSelectedItemChanged", fn)
    [<CustomOperation("OnSelectedItemsChanged")>] member inline _.OnSelectedItemsChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Collections.Generic.IEnumerable<'TItem> -> unit) = render ==> html.callback("OnSelectedItemsChanged", fn)
    [<CustomOperation("OnSelectedItemsChanged")>] member inline _.OnSelectedItemsChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Collections.Generic.IEnumerable<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnSelectedItemsChanged", fn)
    ...
    [<CustomOperation("PopupContainerSelector")>] member inline _.PopupContainerSelector ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("PopupContainerSelector" => x)
    [<CustomOperation("DropdownRender")>] member inline _.DropdownRender ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.RenderFragment -> NodeRenderFragment) = render ==> html.renderFragment("DropdownRender", fn)
    [<CustomOperation("LabelTemplate")>] member inline _.LabelTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem -> NodeRenderFragment) = render ==> html.renderFragment("LabelTemplate", fn)
    [<CustomOperation("MaxTagPlaceholder")>] member inline _.MaxTagPlaceholder ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Collections.Generic.IEnumerable<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("MaxTagPlaceholder", fn)
    ...
    [<CustomOperation("ShowSearchIcon")>] member inline _.ShowSearchIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowSearchIcon" =>>> x)
...
type CascaderBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit SelectBaseBuilder<'FunBlazorGeneric, System.String, System.String>()
    [<CustomOperation("ChangeOnSelect")>] member inline _.ChangeOnSelect ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ChangeOnSelect" =>>> true)
    [<CustomOperation("ChangeOnSelect")>] member inline _.ChangeOnSelect ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ChangeOnSelect" =>>> x)
    ...
    [<CustomOperation("SelectedNodesChanged")>] member inline _.SelectedNodesChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.CascaderNode[] -> unit) = render ==> html.callback("SelectedNodesChanged", fn)
    [<CustomOperation("SelectedNodesChanged")>] member inline _.SelectedNodesChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.CascaderNode[] -> Task<unit>) = render ==> html.callbackTask("SelectedNodesChanged", fn)
...
type SelectBuilder<'FunBlazorGeneric, 'TItemValue, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("IgnoreItemChanges")>] member inline _.IgnoreItemChanges ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IgnoreItemChanges" =>>> true)
    [<CustomOperation("IgnoreItemChanges")>] member inline _.IgnoreItemChanges ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IgnoreItemChanges" =>>> x)
    ...
    [<CustomOperation("NotFoundContent")>] member inline _.NotFoundContent ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("NotFoundContent", fragment)
    [<CustomOperation("NotFoundContent")>] member inline _.NotFoundContent ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("NotFoundContent", fragment { yield! fragments })
...
type TreeSelectBuilder<'FunBlazorGeneric, 'TItemValue, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("TreeCheckable")>] member inline _.TreeCheckable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("TreeCheckable" =>>> true)
    [<CustomOperation("TreeCheckable")>] member inline _.TreeCheckable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("TreeCheckable" =>>> x)
    [<CustomOperation("TreeCheckStrictly")>] member inline _.TreeCheckStrictly ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("TreeCheckStrictly" =>>> true)
    [<CustomOperation("TreeCheckStrictly")>] member inline _.TreeCheckStrictly ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("TreeCheckStrictly" =>>> x)
    ...
    [<CustomOperation("CheckOnClickNode")>] member inline _.CheckOnClickNode ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("CheckOnClickNode" =>>> true)
    [<CustomOperation("CheckOnClickNode")>] member inline _.CheckOnClickNode ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("CheckOnClickNode" =>>> x)
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Action) = render ==> ("OnBlur" => x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("TitleTemplate", fn)
    [<CustomOperation("TitleIconTemplate")>] member inline _.TitleIconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("TitleIconTemplate", fn)
    ...
    [<CustomOperation("DataSource")>] member inline _.DataSource ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.IEnumerable<'TItem>) = render ==> ("DataSource" => x)
    [<CustomOperation("TreeDefaultExpandAll")>] member inline _.TreeDefaultExpandAll ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("TreeDefaultExpandAll" =>>> true)
    [<CustomOperation("TreeDefaultExpandAll")>] member inline _.TreeDefaultExpandAll ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("TreeDefaultExpandAll" =>>> x)
    [<CustomOperation("TreeDefaultExpandParent")>] member inline _.TreeDefaultExpandParent ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("TreeDefaultExpandParent" =>>> true)
    [<CustomOperation("TreeDefaultExpandParent")>] member inline _.TreeDefaultExpandParent ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("TreeDefaultExpandParent" =>>> x)
    ...
    [<CustomOperation("ExpandOnClickNode")>] member inline _.ExpandOnClickNode ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ExpandOnClickNode" =>>> true)
    [<CustomOperation("ExpandOnClickNode")>] member inline _.ExpandOnClickNode ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ExpandOnClickNode" =>>> x)
    ...
    [<CustomOperation("ShowLeafIcon")>] member inline _.ShowLeafIcon ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowLeafIcon" =>>> true)
    [<CustomOperation("ShowLeafIcon")>] member inline _.ShowLeafIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowLeafIcon" =>>> x)
    ...
    [<CustomOperation("OnNodeLoadDelayAsync")>] member inline _.OnNodeLoadDelayAsync ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnNodeLoadDelayAsync", fn)
    [<CustomOperation("OnNodeLoadDelayAsync")>] member inline _.OnNodeLoadDelayAsync ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnNodeLoadDelayAsync", fn)
    [<CustomOperation("OnTreeNodeSelect")>] member inline _.OnTreeNodeSelect ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnTreeNodeSelect", fn)
    [<CustomOperation("OnTreeNodeSelect")>] member inline _.OnTreeNodeSelect ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnTreeNodeSelect", fn)
    ...
    [<CustomOperation("ShowTreeLine")>] member inline _.ShowTreeLine ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowTreeLine" =>>> true)
    [<CustomOperation("ShowTreeLine")>] member inline _.ShowTreeLine ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowTreeLine" =>>> x)
    ...
    [<CustomOperation("SelectableExpression")>] member inline _.SelectableExpression ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("SelectableExpression" => (System.Func<AntDesign.TreeNode<'TItem>, System.Boolean>fn))
...
type SliderBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Dots")>] member inline _.Dots ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Dots" =>>> true)
    [<CustomOperation("Dots")>] member inline _.Dots ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Dots" =>>> x)
    [<CustomOperation("Included")>] member inline _.Included ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Included" =>>> true)
    [<CustomOperation("Included")>] member inline _.Included ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Included" =>>> x)
    ...
    [<CustomOperation("OnAfterChange")>] member inline _.OnAfterChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TValue -> unit) = render ==> html.callback("OnAfterChange", fn)
    [<CustomOperation("OnAfterChange")>] member inline _.OnAfterChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TValue -> Task<unit>) = render ==> html.callbackTask("OnAfterChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TValue -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TValue -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)
    [<CustomOperation("HasTooltip")>] member inline _.HasTooltip ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("HasTooltip" =>>> true)
    [<CustomOperation("HasTooltip")>] member inline _.HasTooltip ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("HasTooltip" =>>> x)
    ...
    [<CustomOperation("TooltipVisible")>] member inline _.TooltipVisible ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("TooltipVisible" =>>> true)
    [<CustomOperation("TooltipVisible")>] member inline _.TooltipVisible ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("TooltipVisible" =>>> x)
...
type DescriptionsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Bordered" =>>> true)
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Bordered" =>>> x)
    [<CustomOperation("Layout")>] member inline _.Layout ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.DescriptionsLayout) = render ==> ("Layout" => x)
    ...
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.DescriptionsSize) = render ==> ("Size" => x)
    [<CustomOperation("Title")>] member inline _.Title ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Title" => x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("TitleTemplate", fragment)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("TitleTemplate", fragment { yield! fragments })
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render ==> html.renderFragment("TitleTemplate", html.text x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("TitleTemplate", html.text x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("TitleTemplate", html.text x)
    [<CustomOperation("Colon")>] member inline _.Colon ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Colon" =>>> true)
    [<CustomOperation("Colon")>] member inline _.Colon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Colon" =>>> x)
...
type DividerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Text")>] member inline _.Text ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Text" => x)
    [<CustomOperation("Plain")>] member inline _.Plain ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Plain" =>>> true)
    [<CustomOperation("Plain")>] member inline _.Plain ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Plain" =>>> x)
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.DividerType) = render ==> ("Type" => x)
    [<CustomOperation("Orientation")>] member inline _.Orientation ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.DividerOrientation) = render ==> ("Orientation" => x)
    [<CustomOperation("Dashed")>] member inline _.Dashed ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Dashed" =>>> true)
    [<CustomOperation("Dashed")>] member inline _.Dashed ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Dashed" =>>> x)

type DraftMonitorBuilder<'FunBlazorGeneric, 'TData when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Data")>] member inline _.Data ([<InlineIfLambda>] render: AttrRenderFragment, x: 'TData) = render ==> ("Data" => x)
    [<CustomOperation("Data'")>] member inline _.Data' ([<InlineIfLambda>] render: AttrRenderFragment, valueFn: 'TData * ('TData -> unit)) = render ==> html.bind("Data", valueFn)
    [<CustomOperation("DataChanged")>] member inline _.DataChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TData -> unit) = render ==> html.callback("DataChanged", fn)
    [<CustomOperation("DataChanged")>] member inline _.DataChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TData -> Task<unit>) = render ==> html.callbackTask("DataChanged", fn)
    ...
    [<CustomOperation("Options")>] member inline _.Options ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.DraftOptions) = render ==> ("Options" => x)
    [<CustomOperation("OnRecovered")>] member inline _.OnRecovered ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TData -> unit) = render ==> html.callback("OnRecovered", fn)
    [<CustomOperation("OnRecovered")>] member inline _.OnRecovered ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TData -> Task<unit>) = render ==> html.callbackTask("OnRecovered", fn)
    [<CustomOperation("OnDeleted")>] member inline _.OnDeleted ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnDeleted", fn)
    [<CustomOperation("OnDeleted")>] member inline _.OnDeleted ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnDeleted", fn)
    [<CustomOperation("OnUpdate")>] member inline _.OnUpdate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TData -> unit) = render ==> html.callback("OnUpdate", fn)
    [<CustomOperation("OnUpdate")>] member inline _.OnUpdate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TData -> Task<unit>) = render ==> html.callbackTask("OnUpdate", fn)
    [<CustomOperation("Locale")>] member inline _.Locale ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.Locales.DraftLocale) = render ==> ("Locale" => x)
    [<CustomOperation("RecoveryContentTemplate")>] member inline _.RecoveryContentTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.DraftData<'TData> -> NodeRenderFragment) = render ==> html.renderFragment("RecoveryContentTemplate", fn)
...
type DrawerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Closable")>] member inline _.Closable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Closable" =>>> true)
    [<CustomOperation("Closable")>] member inline _.Closable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Closable" =>>> x)
    [<CustomOperation("MaskClosable")>] member inline _.MaskClosable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("MaskClosable" =>>> true)
    [<CustomOperation("MaskClosable")>] member inline _.MaskClosable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("MaskClosable" =>>> x)
    [<CustomOperation("Mask")>] member inline _.Mask ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Mask" =>>> true)
    [<CustomOperation("Mask")>] member inline _.Mask ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Mask" =>>> x)
    ...
    [<CustomOperation("Placement")>] member inline _.Placement ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.DrawerPlacement) = render ==> ("Placement" => x)
    [<CustomOperation("BodyStyle")>] member inline _.BodyStyle ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("BodyStyle" => x)
    [<CustomOperation("HeaderStyle")>] member inline _.HeaderStyle ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("HeaderStyle" => x)
    ...
    [<CustomOperation("Handler")>] member inline _.Handler ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Handler", fragment)
    [<CustomOperation("Handler")>] member inline _.Handler ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Handler", fragment { yield! fragments })
...
type EmptyBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Small")>] member inline _.Small ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Small" =>>> true)
    [<CustomOperation("Small")>] member inline _.Small ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Small" =>>> x)
    [<CustomOperation("Simple")>] member inline _.Simple ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Simple" =>>> true)
    [<CustomOperation("Simple")>] member inline _.Simple ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Simple" =>>> x)
    ...
    [<CustomOperation("DescriptionTemplate")>] member inline _.DescriptionTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("DescriptionTemplate", fragment)
    [<CustomOperation("DescriptionTemplate")>] member inline _.DescriptionTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("DescriptionTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("ImageTemplate")>] member inline _.ImageTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("ImageTemplate", fragment)
    [<CustomOperation("ImageTemplate")>] member inline _.ImageTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("ImageTemplate", fragment { yield! fragments })
...
type FlexBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Vertical")>] member inline _.Vertical ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Vertical" =>>> true)
    [<CustomOperation("Vertical")>] member inline _.Vertical ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Vertical" =>>> x)
    [<CustomOperation("Direction")>] member inline _.Direction ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.FlexDirection) = render ==> ("Direction" => x)
    [<CustomOperation("Wrap")>] member inline _.Wrap ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.FlexWrap, System.String>) = render ==> ("Wrap" => x)
    [<CustomOperation("Justify")>] member inline _.Justify ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.FlexJustify, System.String>) = render ==> ("Justify" => x)
    [<CustomOperation("Align")>] member inline _.Align ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.FlexAlign, System.String>) = render ==> ("Align" => x)
    ...
    [<CustomOperation("Gap")>] member inline _.Gap ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.FlexGap, System.String>) = render ==> ("Gap" => x)
...
type FormBuilder<'FunBlazorGeneric, 'TModel when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Layout")>] member inline _.Layout ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.FormLayout) = render ==> ("Layout" => x)
    [<CustomOperation("ChildContent")>] member inline _.ChildContent ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TModel -> NodeRenderFragment) = render ==> html.renderFragment("ChildContent", fn)
    ...
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Nullable<AntDesign.FormSize>) = render ==> ("Size" => x)
    [<CustomOperation("Name")>] member inline _.Name ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Name" => x)
    [<CustomOperation("Method")>] member inline _.Method ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Net.Http.HttpMethod) = render ==> ("Method" => x)
    [<CustomOperation("Model")>] member inline _.Model ([<InlineIfLambda>] render: AttrRenderFragment, x: 'TModel) = render ==> ("Model" => x)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Loading" =>>> true)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Loading" =>>> x)
    [<CustomOperation("OnFinish")>] member inline _.OnFinish ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.EditContext -> unit) = render ==> html.callback("OnFinish", fn)
    [<CustomOperation("OnFinish")>] member inline _.OnFinish ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.EditContext -> Task<unit>) = render ==> html.callbackTask("OnFinish", fn)
    [<CustomOperation("OnFinishFailed")>] member inline _.OnFinishFailed ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.EditContext -> unit) = render ==> html.callback("OnFinishFailed", fn)
    [<CustomOperation("OnFinishFailed")>] member inline _.OnFinishFailed ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.EditContext -> Task<unit>) = render ==> html.callbackTask("OnFinishFailed", fn)
    [<CustomOperation("OnFieldChanged")>] member inline _.OnFieldChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.FieldChangedEventArgs -> unit) = render ==> html.callback("OnFieldChanged", fn)
    [<CustomOperation("OnFieldChanged")>] member inline _.OnFieldChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.FieldChangedEventArgs -> Task<unit>) = render ==> html.callbackTask("OnFieldChanged", fn)
    [<CustomOperation("OnValidationRequested")>] member inline _.OnValidationRequested ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.ValidationRequestedEventArgs -> unit) = render ==> html.callback("OnValidationRequested", fn)
    [<CustomOperation("OnValidationRequested")>] member inline _.OnValidationRequested ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.ValidationRequestedEventArgs -> Task<unit>) = render ==> html.callbackTask("OnValidationRequested", fn)
    [<CustomOperation("OnValidationStateChanged")>] member inline _.OnValidationStateChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.ValidationStateChangedEventArgs -> unit) = render ==> html.callback("OnValidationStateChanged", fn)
    [<CustomOperation("OnValidationStateChanged")>] member inline _.OnValidationStateChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Forms.ValidationStateChangedEventArgs -> Task<unit>) = render ==> html.callbackTask("OnValidationStateChanged", fn)
    [<CustomOperation("Validator")>] member inline _.Validator ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Validator", fragment)
    [<CustomOperation("Validator")>] member inline _.Validator ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Validator", fragment { yield! fragments })
    ...
    [<CustomOperation("ValidateOnChange")>] member inline _.ValidateOnChange ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ValidateOnChange" =>>> true)
    [<CustomOperation("ValidateOnChange")>] member inline _.ValidateOnChange ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ValidateOnChange" =>>> x)
...
type FormItemBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("WrapperColSpan")>] member inline _.WrapperColSpan ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<System.String, System.Int32>) = render ==> ("WrapperColSpan" => x)
    [<CustomOperation("WrapperColOffset")>] member inline _.WrapperColOffset ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<System.String, System.Int32>) = render ==> ("WrapperColOffset" => x)
    [<CustomOperation("NoStyle")>] member inline _.NoStyle ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("NoStyle" =>>> true)
    [<CustomOperation("NoStyle")>] member inline _.NoStyle ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("NoStyle" =>>> x)
    ...
    [<CustomOperation("HasFeedback")>] member inline _.HasFeedback ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("HasFeedback" =>>> true)
    [<CustomOperation("HasFeedback")>] member inline _.HasFeedback ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("HasFeedback" =>>> x)
    [<CustomOperation("ShowFeedbackOnError")>] member inline _.ShowFeedbackOnError ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowFeedbackOnError" =>>> true)
    [<CustomOperation("ShowFeedbackOnError")>] member inline _.ShowFeedbackOnError ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowFeedbackOnError" =>>> x)
...
type ImageBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Preview")>] member inline _.Preview ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Preview" =>>> true)
    [<CustomOperation("Preview")>] member inline _.Preview ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Preview" =>>> x)
    [<CustomOperation("PreviewVisible")>] member inline _.PreviewVisible ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("PreviewVisible" =>>> true)
    [<CustomOperation("PreviewVisible")>] member inline _.PreviewVisible ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("PreviewVisible" =>>> x)
...
type InputGroupBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Compact")>] member inline _.Compact ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Compact" =>>> true)
    [<CustomOperation("Compact")>] member inline _.Compact ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Compact" =>>> x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.InputSize) = render ==> ("Size" => x)
...
type SiderBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Trigger")>] member inline _.Trigger ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Trigger", fragment)
    [<CustomOperation("Trigger")>] member inline _.Trigger ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Trigger", fragment { yield! fragments })
    ...
    [<CustomOperation("NoTrigger")>] member inline _.NoTrigger ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("NoTrigger" =>>> true)
    [<CustomOperation("NoTrigger")>] member inline _.NoTrigger ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("NoTrigger" =>>> x)
    ...
    [<CustomOperation("CollapsedChanged")>] member inline _.CollapsedChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("CollapsedChanged", fn)
    [<CustomOperation("CollapsedChanged")>] member inline _.CollapsedChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("CollapsedChanged", fn)
    [<CustomOperation("OnCollapse")>] member inline _.OnCollapse ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnCollapse", fn)
    [<CustomOperation("OnCollapse")>] member inline _.OnCollapse ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnCollapse", fn)
    [<CustomOperation("OnBreakpoint")>] member inline _.OnBreakpoint ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnBreakpoint", fn)
    [<CustomOperation("OnBreakpoint")>] member inline _.OnBreakpoint ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnBreakpoint", fn)
    [<CustomOperation("DefaultCollapsed")>] member inline _.DefaultCollapsed ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("DefaultCollapsed" =>>> true)
    [<CustomOperation("DefaultCollapsed")>] member inline _.DefaultCollapsed ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("DefaultCollapsed" =>>> x)
...
type AntListBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("LoadMore")>] member inline _.LoadMore ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("LoadMore", fragment)
    [<CustomOperation("LoadMore")>] member inline _.LoadMore ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("LoadMore", fragment { yield! fragments })
    ...
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ListSize) = render ==> ("Size" => x)
    [<CustomOperation("Split")>] member inline _.Split ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Split" =>>> true)
    [<CustomOperation("Split")>] member inline _.Split ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Split" =>>> x)
...
type ListItemBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnClick", fn)
    [<CustomOperation("NoFlex")>] member inline _.NoFlex ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("NoFlex" =>>> true)
    [<CustomOperation("NoFlex")>] member inline _.NoFlex ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("NoFlex" =>>> x)
...
type MentionsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Disable")>] member inline _.Disable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disable" =>>> true)
    [<CustomOperation("Disable")>] member inline _.Disable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disable" =>>> x)
    [<CustomOperation("Rows")>] member inline _.Rows ([<InlineIfLambda>] render: AttrRenderFragment, x: System.UInt32) = render ==> ("Rows" => x)
    [<CustomOperation("Focused")>] member inline _.Focused ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Focused" =>>> true)
    [<CustomOperation("Focused")>] member inline _.Focused ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Focused" =>>> x)
    [<CustomOperation("Readonly")>] member inline _.Readonly ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Readonly" =>>> true)
    [<CustomOperation("Readonly")>] member inline _.Readonly ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Readonly" =>>> x)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Loading" =>>> true)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Loading" =>>> x)
...
type MenuBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnSubmenuClicked")>] member inline _.OnSubmenuClicked ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.SubMenu -> unit) = render ==> html.callback("OnSubmenuClicked", fn)
    [<CustomOperation("OnSubmenuClicked")>] member inline _.OnSubmenuClicked ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.SubMenu -> Task<unit>) = render ==> html.callbackTask("OnSubmenuClicked", fn)
    [<CustomOperation("OnMenuItemClicked")>] member inline _.OnMenuItemClicked ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.MenuItem -> unit) = render ==> html.callback("OnMenuItemClicked", fn)
    [<CustomOperation("OnMenuItemClicked")>] member inline _.OnMenuItemClicked ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.MenuItem -> Task<unit>) = render ==> html.callbackTask("OnMenuItemClicked", fn)
    [<CustomOperation("Accordion")>] member inline _.Accordion ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Accordion" =>>> true)
    [<CustomOperation("Accordion")>] member inline _.Accordion ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Accordion" =>>> x)
    [<CustomOperation("Selectable")>] member inline _.Selectable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Selectable" =>>> true)
    [<CustomOperation("Selectable")>] member inline _.Selectable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Selectable" =>>> x)
    [<CustomOperation("Multiple")>] member inline _.Multiple ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Multiple" =>>> true)
    [<CustomOperation("Multiple")>] member inline _.Multiple ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Multiple" =>>> x)
    [<CustomOperation("InlineCollapsed")>] member inline _.InlineCollapsed ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("InlineCollapsed" =>>> true)
    [<CustomOperation("InlineCollapsed")>] member inline _.InlineCollapsed ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("InlineCollapsed" =>>> x)
    ...
    [<CustomOperation("AutoCloseDropdown")>] member inline _.AutoCloseDropdown ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoCloseDropdown" =>>> true)
    [<CustomOperation("AutoCloseDropdown")>] member inline _.AutoCloseDropdown ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoCloseDropdown" =>>> x)
    ...
    [<CustomOperation("OpenKeysChanged")>] member inline _.OpenKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> unit) = render ==> html.callback("OpenKeysChanged", fn)
    [<CustomOperation("OpenKeysChanged")>] member inline _.OpenKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> Task<unit>) = render ==> html.callbackTask("OpenKeysChanged", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> unit) = render ==> html.callback("OnOpenChange", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> Task<unit>) = render ==> html.callbackTask("OnOpenChange", fn)
    ...
    [<CustomOperation("SelectedKeysChanged")>] member inline _.SelectedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> unit) = render ==> html.callback("SelectedKeysChanged", fn)
    [<CustomOperation("SelectedKeysChanged")>] member inline _.SelectedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> Task<unit>) = render ==> html.callbackTask("SelectedKeysChanged", fn)
    ...
    [<CustomOperation("ShowCollapsedTooltip")>] member inline _.ShowCollapsedTooltip ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowCollapsedTooltip" =>>> true)
    [<CustomOperation("ShowCollapsedTooltip")>] member inline _.ShowCollapsedTooltip ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowCollapsedTooltip" =>>> x)
    [<CustomOperation("Animation")>] member inline _.Animation ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Animation" =>>> true)
    [<CustomOperation("Animation")>] member inline _.Animation ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Animation" =>>> x)
...
type SubMenuBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnTitleClick")>] member inline _.OnTitleClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("OnTitleClick", fn)
    [<CustomOperation("OnTitleClick")>] member inline _.OnTitleClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("OnTitleClick", fn)
...
type ConfirmBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnRemove")>] member inline _.OnRemove ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.ConfirmRef -> unit) = render ==> html.callback("OnRemove", fn)
    [<CustomOperation("OnRemove")>] member inline _.OnRemove ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.ConfirmRef -> Task<unit>) = render ==> html.callbackTask("OnRemove", fn)
...
type DialogBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AdditionalContent")>] member inline _.AdditionalContent ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("AdditionalContent", fragment)
    [<CustomOperation("AdditionalContent")>] member inline _.AdditionalContent ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("AdditionalContent", fragment { yield! fragments })
...
type DialogWrapperBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Visible")>] member inline _.Visible ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Visible" =>>> true)
    [<CustomOperation("Visible")>] member inline _.Visible ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Visible" =>>> x)
    [<CustomOperation("OnBeforeDestroy")>] member inline _.OnBeforeDestroy ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.ComponentModel.CancelEventArgs -> unit) = render ==> html.callback("OnBeforeDestroy", fn)
    [<CustomOperation("OnBeforeDestroy")>] member inline _.OnBeforeDestroy ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.ComponentModel.CancelEventArgs -> Task<unit>) = render ==> html.callbackTask("OnBeforeDestroy", fn)
    [<CustomOperation("OnAfterShow")>] member inline _.OnAfterShow ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnAfterShow", fn)
    [<CustomOperation("OnAfterShow")>] member inline _.OnAfterShow ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnAfterShow", fn)
    [<CustomOperation("OnAfterHide")>] member inline _.OnAfterHide ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnAfterHide", fn)
    [<CustomOperation("OnAfterHide")>] member inline _.OnAfterHide ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnAfterHide", fn)

type ModalBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("AfterClose")>] member inline _.AfterClose ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("AfterClose", fn)
    [<CustomOperation("AfterClose")>] member inline _.AfterClose ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("AfterClose", fn)
    [<CustomOperation("AfterOpen")>] member inline _.AfterOpen ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("AfterOpen", fn)
    [<CustomOperation("AfterOpen")>] member inline _.AfterOpen ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("AfterOpen", fn)
    [<CustomOperation("BodyStyle")>] member inline _.BodyStyle ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("BodyStyle" => x)
    ...
    [<CustomOperation("Draggable")>] member inline _.Draggable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Draggable" =>>> true)
    [<CustomOperation("Draggable")>] member inline _.Draggable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Draggable" =>>> x)
    [<CustomOperation("DragInViewport")>] member inline _.DragInViewport ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("DragInViewport" =>>> true)
    [<CustomOperation("DragInViewport")>] member inline _.DragInViewport ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("DragInViewport" =>>> x)
    [<CustomOperation("CloseIcon")>] member inline _.CloseIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("CloseIcon", fragment)
    [<CustomOperation("CloseIcon")>] member inline _.CloseIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("CloseIcon", fragment { yield! fragments })
    ...
    [<CustomOperation("ConfirmLoading")>] member inline _.ConfirmLoading ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ConfirmLoading" =>>> true)
    [<CustomOperation("ConfirmLoading")>] member inline _.ConfirmLoading ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ConfirmLoading" =>>> x)
    [<CustomOperation("DestroyOnClose")>] member inline _.DestroyOnClose ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("DestroyOnClose" =>>> true)
    [<CustomOperation("DestroyOnClose")>] member inline _.DestroyOnClose ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("DestroyOnClose" =>>> x)
    [<CustomOperation("Header")>] member inline _.Header ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Header", fragment)
    [<CustomOperation("Header")>] member inline _.Header ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Header", fragment { yield! fragments })
    [<CustomOperation("Header")>] member inline _.Header ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render ==> html.renderFragment("Header", html.text x)
    [<CustomOperation("Header")>] member inline _.Header ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("Header", html.text x)
    ...
    [<CustomOperation("OnCancel")>] member inline _.OnCancel ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("OnCancel", fn)
    [<CustomOperation("OnCancel")>] member inline _.OnCancel ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("OnCancel", fn)
    [<CustomOperation("OnOk")>] member inline _.OnOk ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("OnOk", fn)
    [<CustomOperation("OnOk")>] member inline _.OnOk ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("OnOk", fn)
    [<CustomOperation("OkButtonProps")>] member inline _.OkButtonProps ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ButtonProps) = render ==> ("OkButtonProps" => x)
    [<CustomOperation("CancelButtonProps")>] member inline _.CancelButtonProps ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ButtonProps) = render ==> ("CancelButtonProps" => x)
    ...
    [<CustomOperation("Maximizable")>] member inline _.Maximizable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Maximizable" =>>> true)
    [<CustomOperation("Maximizable")>] member inline _.Maximizable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Maximizable" =>>> x)
    [<CustomOperation("MaximizeBtnIcon")>] member inline _.MaximizeBtnIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("MaximizeBtnIcon", fragment)
    [<CustomOperation("MaximizeBtnIcon")>] member inline _.MaximizeBtnIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("MaximizeBtnIcon", fragment { yield! fragments })
    ...
    [<CustomOperation("RestoreBtnIcon")>] member inline _.RestoreBtnIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("RestoreBtnIcon", fragment)
    [<CustomOperation("RestoreBtnIcon")>] member inline _.RestoreBtnIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("RestoreBtnIcon", fragment { yield! fragments })
    ...
    [<CustomOperation("DefaultMaximized")>] member inline _.DefaultMaximized ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("DefaultMaximized" =>>> true)
    [<CustomOperation("DefaultMaximized")>] member inline _.DefaultMaximized ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("DefaultMaximized" =>>> x)
    ...
    [<CustomOperation("ForceRender")>] member inline _.ForceRender ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ForceRender" =>>> true)
    [<CustomOperation("ForceRender")>] member inline _.ForceRender ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ForceRender" =>>> x)
...
type PageHeaderBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("BackIconTemplate")>] member inline _.BackIconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("BackIconTemplate", fragment)
    [<CustomOperation("BackIconTemplate")>] member inline _.BackIconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("BackIconTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("SubtitleTemplate")>] member inline _.SubtitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("SubtitleTemplate", fragment)
    [<CustomOperation("SubtitleTemplate")>] member inline _.SubtitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("SubtitleTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("OnBack")>] member inline _.OnBack ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnBack", fn)
    [<CustomOperation("OnBack")>] member inline _.OnBack ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnBack", fn)
    [<CustomOperation("PageHeaderContent")>] member inline _.PageHeaderContent ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PageHeaderContent", fragment)
    [<CustomOperation("PageHeaderContent")>] member inline _.PageHeaderContent ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PageHeaderContent", fragment { yield! fragments })
    ...
    [<CustomOperation("PageHeaderFooter")>] member inline _.PageHeaderFooter ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PageHeaderFooter", fragment)
    [<CustomOperation("PageHeaderFooter")>] member inline _.PageHeaderFooter ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PageHeaderFooter", fragment { yield! fragments })
    ...
    [<CustomOperation("PageHeaderBreadcrumb")>] member inline _.PageHeaderBreadcrumb ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PageHeaderBreadcrumb", fragment)
    [<CustomOperation("PageHeaderBreadcrumb")>] member inline _.PageHeaderBreadcrumb ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PageHeaderBreadcrumb", fragment { yield! fragments })
    ...
    [<CustomOperation("PageHeaderAvatar")>] member inline _.PageHeaderAvatar ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PageHeaderAvatar", fragment)
    [<CustomOperation("PageHeaderAvatar")>] member inline _.PageHeaderAvatar ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PageHeaderAvatar", fragment { yield! fragments })
    ...
    [<CustomOperation("PageHeaderTitle")>] member inline _.PageHeaderTitle ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PageHeaderTitle", fragment)
    [<CustomOperation("PageHeaderTitle")>] member inline _.PageHeaderTitle ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PageHeaderTitle", fragment { yield! fragments })
    ...
    [<CustomOperation("PageHeaderSubtitle")>] member inline _.PageHeaderSubtitle ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PageHeaderSubtitle", fragment)
    [<CustomOperation("PageHeaderSubtitle")>] member inline _.PageHeaderSubtitle ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PageHeaderSubtitle", fragment { yield! fragments })
    ...
    [<CustomOperation("PageHeaderTags")>] member inline _.PageHeaderTags ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PageHeaderTags", fragment)
    [<CustomOperation("PageHeaderTags")>] member inline _.PageHeaderTags ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PageHeaderTags", fragment { yield! fragments })
    ...
    [<CustomOperation("PageHeaderExtra")>] member inline _.PageHeaderExtra ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PageHeaderExtra", fragment)
    [<CustomOperation("PageHeaderExtra")>] member inline _.PageHeaderExtra ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PageHeaderExtra", fragment { yield! fragments })
...
type PaginationBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnPageSizeChanged")>] member inline _.OnPageSizeChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> unit) = render ==> html.callback("OnPageSizeChanged", fn)
    [<CustomOperation("OnPageSizeChanged")>] member inline _.OnPageSizeChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> Task<unit>) = render ==> html.callbackTask("OnPageSizeChanged", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationEventArgs -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationEventArgs -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)
    [<CustomOperation("HideOnSinglePage")>] member inline _.HideOnSinglePage ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("HideOnSinglePage" =>>> true)
    [<CustomOperation("HideOnSinglePage")>] member inline _.HideOnSinglePage ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("HideOnSinglePage" =>>> x)
    [<CustomOperation("ShowSizeChanger")>] member inline _.ShowSizeChanger ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowSizeChanger" =>>> true)
    [<CustomOperation("ShowSizeChanger")>] member inline _.ShowSizeChanger ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowSizeChanger" =>>> x)
    ...
    [<CustomOperation("OnShowSizeChange")>] member inline _.OnShowSizeChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationEventArgs -> unit) = render ==> html.callback("OnShowSizeChange", fn)
    [<CustomOperation("OnShowSizeChange")>] member inline _.OnShowSizeChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationEventArgs -> Task<unit>) = render ==> html.callbackTask("OnShowSizeChange", fn)
    [<CustomOperation("ShowQuickJumper")>] member inline _.ShowQuickJumper ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowQuickJumper" =>>> true)
    [<CustomOperation("ShowQuickJumper")>] member inline _.ShowQuickJumper ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowQuickJumper" =>>> x)
    [<CustomOperation("GoButton")>] member inline _.GoButton ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("GoButton", fragment)
    [<CustomOperation("GoButton")>] member inline _.GoButton ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("GoButton", fragment { yield! fragments })
    ...
    [<CustomOperation("ShowTitle")>] member inline _.ShowTitle ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowTitle" =>>> true)
    [<CustomOperation("ShowTitle")>] member inline _.ShowTitle ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowTitle" =>>> x)
    ...
    [<CustomOperation("ItemRender")>] member inline _.ItemRender ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationItemRenderContext -> NodeRenderFragment) = render ==> html.renderFragment("ItemRender", fn)
    [<CustomOperation("ShowLessItems")>] member inline _.ShowLessItems ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowLessItems" =>>> true)
    [<CustomOperation("ShowLessItems")>] member inline _.ShowLessItems ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowLessItems" =>>> x)
    [<CustomOperation("ShowPrevNextJumpers")>] member inline _.ShowPrevNextJumpers ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowPrevNextJumpers" =>>> true)
    [<CustomOperation("ShowPrevNextJumpers")>] member inline _.ShowPrevNextJumpers ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowPrevNextJumpers" =>>> x)
    ...
    [<CustomOperation("PrevIcon")>] member inline _.PrevIcon ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationItemRenderContext -> NodeRenderFragment) = render ==> html.renderFragment("PrevIcon", fn)
    [<CustomOperation("NextIcon")>] member inline _.NextIcon ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationItemRenderContext -> NodeRenderFragment) = render ==> html.renderFragment("NextIcon", fn)
    [<CustomOperation("JumpPrevIcon")>] member inline _.JumpPrevIcon ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationItemRenderContext -> NodeRenderFragment) = render ==> html.renderFragment("JumpPrevIcon", fn)
    [<CustomOperation("JumpNextIcon")>] member inline _.JumpNextIcon ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationItemRenderContext -> NodeRenderFragment) = render ==> html.renderFragment("JumpNextIcon", fn)
...
type PaginationOptionsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("IsSmall")>] member inline _.IsSmall ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsSmall" =>>> true)
    [<CustomOperation("IsSmall")>] member inline _.IsSmall ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsSmall" =>>> x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
    ...
    [<CustomOperation("ChangeSize")>] member inline _.ChangeSize ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> unit) = render ==> html.callback("ChangeSize", fn)
    [<CustomOperation("ChangeSize")>] member inline _.ChangeSize ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> Task<unit>) = render ==> html.callbackTask("ChangeSize", fn)
    [<CustomOperation("Current")>] member inline _.Current ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("Current" => x)
    [<CustomOperation("PageSize")>] member inline _.PageSize ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("PageSize" => x)
    [<CustomOperation("PageSizeOptions")>] member inline _.PageSizeOptions ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32[]) = render ==> ("PageSizeOptions" => x)
    [<CustomOperation("QuickGo")>] member inline _.QuickGo ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> unit) = render ==> html.callback("QuickGo", fn)
    [<CustomOperation("QuickGo")>] member inline _.QuickGo ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> Task<unit>) = render ==> html.callbackTask("QuickGo", fn)
...
type RadioBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoFocus" =>>> true)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoFocus" =>>> x)
    [<CustomOperation("RadioButton")>] member inline _.RadioButton ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("RadioButton" =>>> true)
    [<CustomOperation("RadioButton")>] member inline _.RadioButton ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("RadioButton" =>>> x)
    [<CustomOperation("Checked")>] member inline _.Checked ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Checked" =>>> true)
    [<CustomOperation("Checked")>] member inline _.Checked ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Checked" =>>> x)
    [<CustomOperation("Checked'")>] member inline _.Checked' ([<InlineIfLambda>] render: AttrRenderFragment, valueFn: System.Boolean * (System.Boolean -> unit)) = render ==> html.bind("Checked", valueFn)
    [<CustomOperation("DefaultChecked")>] member inline _.DefaultChecked ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("DefaultChecked" =>>> true)
    [<CustomOperation("DefaultChecked")>] member inline _.DefaultChecked ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("DefaultChecked" =>>> x)
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("CheckedChanged", fn)
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("CheckedChanged", fn)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
...
type RateBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AllowClear" =>>> true)
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AllowClear" =>>> x)
    [<CustomOperation("AllowHalf")>] member inline _.AllowHalf ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AllowHalf" =>>> true)
    [<CustomOperation("AllowHalf")>] member inline _.AllowHalf ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AllowHalf" =>>> x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoFocus" =>>> true)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoFocus" =>>> x)
    [<CustomOperation("Character")>] member inline _.Character ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.RateItemRenderContext -> NodeRenderFragment) = render ==> html.renderFragment("Character", fn)
    ...
    [<CustomOperation("ValueChanged")>] member inline _.ValueChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Decimal -> unit) = render ==> html.callback("ValueChanged", fn)
    [<CustomOperation("ValueChanged")>] member inline _.ValueChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Decimal -> Task<unit>) = render ==> html.callbackTask("ValueChanged", fn)
...
type RateItemBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AllowHalf")>] member inline _.AllowHalf ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AllowHalf" =>>> true)
    [<CustomOperation("AllowHalf")>] member inline _.AllowHalf ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AllowHalf" =>>> x)
    [<CustomOperation("OnItemHover")>] member inline _.OnItemHover ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnItemHover", fn)
    [<CustomOperation("OnItemHover")>] member inline _.OnItemHover ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnItemHover", fn)
    [<CustomOperation("OnItemClick")>] member inline _.OnItemClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnItemClick", fn)
    [<CustomOperation("OnItemClick")>] member inline _.OnItemClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnItemClick", fn)
    [<CustomOperation("Tooltip")>] member inline _.Tooltip ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Tooltip" => x)
    ...
    [<CustomOperation("HasHalf")>] member inline _.HasHalf ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("HasHalf" =>>> true)
    [<CustomOperation("HasHalf")>] member inline _.HasHalf ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("HasHalf" =>>> x)
    [<CustomOperation("IsFocused")>] member inline _.IsFocused ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsFocused" =>>> true)
    [<CustomOperation("IsFocused")>] member inline _.IsFocused ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsFocused" =>>> x)
...
type ResultBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Extra")>] member inline _.Extra ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("Extra", html.text x)
    [<CustomOperation("Extra")>] member inline _.Extra ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("Extra", html.text x)
    [<CustomOperation("Status")>] member inline _.Status ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ResultStatus) = render ==> ("Status" => x)
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Icon" => x)
    [<CustomOperation("IsShowIcon")>] member inline _.IsShowIcon ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsShowIcon" =>>> true)
    [<CustomOperation("IsShowIcon")>] member inline _.IsShowIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsShowIcon" =>>> x)
...
type SkeletonBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Loading" =>>> true)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Loading" =>>> x)
    [<CustomOperation("Title")>] member inline _.Title ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Title" =>>> true)
    [<CustomOperation("Title")>] member inline _.Title ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Title" =>>> x)
    ...
    [<CustomOperation("Avatar")>] member inline _.Avatar ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Avatar" =>>> true)
    [<CustomOperation("Avatar")>] member inline _.Avatar ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Avatar" =>>> x)
    [<CustomOperation("AvatarSize")>] member inline _.AvatarSize ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.SkeletonElementSize, System.String>) = render ==> ("AvatarSize" => x)
    [<CustomOperation("AvatarShape")>] member inline _.AvatarShape ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.SkeletonElementShape) = render ==> ("AvatarShape" => x)
    [<CustomOperation("Paragraph")>] member inline _.Paragraph ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Paragraph" =>>> true)
    [<CustomOperation("Paragraph")>] member inline _.Paragraph ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Paragraph" =>>> x)
...
type SkeletonElementBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Active")>] member inline _.Active ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Active" =>>> true)
    [<CustomOperation("Active")>] member inline _.Active ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Active" =>>> x)
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.SkeletonElementType) = render ==> ("Type" => x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.SkeletonElementSize, System.String>) = render ==> ("Size" => x)
    [<CustomOperation("Shape")>] member inline _.Shape ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.SkeletonElementShape) = render ==> ("Shape" => x)
...
type SpaceBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Wrap")>] member inline _.Wrap ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Wrap" =>>> true)
    [<CustomOperation("Wrap")>] member inline _.Wrap ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Wrap" =>>> x)
    [<CustomOperation("Split")>] member inline _.Split ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Split", fragment)
    [<CustomOperation("Split")>] member inline _.Split ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Split", fragment { yield! fragments })
...
type SpinBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.SpinSize) = render ==> ("Size" => x)
    ...
    [<CustomOperation("Spinning")>] member inline _.Spinning ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Spinning" =>>> true)
    [<CustomOperation("Spinning")>] member inline _.Spinning ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Spinning" =>>> x)
    ...
    [<CustomOperation("Indicator")>] member inline _.Indicator ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Indicator", fragment)
    [<CustomOperation("Indicator")>] member inline _.Indicator ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Indicator", fragment { yield! fragments })
...
type StatisticComponentBaseBuilder<'FunBlazorGeneric, 'T when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Prefix")>] member inline _.Prefix ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Prefix" => x)
    [<CustomOperation("PrefixTemplate")>] member inline _.PrefixTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PrefixTemplate", fragment)
    [<CustomOperation("PrefixTemplate")>] member inline _.PrefixTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PrefixTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("SuffixTemplate")>] member inline _.SuffixTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("SuffixTemplate", fragment)
    [<CustomOperation("SuffixTemplate")>] member inline _.SuffixTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("SuffixTemplate", fragment { yield! fragments })
...
type StepBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Icon" => x)
    [<CustomOperation("IconTemplate")>] member inline _.IconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.StepsStatus -> NodeRenderFragment) = render ==> html.renderFragment("IconTemplate", fn)
    [<CustomOperation("Status")>] member inline _.Status ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.StepsStatus) = render ==> ("Status" => x)
    [<CustomOperation("Title")>] member inline _.Title ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Title" => x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("TitleTemplate", fragment)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("TitleTemplate", fragment { yield! fragments })
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render ==> html.renderFragment("TitleTemplate", html.text x)
...
type StepsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ProgressDot")>] member inline _.ProgressDot ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("ProgressDot", fragment)
    [<CustomOperation("ProgressDot")>] member inline _.ProgressDot ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("ProgressDot", fragment { yield! fragments })
    ...
    [<CustomOperation("ShowProgressDot")>] member inline _.ShowProgressDot ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowProgressDot" =>>> true)
    [<CustomOperation("ShowProgressDot")>] member inline _.ShowProgressDot ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowProgressDot" =>>> x)
    [<CustomOperation("Direction")>] member inline _.Direction ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.StepsDirection) = render ==> ("Direction" => x)
    [<CustomOperation("LabelPlacement")>] member inline _.LabelPlacement ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.StepsLabelPlacement) = render ==> ("LabelPlacement" => x)
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.StepsType) = render ==> ("Type" => x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.StepsSize) = render ==> ("Size" => x)
    ...
    [<CustomOperation("Status")>] member inline _.Status ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.StepsStatus) = render ==> ("Status" => x)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)

type TableBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("AutoColIndexes")>] member inline _.AutoColIndexes ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoColIndexes" =>>> true)
    [<CustomOperation("AutoColIndexes")>] member inline _.AutoColIndexes ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoColIndexes" =>>> x)
    ...
    [<CustomOperation("DataSource")>] member inline _.DataSource ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.IEnumerable<'TItem>) = render ==> ("DataSource" => x)
    [<CustomOperation("ChildContent")>] member inline _.ChildContent ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem -> NodeRenderFragment) = render ==> html.renderFragment("ChildContent", fn)
    [<CustomOperation("GroupTitleTemplate")>] member inline _.GroupTitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.GroupResult<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("GroupTitleTemplate", fn)
    [<CustomOperation("GroupFooterTemplate")>] member inline _.GroupFooterTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.GroupResult<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("GroupFooterTemplate", fn)
    [<CustomOperation("RowTemplate")>] member inline _.RowTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.RowData<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("RowTemplate", fn)
    [<CustomOperation("ColumnDefinitions")>] member inline _.ColumnDefinitions ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem -> NodeRenderFragment) = render ==> html.renderFragment("ColumnDefinitions", fn)
    [<CustomOperation("HeaderTemplate")>] member inline _.HeaderTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem -> NodeRenderFragment) = render ==> html.renderFragment("HeaderTemplate", fn)
    [<CustomOperation("ExpandTemplate")>] member inline _.ExpandTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.RowData<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("ExpandTemplate", fn)
    [<CustomOperation("DefaultExpandAllRows")>] member inline _.DefaultExpandAllRows ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("DefaultExpandAllRows" =>>> true)
    [<CustomOperation("DefaultExpandAllRows")>] member inline _.DefaultExpandAllRows ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("DefaultExpandAllRows" =>>> x)
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.QueryModel<'TItem> -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.QueryModel<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)
    ...
    [<CustomOperation("AutoHeight")>] member inline _.AutoHeight ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoHeight" =>>> true)
    [<CustomOperation("AutoHeight")>] member inline _.AutoHeight ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoHeight" =>>> x)
    ...
    [<CustomOperation("OnExpand")>] member inline _.OnExpand ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.RowData<'TItem> -> unit) = render ==> html.callback("OnExpand", fn)
    [<CustomOperation("OnExpand")>] member inline _.OnExpand ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.RowData<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnExpand", fn)
    [<CustomOperation("SortDirections")>] member inline _.SortDirections ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.SortDirection[]) = render ==> ("SortDirections" => x)
    ...
    [<CustomOperation("OnRowClick")>] member inline _.OnRowClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.RowData<'TItem> -> unit) = render ==> html.callback("OnRowClick", fn)
    [<CustomOperation("OnRowClick")>] member inline _.OnRowClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TableModels.RowData<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnRowClick", fn)
    [<CustomOperation("RemoteDataSource")>] member inline _.RemoteDataSource ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("RemoteDataSource" =>>> true)
    [<CustomOperation("RemoteDataSource")>] member inline _.RemoteDataSource ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("RemoteDataSource" =>>> x)
    [<CustomOperation("Responsive")>] member inline _.Responsive ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Responsive" =>>> true)
    [<CustomOperation("Responsive")>] member inline _.Responsive ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Responsive" =>>> x)
    ...
    [<CustomOperation("PaginationTemplate")>] member inline _.PaginationTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.ValueTuple<System.Int32, System.Int32, System.Int32, System.String, Microsoft.AspNetCore.Components.EventCallback<AntDesign.PaginationEventArgs>> -> NodeRenderFragment) = render ==> html.renderFragment("PaginationTemplate", fn)
    [<CustomOperation("Total")>] member inline _.Total ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("Total" => x)
    ...
    [<CustomOperation("TotalChanged")>] member inline _.TotalChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> unit) = render ==> html.callback("TotalChanged", fn)
    [<CustomOperation("TotalChanged")>] member inline _.TotalChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> Task<unit>) = render ==> html.callbackTask("TotalChanged", fn)
    ...
    [<CustomOperation("PageIndexChanged")>] member inline _.PageIndexChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> unit) = render ==> html.callback("PageIndexChanged", fn)
    [<CustomOperation("PageIndexChanged")>] member inline _.PageIndexChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> Task<unit>) = render ==> html.callbackTask("PageIndexChanged", fn)
    [<CustomOperation("PageSize")>] member inline _.PageSize ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("PageSize" => x)
    ...
    [<CustomOperation("OnPageIndexChange")>] member inline _.OnPageIndexChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationEventArgs -> unit) = render ==> html.callback("OnPageIndexChange", fn)
    [<CustomOperation("OnPageIndexChange")>] member inline _.OnPageIndexChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationEventArgs -> Task<unit>) = render ==> html.callbackTask("OnPageIndexChange", fn)
    [<CustomOperation("OnPageSizeChange")>] member inline _.OnPageSizeChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationEventArgs -> unit) = render ==> html.callback("OnPageSizeChange", fn)
    [<CustomOperation("OnPageSizeChange")>] member inline _.OnPageSizeChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationEventArgs -> Task<unit>) = render ==> html.callbackTask("OnPageSizeChange", fn)
    ...
    [<CustomOperation("SelectedRowsChanged")>] member inline _.SelectedRowsChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Collections.Generic.IEnumerable<'TItem> -> unit) = render ==> html.callback("SelectedRowsChanged", fn)
    [<CustomOperation("SelectedRowsChanged")>] member inline _.SelectedRowsChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Collections.Generic.IEnumerable<'TItem> -> Task<unit>) = render ==> html.callbackTask("SelectedRowsChanged", fn)
    [<CustomOperation("OnSelectAll")>] member inline _.OnSelectAll ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("OnSelectAll", fn)
    [<CustomOperation("OnSelectAll")>] member inline _.OnSelectAll ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnSelectAll", fn)
...
type TabPaneBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("TabTemplate")>] member inline _.TabTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("TabTemplate", fragment)
    [<CustomOperation("TabTemplate")>] member inline _.TabTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("TabTemplate", fragment { yield! fragments })
    ...
    [<CustomOperation("TabContextMenu")>] member inline _.TabContextMenu ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("TabContextMenu", fragment)
    [<CustomOperation("TabContextMenu")>] member inline _.TabContextMenu ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("TabContextMenu", fragment { yield! fragments })
...
type TagBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> unit) = render ==> html.callback("CheckedChanged", fn)
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("CheckedChanged", fn)
    [<CustomOperation("Color")>] member inline _.Color ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.TagColor, System.String>) = render ==> ("Color" => x)
    [<CustomOperation("PresetColor")>] member inline _.PresetColor ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("PresetColor" => x)
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Icon" => x)
    [<CustomOperation("IconTheme")>] member inline _.IconTheme ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.IconThemeType) = render ==> ("IconTheme" => x)
    [<CustomOperation("IconTemplate")>] member inline _.IconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("IconTemplate", fragment)
    [<CustomOperation("IconTemplate")>] member inline _.IconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("IconTemplate", fragment { yield! fragments })
    [<CustomOperation("IconTemplate")>] member inline _.IconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render ==> html.renderFragment("IconTemplate", html.text x)
    [<CustomOperation("IconTemplate")>] member inline _.IconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("IconTemplate", html.text x)
    [<CustomOperation("IconTemplate")>] member inline _.IconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("IconTemplate", html.text x)
    [<CustomOperation("NoAnimation")>] member inline _.NoAnimation ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("NoAnimation" =>>> true)
    [<CustomOperation("NoAnimation")>] member inline _.NoAnimation ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("NoAnimation" =>>> x)
    [<CustomOperation("OnClose")>] member inline _.OnClose ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("OnClose", fn)
    [<CustomOperation("OnClose")>] member inline _.OnClose ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("OnClose", fn)
    [<CustomOperation("OnClosing")>] member inline _.OnClosing ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.CloseEventArgs<Microsoft.AspNetCore.Components.Web.MouseEventArgs> -> unit) = render ==> html.callback("OnClosing", fn)
    [<CustomOperation("OnClosing")>] member inline _.OnClosing ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.CloseEventArgs<Microsoft.AspNetCore.Components.Web.MouseEventArgs> -> Task<unit>) = render ==> html.callbackTask("OnClosing", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnClick", fn)
    [<CustomOperation("Visible")>] member inline _.Visible ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Visible" =>>> true)
    [<CustomOperation("Visible")>] member inline _.Visible ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Visible" =>>> x)
...
type TimelineBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("PendingDot")>] member inline _.PendingDot ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("PendingDot", fragment)
    [<CustomOperation("PendingDot")>] member inline _.PendingDot ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("PendingDot", fragment { yield! fragments })
...
type TimelineItemBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Dot")>] member inline _.Dot ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Dot", fragment)
    [<CustomOperation("Dot")>] member inline _.Dot ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Dot", fragment { yield! fragments })
    ...
    [<CustomOperation("Color")>] member inline _.Color ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<AntDesign.TimelineDotColor, System.String>) = render ==> ("Color" => x)
    [<CustomOperation("Label")>] member inline _.Label ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Label" => x)
...
type TransferBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowSearch")>] member inline _.ShowSearch ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowSearch" =>>> true)
    [<CustomOperation("ShowSearch")>] member inline _.ShowSearch ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowSearch" =>>> x)
    [<CustomOperation("ShowSelectAll")>] member inline _.ShowSelectAll ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowSelectAll" =>>> true)
    [<CustomOperation("ShowSelectAll")>] member inline _.ShowSelectAll ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowSelectAll" =>>> x)
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TransferChangeArgs -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TransferChangeArgs -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)
    [<CustomOperation("OnScroll")>] member inline _.OnScroll ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TransferScrollArgs -> unit) = render ==> html.callback("OnScroll", fn)
    [<CustomOperation("OnScroll")>] member inline _.OnScroll ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TransferScrollArgs -> Task<unit>) = render ==> html.callbackTask("OnScroll", fn)
    [<CustomOperation("OnSearch")>] member inline _.OnSearch ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TransferSearchArgs -> unit) = render ==> html.callback("OnSearch", fn)
    [<CustomOperation("OnSearch")>] member inline _.OnSearch ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TransferSearchArgs -> Task<unit>) = render ==> html.callbackTask("OnSearch", fn)
    [<CustomOperation("OnSelectChange")>] member inline _.OnSelectChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TransferSelectChangeArgs -> unit) = render ==> html.callback("OnSelectChange", fn)
    [<CustomOperation("OnSelectChange")>] member inline _.OnSelectChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TransferSelectChangeArgs -> Task<unit>) = render ==> html.callbackTask("OnSelectChange", fn)
...
type TreeBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("ShowExpand")>] member inline _.ShowExpand ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowExpand" =>>> true)
    [<CustomOperation("ShowExpand")>] member inline _.ShowExpand ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowExpand" =>>> x)
    [<CustomOperation("ShowLine")>] member inline _.ShowLine ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowLine" =>>> true)
    [<CustomOperation("ShowLine")>] member inline _.ShowLine ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowLine" =>>> x)
    [<CustomOperation("ShowIcon")>] member inline _.ShowIcon ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowIcon" =>>> true)
    [<CustomOperation("ShowIcon")>] member inline _.ShowIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowIcon" =>>> x)
    [<CustomOperation("BlockNode")>] member inline _.BlockNode ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("BlockNode" =>>> true)
    [<CustomOperation("BlockNode")>] member inline _.BlockNode ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("BlockNode" =>>> x)
    [<CustomOperation("Draggable")>] member inline _.Draggable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Draggable" =>>> true)
    [<CustomOperation("Draggable")>] member inline _.Draggable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Draggable" =>>> x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
    ...
    [<CustomOperation("Nodes")>] member inline _.Nodes ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("Nodes", fragment)
    [<CustomOperation("Nodes")>] member inline _.Nodes ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("Nodes", fragment { yield! fragments })
    ...
    [<CustomOperation("SelectedKeyChanged")>] member inline _.SelectedKeyChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> unit) = render ==> html.callback("SelectedKeyChanged", fn)
    [<CustomOperation("SelectedKeyChanged")>] member inline _.SelectedKeyChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> Task<unit>) = render ==> html.callbackTask("SelectedKeyChanged", fn)
    ...
    [<CustomOperation("SelectedNodeChanged")>] member inline _.SelectedNodeChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> unit) = render ==> html.callback("SelectedNodeChanged", fn)
    [<CustomOperation("SelectedNodeChanged")>] member inline _.SelectedNodeChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> Task<unit>) = render ==> html.callbackTask("SelectedNodeChanged", fn)
    ...
    [<CustomOperation("SelectedDataChanged")>] member inline _.SelectedDataChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem -> unit) = render ==> html.callback("SelectedDataChanged", fn)
    [<CustomOperation("SelectedDataChanged")>] member inline _.SelectedDataChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem -> Task<unit>) = render ==> html.callbackTask("SelectedDataChanged", fn)
    [<CustomOperation("SelectedKeys")>] member inline _.SelectedKeys ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String[]) = render ==> ("SelectedKeys" => x)
    [<CustomOperation("SelectedKeys'")>] member inline _.SelectedKeys' ([<InlineIfLambda>] render: AttrRenderFragment, valueFn: System.String[] * (System.String[] -> unit)) = render ==> html.bind("SelectedKeys", valueFn)
    [<CustomOperation("SelectedKeysChanged")>] member inline _.SelectedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> unit) = render ==> html.callback("SelectedKeysChanged", fn)
    [<CustomOperation("SelectedKeysChanged")>] member inline _.SelectedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> Task<unit>) = render ==> html.callbackTask("SelectedKeysChanged", fn)
    ...
    [<CustomOperation("SelectedNodesChanged")>] member inline _.SelectedNodesChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem>[] -> unit) = render ==> html.callback("SelectedNodesChanged", fn)
    [<CustomOperation("SelectedNodesChanged")>] member inline _.SelectedNodesChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem>[] -> Task<unit>) = render ==> html.callbackTask("SelectedNodesChanged", fn)
    ...
    [<CustomOperation("SelectedDatasChanged")>] member inline _.SelectedDatasChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem[] -> unit) = render ==> html.callback("SelectedDatasChanged", fn)
    [<CustomOperation("SelectedDatasChanged")>] member inline _.SelectedDatasChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: 'TItem[] -> Task<unit>) = render ==> html.callbackTask("SelectedDatasChanged", fn)
    [<CustomOperation("Checkable")>] member inline _.Checkable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Checkable" =>>> true)
    [<CustomOperation("Checkable")>] member inline _.Checkable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Checkable" =>>> x)
    [<CustomOperation("CheckOnClickNode")>] member inline _.CheckOnClickNode ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("CheckOnClickNode" =>>> true)
    [<CustomOperation("CheckOnClickNode")>] member inline _.CheckOnClickNode ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("CheckOnClickNode" =>>> x)
    ...
    [<CustomOperation("CheckedKeysChanged")>] member inline _.CheckedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> unit) = render ==> html.callback("CheckedKeysChanged", fn)
    [<CustomOperation("CheckedKeysChanged")>] member inline _.CheckedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> Task<unit>) = render ==> html.callbackTask("CheckedKeysChanged", fn)
    ...
    [<CustomOperation("MatchedStyle")>] member inline _.MatchedStyle ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("MatchedStyle" => x)
    [<CustomOperation("MatchedClass")>] member inline _.MatchedClass ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("MatchedClass" => x)
    [<CustomOperation("HideUnmatched")>] member inline _.HideUnmatched ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("HideUnmatched" =>>> true)
    [<CustomOperation("HideUnmatched")>] member inline _.HideUnmatched ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("HideUnmatched" =>>> x)
    [<CustomOperation("DataSource")>] member inline _.DataSource ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.IEnumerable<'TItem>) = render ==> ("DataSource" => x)
    [<CustomOperation("TitleExpression")>] member inline _.TitleExpression ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("TitleExpression" => (System.Func<AntDesign.TreeNode<'TItem>, System.String>fn))
    [<CustomOperation("KeyExpression")>] member inline _.KeyExpression ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("KeyExpression" => (System.Func<AntDesign.TreeNode<'TItem>, System.String>fn))
    [<CustomOperation("IconExpression")>] member inline _.IconExpression ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("IconExpression" => (System.Func<AntDesign.TreeNode<'TItem>, System.String>fn))
    ...
    [<CustomOperation("OnNodeLoadDelayAsync")>] member inline _.OnNodeLoadDelayAsync ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnNodeLoadDelayAsync", fn)
    [<CustomOperation("OnNodeLoadDelayAsync")>] member inline _.OnNodeLoadDelayAsync ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnNodeLoadDelayAsync", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnClick", fn)
    [<CustomOperation("OnDblClick")>] member inline _.OnDblClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnDblClick", fn)
    [<CustomOperation("OnDblClick")>] member inline _.OnDblClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnDblClick", fn)
    [<CustomOperation("OnContextMenu")>] member inline _.OnContextMenu ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnContextMenu", fn)
    [<CustomOperation("OnContextMenu")>] member inline _.OnContextMenu ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnContextMenu", fn)
    [<CustomOperation("OnCheck")>] member inline _.OnCheck ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnCheck", fn)
    [<CustomOperation("OnCheck")>] member inline _.OnCheck ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnCheck", fn)
    [<CustomOperation("OnSelect")>] member inline _.OnSelect ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnSelect", fn)
    [<CustomOperation("OnSelect")>] member inline _.OnSelect ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnSelect", fn)
    [<CustomOperation("OnUnselect")>] member inline _.OnUnselect ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnUnselect", fn)
    [<CustomOperation("OnUnselect")>] member inline _.OnUnselect ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnUnselect", fn)
    [<CustomOperation("OnExpandChanged")>] member inline _.OnExpandChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnExpandChanged", fn)
    [<CustomOperation("OnExpandChanged")>] member inline _.OnExpandChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnExpandChanged", fn)
    [<CustomOperation("IndentTemplate")>] member inline _.IndentTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("IndentTemplate", fn)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("TitleTemplate", fn)
    [<CustomOperation("TitleIconTemplate")>] member inline _.TitleIconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("TitleIconTemplate", fn)
    [<CustomOperation("SwitcherIconTemplate")>] member inline _.SwitcherIconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("SwitcherIconTemplate", fn)
    [<CustomOperation("OnDragStart")>] member inline _.OnDragStart ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnDragStart", fn)
    [<CustomOperation("OnDragStart")>] member inline _.OnDragStart ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnDragStart", fn)
    [<CustomOperation("OnDragEnter")>] member inline _.OnDragEnter ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnDragEnter", fn)
    [<CustomOperation("OnDragEnter")>] member inline _.OnDragEnter ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnDragEnter", fn)
    [<CustomOperation("OnDragLeave")>] member inline _.OnDragLeave ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnDragLeave", fn)
    [<CustomOperation("OnDragLeave")>] member inline _.OnDragLeave ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnDragLeave", fn)
    [<CustomOperation("OnDrop")>] member inline _.OnDrop ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnDrop", fn)
    [<CustomOperation("OnDrop")>] member inline _.OnDrop ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnDrop", fn)
    [<CustomOperation("OnDragEnd")>] member inline _.OnDragEnd ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> unit) = render ==> html.callback("OnDragEnd", fn)
    [<CustomOperation("OnDragEnd")>] member inline _.OnDragEnd ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeEventArgs<'TItem> -> Task<unit>) = render ==> html.callbackTask("OnDragEnd", fn)
    [<CustomOperation("DraggableExpression")>] member inline _.DraggableExpression ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DraggableExpression" => (System.Func<AntDesign.TreeNode<'TItem>, System.Boolean>fn))
    [<CustomOperation("DroppableExpression")>] member inline _.DroppableExpression ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DroppableExpression" => (System.Func<AntDesign.TreeNode<'TItem>, AntDesign.TreeNode<'TItem>, System.Boolean, System.Boolean>fn))
    [<CustomOperation("ExpandOnClickNode")>] member inline _.ExpandOnClickNode ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ExpandOnClickNode" =>>> true)
    [<CustomOperation("ExpandOnClickNode")>] member inline _.ExpandOnClickNode ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ExpandOnClickNode" =>>> x)
    [<CustomOperation("DefaultExpandAll")>] member inline _.DefaultExpandAll ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("DefaultExpandAll" =>>> true)
    [<CustomOperation("DefaultExpandAll")>] member inline _.DefaultExpandAll ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("DefaultExpandAll" =>>> x)
    [<CustomOperation("DefaultExpandParent")>] member inline _.DefaultExpandParent ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("DefaultExpandParent" =>>> true)
    [<CustomOperation("DefaultExpandParent")>] member inline _.DefaultExpandParent ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("DefaultExpandParent" =>>> x)
    ...
    [<CustomOperation("ExpandedKeysChanged")>] member inline _.ExpandedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> unit) = render ==> html.callback("ExpandedKeysChanged", fn)
    [<CustomOperation("ExpandedKeysChanged")>] member inline _.ExpandedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String[] -> Task<unit>) = render ==> html.callbackTask("ExpandedKeysChanged", fn)
    [<CustomOperation("OnExpand")>] member inline _.OnExpand ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.ValueTuple<System.String[], AntDesign.TreeNode<'TItem>, System.Boolean> -> unit) = render ==> html.callback("OnExpand", fn)
    [<CustomOperation("OnExpand")>] member inline _.OnExpand ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.ValueTuple<System.String[], AntDesign.TreeNode<'TItem>, System.Boolean> -> Task<unit>) = render ==> html.callbackTask("OnExpand", fn)
    [<CustomOperation("AutoExpandParent")>] member inline _.AutoExpandParent ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoExpandParent" =>>> true)
    [<CustomOperation("AutoExpandParent")>] member inline _.AutoExpandParent ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoExpandParent" =>>> x)
...
type TreeNodeBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Loading" =>>> true)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Loading" =>>> x)
    [<CustomOperation("IsLeaf")>] member inline _.IsLeaf ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("IsLeaf" =>>> true)
    [<CustomOperation("IsLeaf")>] member inline _.IsLeaf ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("IsLeaf" =>>> x)
    ...
    [<CustomOperation("Selectable")>] member inline _.Selectable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Selectable" =>>> true)
    [<CustomOperation("Selectable")>] member inline _.Selectable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Selectable" =>>> x)
    [<CustomOperation("DisableCheckbox")>] member inline _.DisableCheckbox ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("DisableCheckbox" =>>> true)
    [<CustomOperation("DisableCheckbox")>] member inline _.DisableCheckbox ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("DisableCheckbox" =>>> x)
    [<CustomOperation("Draggable")>] member inline _.Draggable ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Draggable" =>>> true)
    [<CustomOperation("Draggable")>] member inline _.Draggable ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Draggable" =>>> x)
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Icon" => x)
    [<CustomOperation("IconTemplate")>] member inline _.IconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("IconTemplate", fn)
    [<CustomOperation("SwitcherIcon")>] member inline _.SwitcherIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("SwitcherIcon" => x)
    [<CustomOperation("SwitcherIconTemplate")>] member inline _.SwitcherIconTemplate ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.TreeNode<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("SwitcherIconTemplate", fn)
    [<CustomOperation("Title")>] member inline _.Title ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Title" => x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("TitleTemplate", fragment)
...
type UploadBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ListType")>] member inline _.ListType ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.UploadListType) = render ==> ("ListType" => x)
    [<CustomOperation("Directory")>] member inline _.Directory ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Directory" =>>> true)
    [<CustomOperation("Directory")>] member inline _.Directory ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Directory" =>>> x)
    [<CustomOperation("Multiple")>] member inline _.Multiple ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Multiple" =>>> true)
    [<CustomOperation("Multiple")>] member inline _.Multiple ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Multiple" =>>> x)
    [<CustomOperation("Accept")>] member inline _.Accept ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Accept" => x)
    [<CustomOperation("ShowUploadList")>] member inline _.ShowUploadList ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowUploadList" =>>> true)
    [<CustomOperation("ShowUploadList")>] member inline _.ShowUploadList ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowUploadList" =>>> x)
    [<CustomOperation("ShowDownloadIcon")>] member inline _.ShowDownloadIcon ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowDownloadIcon" =>>> true)
    [<CustomOperation("ShowDownloadIcon")>] member inline _.ShowDownloadIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowDownloadIcon" =>>> x)
    [<CustomOperation("ShowPreviewIcon")>] member inline _.ShowPreviewIcon ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowPreviewIcon" =>>> true)
    [<CustomOperation("ShowPreviewIcon")>] member inline _.ShowPreviewIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowPreviewIcon" =>>> x)
    [<CustomOperation("ShowRemoveIcon")>] member inline _.ShowRemoveIcon ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowRemoveIcon" =>>> true)
    [<CustomOperation("ShowRemoveIcon")>] member inline _.ShowRemoveIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowRemoveIcon" =>>> x)
    ...
    [<CustomOperation("FileListChanged")>] member inline _.FileListChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Collections.Generic.List<AntDesign.UploadFileItem> -> unit) = render ==> html.callback("FileListChanged", fn)
    [<CustomOperation("FileListChanged")>] member inline _.FileListChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Collections.Generic.List<AntDesign.UploadFileItem> -> Task<unit>) = render ==> html.callbackTask("FileListChanged", fn)
    ...
    [<CustomOperation("OnSingleCompleted")>] member inline _.OnSingleCompleted ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadInfo -> unit) = render ==> html.callback("OnSingleCompleted", fn)
    [<CustomOperation("OnSingleCompleted")>] member inline _.OnSingleCompleted ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadInfo -> Task<unit>) = render ==> html.callbackTask("OnSingleCompleted", fn)
    [<CustomOperation("OnCompleted")>] member inline _.OnCompleted ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadInfo -> unit) = render ==> html.callback("OnCompleted", fn)
    [<CustomOperation("OnCompleted")>] member inline _.OnCompleted ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadInfo -> Task<unit>) = render ==> html.callbackTask("OnCompleted", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadInfo -> unit) = render ==> html.callback("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadInfo -> Task<unit>) = render ==> html.callbackTask("OnChange", fn)
    ...
    [<CustomOperation("OnPreview")>] member inline _.OnPreview ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadFileItem -> unit) = render ==> html.callback("OnPreview", fn)
    [<CustomOperation("OnPreview")>] member inline _.OnPreview ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadFileItem -> Task<unit>) = render ==> html.callbackTask("OnPreview", fn)
    [<CustomOperation("OnDownload")>] member inline _.OnDownload ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadFileItem -> unit) = render ==> html.callback("OnDownload", fn)
    [<CustomOperation("OnDownload")>] member inline _.OnDownload ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.UploadFileItem -> Task<unit>) = render ==> html.callbackTask("OnDownload", fn)
...
type WatermarkBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Scrolling")>] member inline _.Scrolling ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Scrolling" =>>> true)
    [<CustomOperation("Scrolling")>] member inline _.Scrolling ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Scrolling" =>>> x)
    ...
    [<CustomOperation("Repeat")>] member inline _.Repeat ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Repeat" =>>> true)
    [<CustomOperation("Repeat")>] member inline _.Repeat ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Repeat" =>>> x)
    [<CustomOperation("Grayscale")>] member inline _.Grayscale ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Grayscale" =>>> true)
    [<CustomOperation("Grayscale")>] member inline _.Grayscale ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Grayscale" =>>> x)
...
type PaginationPagerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("Disabled" =>>> true)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("Disabled" =>>> x)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> unit) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.Int32 -> Task<unit>) = render ==> html.callbackTask("OnClick", fn)
    [<CustomOperation("OnKeyPress")>] member inline _.OnKeyPress ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.ValueTuple<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs, System.Action> -> unit) = render ==> html.callback("OnKeyPress", fn)
    [<CustomOperation("OnKeyPress")>] member inline _.OnKeyPress ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.ValueTuple<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs, System.Action> -> Task<unit>) = render ==> html.callbackTask("OnKeyPress", fn)
    [<CustomOperation("ItemRender")>] member inline _.ItemRender ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.PaginationItemRenderContext -> NodeRenderFragment) = render ==> html.renderFragment("ItemRender", fn)
    [<CustomOperation("UnmatchedAttributes")>] member inline _.UnmatchedAttributes ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.Dictionary<System.String, System.Object>) = render ==> ("UnmatchedAttributes" => x)
...
type SelectContentBuilder<'FunBlazorGeneric, 'TItemValue, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.FocusEventArgs -> unit) = render ==> html.callback("OnBlur", fn)
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.FocusEventArgs -> Task<unit>) = render ==> html.callbackTask("OnBlur", fn)
    [<CustomOperation("OnClearClick")>] member inline _.OnClearClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> unit) = render ==> html.callback("OnClearClick", fn)
    [<CustomOperation("OnClearClick")>] member inline _.OnClearClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.MouseEventArgs -> Task<unit>) = render ==> html.callbackTask("OnClearClick", fn)
    [<CustomOperation("OnRemoveSelected")>] member inline _.OnRemoveSelected ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.Select.Internal.SelectOptionItem<'TItemValue, 'TItem> -> unit) = render ==> html.callback("OnRemoveSelected", fn)
    [<CustomOperation("OnRemoveSelected")>] member inline _.OnRemoveSelected ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.Select.Internal.SelectOptionItem<'TItemValue, 'TItem> -> Task<unit>) = render ==> html.callbackTask("OnRemoveSelected", fn)
    [<CustomOperation("SearchValue")>] member inline _.SearchValue ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("SearchValue" => x)
    [<CustomOperation("SearchDebounceMilliseconds")>] member inline _.SearchDebounceMilliseconds ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("SearchDebounceMilliseconds" => x)
...
type OverlayBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("OnOverlayMouseEnter")>] member inline _.OnOverlayMouseEnter ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnOverlayMouseEnter", fn)
    [<CustomOperation("OnOverlayMouseEnter")>] member inline _.OnOverlayMouseEnter ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnOverlayMouseEnter", fn)
    [<CustomOperation("OnOverlayMouseLeave")>] member inline _.OnOverlayMouseLeave ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnOverlayMouseLeave", fn)
    [<CustomOperation("OnOverlayMouseLeave")>] member inline _.OnOverlayMouseLeave ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnOverlayMouseLeave", fn)
    [<CustomOperation("OnOverlayMouseUp")>] member inline _.OnOverlayMouseUp ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnOverlayMouseUp", fn)
    [<CustomOperation("OnOverlayMouseUp")>] member inline _.OnOverlayMouseUp ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnOverlayMouseUp", fn)
    [<CustomOperation("OnShow")>] member inline _.OnShow ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnShow", fn)
    [<CustomOperation("OnShow")>] member inline _.OnShow ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnShow", fn)
    [<CustomOperation("OnHide")>] member inline _.OnHide ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnHide", fn)
    [<CustomOperation("OnHide")>] member inline _.OnHide ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnHide", fn)
...
type DatePickerInputBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AutoFocus" =>>> true)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AutoFocus" =>>> x)
    [<CustomOperation("ShowSuffixIcon")>] member inline _.ShowSuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("ShowSuffixIcon" =>>> true)
    [<CustomOperation("ShowSuffixIcon")>] member inline _.ShowSuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("ShowSuffixIcon" =>>> x)
    ...
    [<CustomOperation("Onfocus")>] member inline _.Onfocus ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("Onfocus", fn)
    [<CustomOperation("Onfocus")>] member inline _.Onfocus ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("Onfocus", fn)
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnBlur", fn)
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnBlur", fn)
    [<CustomOperation("Onfocusout")>] member inline _.Onfocusout ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("Onfocusout", fn)
    [<CustomOperation("Onfocusout")>] member inline _.Onfocusout ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("Onfocusout", fn)
    [<CustomOperation("OnKeyUp")>] member inline _.OnKeyUp ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.KeyboardEventArgs -> unit) = render ==> html.callback("OnKeyUp", fn)
    [<CustomOperation("OnKeyUp")>] member inline _.OnKeyUp ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.KeyboardEventArgs -> Task<unit>) = render ==> html.callbackTask("OnKeyUp", fn)
    [<CustomOperation("OnKeyDown")>] member inline _.OnKeyDown ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.KeyboardEventArgs -> unit) = render ==> html.callback("OnKeyDown", fn)
    [<CustomOperation("OnKeyDown")>] member inline _.OnKeyDown ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: Microsoft.AspNetCore.Components.Web.KeyboardEventArgs -> Task<unit>) = render ==> html.callbackTask("OnKeyDown", fn)
    ...
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment) = render ==> ("AllowClear" =>>> true)
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment, x: bool) = render ==> ("AllowClear" =>>> x)
    [<CustomOperation("OnClickClear")>] member inline _.OnClickClear ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnClickClear", fn)
    [<CustomOperation("OnClickClear")>] member inline _.OnClickClear ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnClickClear", fn)
    [<CustomOperation("OnSuffixIconClick")>] member inline _.OnSuffixIconClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> unit) = render ==> html.callback("OnSuffixIconClick", fn)
    [<CustomOperation("OnSuffixIconClick")>] member inline _.OnSuffixIconClick ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: unit -> Task<unit>) = render ==> html.callbackTask("OnSuffixIconClick", fn)
    [<CustomOperation("FeedbackIcon")>] member inline _.FeedbackIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("FeedbackIcon", fragment)
    [<CustomOperation("FeedbackIcon")>] member inline _.FeedbackIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("FeedbackIcon", fragment { yield! fragments })
...
type DropdownGroupButtonBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("LeftButton")>] member inline _.LeftButton ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("LeftButton", fragment)
    [<CustomOperation("LeftButton")>] member inline _.LeftButton ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("LeftButton", fragment { yield! fragments })
    ...
    [<CustomOperation("RightButton")>] member inline _.RightButton ([<InlineIfLambda>] render: AttrRenderFragment, fragment: NodeRenderFragment) = render ==> html.renderFragment("RightButton", fragment)
    [<CustomOperation("RightButton")>] member inline _.RightButton ([<InlineIfLambda>] render: AttrRenderFragment, fragments: NodeRenderFragment seq) = render ==> html.renderFragment("RightButton", fragment { yield! fragments })
...
type FormProviderBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("OnFormFinish")>] member inline _.OnFormFinish ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.FormProviderFinishEventArgs -> unit) = render ==> html.callback("OnFormFinish", fn)
    [<CustomOperation("OnFormFinish")>] member inline _.OnFormFinish ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.FormProviderFinishEventArgs -> Task<unit>) = render ==> html.callbackTask("OnFormFinish", fn)
...
type ResizeObserverBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("OnResize")>] member inline _.OnResize ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.JsInterop.DomRect -> unit) = render ==> html.callback("OnResize", fn)
    [<CustomOperation("OnResize")>] member inline _.OnResize ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: AntDesign.JsInterop.DomRect -> Task<unit>) = render ==> html.callbackTask("OnResize", fn)
...
type GenerateColumnsBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("StartColumnIndex")>] member inline _.StartColumnIndex ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("StartColumnIndex" => x)
...
type ReusePagesBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ActivedUriChanged")>] member inline _.ActivedUriChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> unit) = render ==> html.callback("ActivedUriChanged", fn)
    [<CustomOperation("ActivedUriChanged")>] member inline _.ActivedUriChanged ([<InlineIfLambda>] render: AttrRenderFragment, [<InlineIfLambda>] fn: System.String -> Task<unit>) = render ==> html.callbackTask("ActivedUriChanged", fn)
...
module DslCE =
    ...
    type AntComponentBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AntComponentBase", "AntDesign")>] () = inherit AntComponentBaseBuilder<AntDesign.AntComponentBase>()
    type AntDomComponentBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AntDomComponentBase", "AntDesign")>] () = inherit AntDomComponentBaseBuilder<AntDesign.AntDomComponentBase>()
    type Dropdown' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Dropdown", "AntDesign")>] () = inherit DropdownBuilder<AntDesign.Dropdown>()
    type DropdownButton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DropdownButton", "AntDesign")>] () = inherit DropdownButtonBuilder<AntDesign.DropdownButton>()
    type Popconfirm' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Popconfirm", "AntDesign")>] () = inherit PopconfirmBuilder<AntDesign.Popconfirm>()
    type Popover' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Popover", "AntDesign")>] () = inherit PopoverBuilder<AntDesign.Popover>()
    type Tooltip' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Tooltip", "AntDesign")>] () = inherit TooltipBuilder<AntDesign.Tooltip>()
    type ColumnBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ColumnBase", "AntDesign")>] () = inherit ColumnBaseBuilder<AntDesign.ColumnBase>()
    type ActionColumn' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ActionColumn", "AntDesign")>] () = inherit ActionColumnBuilder<AntDesign.ActionColumn>()
    type ColumnDefinition' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ColumnDefinition", "AntDesign")>] () = inherit ColumnDefinitionBuilder<AntDesign.ColumnDefinition>()
    type TableCell' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TableCell", "AntDesign")>] () = inherit TableCellBuilder<AntDesign.TableCell>()
    type SimpleTableHeader' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SimpleTableHeader", "AntDesign")>] () = inherit SimpleTableHeaderBuilder<AntDesign.SimpleTableHeader>()
    type Column'<'TData> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Column`1", "AntDesign")>] () = inherit ColumnBuilder<AntDesign.Column<'TData>, 'TData>()
    type PropertyColumn'<'TItem, 'TProp> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.PropertyColumn`2", "AntDesign")>] () = inherit PropertyColumnBuilder<AntDesign.PropertyColumn<'TItem, 'TProp>, 'TItem, 'TProp>()
    type TableHeader'<'TData> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TableHeader`1", "AntDesign")>] () = inherit TableHeaderBuilder<AntDesign.TableHeader<'TData>, 'TData>()
    type Selection' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Selection", "AntDesign")>] () = inherit SelectionBuilder<AntDesign.Selection>()
    type SummaryCell' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SummaryCell", "AntDesign")>] () = inherit SummaryCellBuilder<AntDesign.SummaryCell>()
    type DatePickerPanelBase'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DatePickerPanelBase`1", "AntDesign")>] () = inherit DatePickerPanelBaseBuilder<AntDesign.DatePickerPanelBase<'TValue>, 'TValue>()
    type Button' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Button", "AntDesign")>] () = inherit ButtonBuilder<AntDesign.Button>()
    type DownloadButton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DownloadButton", "AntDesign")>] () = inherit DownloadButtonBuilder<AntDesign.DownloadButton>()
    type Col' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Col", "AntDesign")>] () = inherit ColBuilder<AntDesign.Col>()
    type GridCol' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.GridCol", "AntDesign")>] () = inherit GridColBuilder<AntDesign.GridCol>()
    type Row' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Row", "AntDesign")>] () = inherit RowBuilder<AntDesign.Row>()
    type GridRow' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.GridRow", "AntDesign")>] () = inherit GridRowBuilder<AntDesign.GridRow>()
    type Icon' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Icon", "AntDesign")>] () = inherit IconBuilder<AntDesign.Icon>()
    type IconFont' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.IconFont", "AntDesign")>] () = inherit IconFontBuilder<AntDesign.IconFont>()
    type NotificationBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.NotificationBase", "AntDesign")>] () = inherit NotificationBaseBuilder<AntDesign.NotificationBase>()
    type Notification' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Notification", "AntDesign")>] () = inherit NotificationBuilder<AntDesign.Notification>()
    type NotificationItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.NotificationItem", "AntDesign")>] () = inherit NotificationItemBuilder<AntDesign.NotificationItem>()
    type Tabs' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Tabs", "AntDesign")>] () = inherit TabsBuilder<AntDesign.Tabs>()
    type ReuseTabs' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ReuseTabs", "AntDesign")>] () = inherit ReuseTabsBuilder<AntDesign.ReuseTabs>()
    type TypographyBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TypographyBase", "AntDesign")>] () = inherit TypographyBaseBuilder<AntDesign.TypographyBase>()
    type Link' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Link", "AntDesign")>] () = inherit LinkBuilder<AntDesign.Link>()
    type Paragraph' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Paragraph", "AntDesign")>] () = inherit ParagraphBuilder<AntDesign.Paragraph>()
    type Text' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Text", "AntDesign")>] () = inherit TextBuilder<AntDesign.Text>()
    type Title' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Title", "AntDesign")>] () = inherit TitleBuilder<AntDesign.Title>()
    type Typography' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Typography", "AntDesign")>] () = inherit TypographyBuilder<AntDesign.Typography>()
    type Affix' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Affix", "AntDesign")>] () = inherit AffixBuilder<AntDesign.Affix>()
    type Alert' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Alert", "AntDesign")>] () = inherit AlertBuilder<AntDesign.Alert>()
    type Anchor' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Anchor", "AntDesign")>] () = inherit AnchorBuilder<AntDesign.Anchor>()
    type AnchorLink' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AnchorLink", "AntDesign")>] () = inherit AnchorLinkBuilder<AntDesign.AnchorLink>()
    type AutoCompleteOptGroup' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AutoCompleteOptGroup", "AntDesign")>] () = inherit AutoCompleteOptGroupBuilder<AntDesign.AutoCompleteOptGroup>()
    type AutoCompleteOption' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AutoCompleteOption", "AntDesign")>] () = inherit AutoCompleteOptionBuilder<AntDesign.AutoCompleteOption>()
    type Avatar' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Avatar", "AntDesign")>] () = inherit AvatarBuilder<AntDesign.Avatar>()
    type AvatarGroup' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AvatarGroup", "AntDesign")>] () = inherit AvatarGroupBuilder<AntDesign.AvatarGroup>()
    type BackTop' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.BackTop", "AntDesign")>] () = inherit BackTopBuilder<AntDesign.BackTop>()
    type Badge' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Badge", "AntDesign")>] () = inherit BadgeBuilder<AntDesign.Badge>()
    type BadgeRibbon' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.BadgeRibbon", "AntDesign")>] () = inherit BadgeRibbonBuilder<AntDesign.BadgeRibbon>()
    type Breadcrumb' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Breadcrumb", "AntDesign")>] () = inherit BreadcrumbBuilder<AntDesign.Breadcrumb>()
    type ButtonGroup' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ButtonGroup", "AntDesign")>] () = inherit ButtonGroupBuilder<AntDesign.ButtonGroup>()
    type Calendar' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Calendar", "AntDesign")>] () = inherit CalendarBuilder<AntDesign.Calendar>()
    type Card' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Card", "AntDesign")>] () = inherit CardBuilder<AntDesign.Card>()
    type CardAction' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.CardAction", "AntDesign")>] () = inherit CardActionBuilder<AntDesign.CardAction>()
    type CardGrid' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.CardGrid", "AntDesign")>] () = inherit CardGridBuilder<AntDesign.CardGrid>()
    type Carousel' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Carousel", "AntDesign")>] () = inherit CarouselBuilder<AntDesign.Carousel>()
    type CarouselSlick' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.CarouselSlick", "AntDesign")>] () = inherit CarouselSlickBuilder<AntDesign.CarouselSlick>()
    type Collapse' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Collapse", "AntDesign")>] () = inherit CollapseBuilder<AntDesign.Collapse>()
    type Panel' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Panel", "AntDesign")>] () = inherit PanelBuilder<AntDesign.Panel>()
    type Comment' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Comment", "AntDesign")>] () = inherit CommentBuilder<AntDesign.Comment>()
    type AntContainerComponentBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AntContainerComponentBase", "AntDesign")>] () = inherit AntContainerComponentBaseBuilder<AntDesign.AntContainerComponentBase>()
    type AntInputComponentBase'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AntInputComponentBase`1", "AntDesign")>] () = inherit AntInputComponentBaseBuilder<AntDesign.AntInputComponentBase<'TValue>, 'TValue>()
    type AntInputBoolComponentBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AntInputBoolComponentBase", "AntDesign")>] () = inherit AntInputBoolComponentBaseBuilder<AntDesign.AntInputBoolComponentBase>()
    type Checkbox' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Checkbox", "AntDesign")>] () = inherit CheckboxBuilder<AntDesign.Checkbox>()
    type Switch' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Switch", "AntDesign")>] () = inherit SwitchBuilder<AntDesign.Switch>()
    type AutoComplete'<'TOption> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AutoComplete`1", "AntDesign")>] () = inherit AutoCompleteBuilder<AntDesign.AutoComplete<'TOption>, 'TOption>()
    type CheckboxGroup'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.CheckboxGroup`1", "AntDesign")>] () = inherit CheckboxGroupBuilder<AntDesign.CheckboxGroup<'TValue>, 'TValue>()
    type EnumCheckboxGroup'<'TEnum> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.EnumCheckboxGroup`1", "AntDesign")>] () = inherit EnumCheckboxGroupBuilder<AntDesign.EnumCheckboxGroup<'TEnum>, 'TEnum>()
    type DatePickerBase'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DatePickerBase`1", "AntDesign")>] () = inherit DatePickerBaseBuilder<AntDesign.DatePickerBase<'TValue>, 'TValue>()
    type DatePicker'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DatePicker`1", "AntDesign")>] () = inherit DatePickerBuilder<AntDesign.DatePicker<'TValue>, 'TValue>()
    type MonthPicker'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.MonthPicker`1", "AntDesign")>] () = inherit MonthPickerBuilder<AntDesign.MonthPicker<'TValue>, 'TValue>()
    type QuarterPicker'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.QuarterPicker`1", "AntDesign")>] () = inherit QuarterPickerBuilder<AntDesign.QuarterPicker<'TValue>, 'TValue>()
    type WeekPicker'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.WeekPicker`1", "AntDesign")>] () = inherit WeekPickerBuilder<AntDesign.WeekPicker<'TValue>, 'TValue>()
    type YearPicker'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.YearPicker`1", "AntDesign")>] () = inherit YearPickerBuilder<AntDesign.YearPicker<'TValue>, 'TValue>()
    type TimePicker'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TimePicker`1", "AntDesign")>] () = inherit TimePickerBuilder<AntDesign.TimePicker<'TValue>, 'TValue>()
    type RangePicker'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.RangePicker`1", "AntDesign")>] () = inherit RangePickerBuilder<AntDesign.RangePicker<'TValue>, 'TValue>()
    type InputNumber'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.InputNumber`1", "AntDesign")>] () = inherit InputNumberBuilder<AntDesign.InputNumber<'TValue>, 'TValue>()
    type Input'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Input`1", "AntDesign")>] () = inherit InputBuilder<AntDesign.Input<'TValue>, 'TValue>()
    type Search' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Search", "AntDesign")>] () = inherit SearchBuilder<AntDesign.Search>()
    type AutoCompleteSearch' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AutoCompleteSearch", "AntDesign")>] () = inherit AutoCompleteSearchBuilder<AntDesign.AutoCompleteSearch>()
    type AutoCompleteInput'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AutoCompleteInput`1", "AntDesign")>] () = inherit AutoCompleteInputBuilder<AntDesign.AutoCompleteInput<'TValue>, 'TValue>()
    type InputPassword' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.InputPassword", "AntDesign")>] () = inherit InputPasswordBuilder<AntDesign.InputPassword>()
    type TextArea' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TextArea", "AntDesign")>] () = inherit TextAreaBuilder<AntDesign.TextArea>()
    type RadioGroup'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.RadioGroup`1", "AntDesign")>] () = inherit RadioGroupBuilder<AntDesign.RadioGroup<'TValue>, 'TValue>()
    type EnumRadioGroup'<'TEnum> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.EnumRadioGroup`1", "AntDesign")>] () = inherit EnumRadioGroupBuilder<AntDesign.EnumRadioGroup<'TEnum>, 'TEnum>()
    type SelectBase'<'TItemValue, 'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SelectBase`2", "AntDesign")>] () = inherit SelectBaseBuilder<AntDesign.SelectBase<'TItemValue, 'TItem>, 'TItemValue, 'TItem>()
    type Cascader' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Cascader", "AntDesign")>] () = inherit CascaderBuilder<AntDesign.Cascader>()
    type Select'<'TItemValue, 'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Select`2", "AntDesign")>] () = inherit SelectBuilder<AntDesign.Select<'TItemValue, 'TItem>, 'TItemValue, 'TItem>()
    type EnumSelect'<'TEnum> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.EnumSelect`1", "AntDesign")>] () = inherit EnumSelectBuilder<AntDesign.EnumSelect<'TEnum>, 'TEnum>()
    type SimpleSelect' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SimpleSelect", "AntDesign")>] () = inherit SimpleSelectBuilder<AntDesign.SimpleSelect>()
    type TreeSelect'<'TItemValue, 'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TreeSelect`2", "AntDesign")>] () = inherit TreeSelectBuilder<AntDesign.TreeSelect<'TItemValue, 'TItem>, 'TItemValue, 'TItem>()
    type Slider'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Slider`1", "AntDesign")>] () = inherit SliderBuilder<AntDesign.Slider<'TValue>, 'TValue>()
    type Descriptions' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Descriptions", "AntDesign")>] () = inherit DescriptionsBuilder<AntDesign.Descriptions>()
    type DescriptionsItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DescriptionsItem", "AntDesign")>] () = inherit DescriptionsItemBuilder<AntDesign.DescriptionsItem>()
    type Divider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Divider", "AntDesign")>] () = inherit DividerBuilder<AntDesign.Divider>()
    type DraftMonitor'<'TData> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DraftMonitor`1", "AntDesign")>] () = inherit DraftMonitorBuilder<AntDesign.DraftMonitor<'TData>, 'TData>()
    type Drawer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Drawer", "AntDesign")>] () = inherit DrawerBuilder<AntDesign.Drawer>()
    type DrawerContainer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DrawerContainer", "AntDesign")>] () = inherit DrawerContainerBuilder<AntDesign.DrawerContainer>()
    type Empty' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Empty", "AntDesign")>] () = inherit EmptyBuilder<AntDesign.Empty>()
    type Flex' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Flex", "AntDesign")>] () = inherit FlexBuilder<AntDesign.Flex>()
    type Form'<'TModel> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Form`1", "AntDesign")>] () = inherit FormBuilder<AntDesign.Form<'TModel>, 'TModel>()
    type FormItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.FormItem", "AntDesign")>] () = inherit FormItemBuilder<AntDesign.FormItem>()
    type Image' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Image", "AntDesign")>] () = inherit ImageBuilder<AntDesign.Image>()
    type ImagePreviewContainer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ImagePreviewContainer", "AntDesign")>] () = inherit ImagePreviewContainerBuilder<AntDesign.ImagePreviewContainer>()
    type InputGroup' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.InputGroup", "AntDesign")>] () = inherit InputGroupBuilder<AntDesign.InputGroup>()
    type Layout' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Layout", "AntDesign")>] () = inherit LayoutBuilder<AntDesign.Layout>()
    type Sider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Sider", "AntDesign")>] () = inherit SiderBuilder<AntDesign.Sider>()
    type AntList'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AntList`1", "AntDesign")>] () = inherit AntListBuilder<AntDesign.AntList<'TItem>, 'TItem>()
    type ListItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ListItem", "AntDesign")>] () = inherit ListItemBuilder<AntDesign.ListItem>()
    type ListItemMeta' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ListItemMeta", "AntDesign")>] () = inherit ListItemMetaBuilder<AntDesign.ListItemMeta>()
    type Mentions' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Mentions", "AntDesign")>] () = inherit MentionsBuilder<AntDesign.Mentions>()
    type MentionsOption' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.MentionsOption", "AntDesign")>] () = inherit MentionsOptionBuilder<AntDesign.MentionsOption>()
    type Menu' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Menu", "AntDesign")>] () = inherit MenuBuilder<AntDesign.Menu>()
    type MenuItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.MenuItem", "AntDesign")>] () = inherit MenuItemBuilder<AntDesign.MenuItem>()
    type MenuItemGroup' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.MenuItemGroup", "AntDesign")>] () = inherit MenuItemGroupBuilder<AntDesign.MenuItemGroup>()
    type MenuLink' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.MenuLink", "AntDesign")>] () = inherit MenuLinkBuilder<AntDesign.MenuLink>()
    type SubMenu' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SubMenu", "AntDesign")>] () = inherit SubMenuBuilder<AntDesign.SubMenu>()
    type Message' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Message", "AntDesign")>] () = inherit MessageBuilder<AntDesign.Message>()
    type MessageItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.MessageItem", "AntDesign")>] () = inherit MessageItemBuilder<AntDesign.MessageItem>()
    type ComfirmContainer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ComfirmContainer", "AntDesign")>] () = inherit ComfirmContainerBuilder<AntDesign.ComfirmContainer>()
    type Confirm' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Confirm", "AntDesign")>] () = inherit ConfirmBuilder<AntDesign.Confirm>()
    type Dialog' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Dialog", "AntDesign")>] () = inherit DialogBuilder<AntDesign.Dialog>()
    type DialogWrapper' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DialogWrapper", "AntDesign")>] () = inherit DialogWrapperBuilder<AntDesign.DialogWrapper>()
    type Modal' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Modal", "AntDesign")>] () = inherit ModalBuilder<AntDesign.Modal>()
    type ModalCancelFooter' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ModalCancelFooter", "AntDesign")>] () = inherit ModalCancelFooterBuilder<AntDesign.ModalCancelFooter>()
    type ModalContainer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ModalContainer", "AntDesign")>] () = inherit ModalContainerBuilder<AntDesign.ModalContainer>()
    type ModalFooter' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ModalFooter", "AntDesign")>] () = inherit ModalFooterBuilder<AntDesign.ModalFooter>()
    type ModalOkFooter' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ModalOkFooter", "AntDesign")>] () = inherit ModalOkFooterBuilder<AntDesign.ModalOkFooter>()
    type PageHeader' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.PageHeader", "AntDesign")>] () = inherit PageHeaderBuilder<AntDesign.PageHeader>()
    type Pagination' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Pagination", "AntDesign")>] () = inherit PaginationBuilder<AntDesign.Pagination>()
    type PaginationOptions' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.PaginationOptions", "AntDesign")>] () = inherit PaginationOptionsBuilder<AntDesign.PaginationOptions>()
    type Progress' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Progress", "AntDesign")>] () = inherit ProgressBuilder<AntDesign.Progress>()
    type Radio'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Radio`1", "AntDesign")>] () = inherit RadioBuilder<AntDesign.Radio<'TValue>, 'TValue>()
    type Rate' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Rate", "AntDesign")>] () = inherit RateBuilder<AntDesign.Rate>()
    type RateItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.RateItem", "AntDesign")>] () = inherit RateItemBuilder<AntDesign.RateItem>()
    type Result' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Result", "AntDesign")>] () = inherit ResultBuilder<AntDesign.Result>()
    type Segmented'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Segmented`1", "AntDesign")>] () = inherit SegmentedBuilder<AntDesign.Segmented<'TValue>, 'TValue>()
    type SegmentedItem'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SegmentedItem`1", "AntDesign")>] () = inherit SegmentedItemBuilder<AntDesign.SegmentedItem<'TValue>, 'TValue>()
    type SelectOption'<'TItemValue, 'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SelectOption`2", "AntDesign")>] () = inherit SelectOptionBuilder<AntDesign.SelectOption<'TItemValue, 'TItem>, 'TItemValue, 'TItem>()
    type SimpleSelectOption' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SimpleSelectOption", "AntDesign")>] () = inherit SimpleSelectOptionBuilder<AntDesign.SimpleSelectOption>()
    type Skeleton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Skeleton", "AntDesign")>] () = inherit SkeletonBuilder<AntDesign.Skeleton>()
    type SkeletonElement' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SkeletonElement", "AntDesign")>] () = inherit SkeletonElementBuilder<AntDesign.SkeletonElement>()
    type Space' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Space", "AntDesign")>] () = inherit SpaceBuilder<AntDesign.Space>()
    type SpaceItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SpaceItem", "AntDesign")>] () = inherit SpaceItemBuilder<AntDesign.SpaceItem>()
    type Spin' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Spin", "AntDesign")>] () = inherit SpinBuilder<AntDesign.Spin>()
    type Splitter' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Splitter", "AntDesign")>] () = inherit SplitterBuilder<AntDesign.Splitter>()
    type StatisticComponentBase'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.StatisticComponentBase`1", "AntDesign")>] () = inherit StatisticComponentBaseBuilder<AntDesign.StatisticComponentBase<'T>, 'T>()
    type CountDown' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.CountDown", "AntDesign")>] () = inherit CountDownBuilder<AntDesign.CountDown>()
    type Statistic'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Statistic`1", "AntDesign")>] () = inherit StatisticBuilder<AntDesign.Statistic<'TValue>, 'TValue>()
    type Step' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Step", "AntDesign")>] () = inherit StepBuilder<AntDesign.Step>()
    type Steps' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Steps", "AntDesign")>] () = inherit StepsBuilder<AntDesign.Steps>()
    type Table'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Table`1", "AntDesign")>] () = inherit TableBuilder<AntDesign.Table<'TItem>, 'TItem>()
    type TabPane' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TabPane", "AntDesign")>] () = inherit TabPaneBuilder<AntDesign.TabPane>()
    type Tag' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Tag", "AntDesign")>] () = inherit TagBuilder<AntDesign.Tag>()
    type Timeline' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Timeline", "AntDesign")>] () = inherit TimelineBuilder<AntDesign.Timeline>()
    type TimelineItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TimelineItem", "AntDesign")>] () = inherit TimelineItemBuilder<AntDesign.TimelineItem>()
    type Transfer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Transfer", "AntDesign")>] () = inherit TransferBuilder<AntDesign.Transfer>()
    type Tree'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Tree`1", "AntDesign")>] () = inherit TreeBuilder<AntDesign.Tree<'TItem>, 'TItem>()
    type DirectoryTree'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.DirectoryTree`1", "AntDesign")>] () = inherit DirectoryTreeBuilder<AntDesign.DirectoryTree<'TItem>, 'TItem>()
    type TreeNode'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TreeNode`1", "AntDesign")>] () = inherit TreeNodeBuilder<AntDesign.TreeNode<'TItem>, 'TItem>()
    type Upload' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Upload", "AntDesign")>] () = inherit UploadBuilder<AntDesign.Upload>()
    type Watermark' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Watermark", "AntDesign")>] () = inherit WatermarkBuilder<AntDesign.Watermark>()
    type BreadcrumbItem' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.BreadcrumbItem", "AntDesign")>] () = inherit BreadcrumbItemBuilder<AntDesign.BreadcrumbItem>()
    type CalendarHeader' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.CalendarHeader", "AntDesign")>] () = inherit CalendarHeaderBuilder<AntDesign.CalendarHeader>()
    type CardMeta' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.CardMeta", "AntDesign")>] () = inherit CardMetaBuilder<AntDesign.CardMeta>()
    type AntContainer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.AntContainer", "AntDesign")>] () = inherit AntContainerBuilder<AntDesign.AntContainer>()
    type Template' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Template", "AntDesign")>] () = inherit TemplateBuilder<AntDesign.Template>()
    type EmptyDefaultImg' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.EmptyDefaultImg", "AntDesign")>] () = inherit EmptyDefaultImgBuilder<AntDesign.EmptyDefaultImg>()
    type EmptySimpleImg' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.EmptySimpleImg", "AntDesign")>] () = inherit EmptySimpleImgBuilder<AntDesign.EmptySimpleImg>()
    type Content' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Content", "AntDesign")>] () = inherit ContentBuilder<AntDesign.Content>()
    type Footer' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Footer", "AntDesign")>] () = inherit FooterBuilder<AntDesign.Footer>()
    type Header' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Header", "AntDesign")>] () = inherit HeaderBuilder<AntDesign.Header>()
    type MenuDivider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.MenuDivider", "AntDesign")>] () = inherit MenuDividerBuilder<AntDesign.MenuDivider>()
    type PaginationPager' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.PaginationPager", "AntDesign")>] () = inherit PaginationPagerBuilder<AntDesign.PaginationPager>()
    type TableRow' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TableRow", "AntDesign")>] () = inherit TableRowBuilder<AntDesign.TableRow>()
    type ConfigProvider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ConfigProvider", "AntDesign")>] () = inherit ConfigProviderBuilder<AntDesign.ConfigProvider>()
    type TemplateComponentBase'<'TComponentOptions> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TemplateComponentBase`1", "AntDesign")>] () = inherit TemplateComponentBaseBuilder<AntDesign.TemplateComponentBase<'TComponentOptions>, 'TComponentOptions>()
    type FeedbackComponent'<'TComponentOptions> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.FeedbackComponent`1", "AntDesign")>] () = inherit FeedbackComponentBuilder<AntDesign.FeedbackComponent<'TComponentOptions>, 'TComponentOptions>()
    type FeedbackComponent'<'TComponentOptions, 'TResult> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.FeedbackComponent`2", "AntDesign")>] () = inherit FeedbackComponentBuilder2<AntDesign.FeedbackComponent<'TComponentOptions, 'TResult>, 'TComponentOptions, 'TResult>()
    type FormProvider' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.FormProvider", "AntDesign")>] () = inherit FormProviderBuilder<AntDesign.FormProvider>()
    type Component' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Component", "AntDesign")>] () = inherit ComponentBuilder<AntDesign.Component>()
    type ForeachLoop'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ForeachLoop`1", "AntDesign")>] () = inherit ForeachLoopBuilder<AntDesign.ForeachLoop<'TItem>, 'TItem>()
    type GenerateFormItem'<'TModel> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.GenerateFormItem`1", "AntDesign")>] () = inherit GenerateFormItemBuilder<AntDesign.GenerateFormItem<'TModel>, 'TModel>()
    type ImagePreview' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ImagePreview", "AntDesign")>] () = inherit ImagePreviewBuilder<AntDesign.ImagePreview>()
    type ImagePreviewGroup' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ImagePreviewGroup", "AntDesign")>] () = inherit ImagePreviewGroupBuilder<AntDesign.ImagePreviewGroup>()
    type SplitterPanel' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SplitterPanel", "AntDesign")>] () = inherit SplitterPanelBuilder<AntDesign.SplitterPanel>()
    type GenerateColumns'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.GenerateColumns`1", "AntDesign")>] () = inherit GenerateColumnsBuilder<AntDesign.GenerateColumns<'TItem>, 'TItem>()
    type TreeIndent'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TreeIndent`1", "AntDesign")>] () = inherit TreeIndentBuilder<AntDesign.TreeIndent<'TItem>, 'TItem>()
    type TreeNodeCheckbox'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TreeNodeCheckbox`1", "AntDesign")>] () = inherit TreeNodeCheckboxBuilder<AntDesign.TreeNodeCheckbox<'TItem>, 'TItem>()
    type TreeNodeSwitcher'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TreeNodeSwitcher`1", "AntDesign")>] () = inherit TreeNodeSwitcherBuilder<AntDesign.TreeNodeSwitcher<'TItem>, 'TItem>()
    type TreeNodeTitle'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.TreeNodeTitle`1", "AntDesign")>] () = inherit TreeNodeTitleBuilder<AntDesign.TreeNodeTitle<'TItem>, 'TItem>()
    type SummaryRow' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.SummaryRow", "AntDesign")>] () = inherit SummaryRowBuilder<AntDesign.SummaryRow>()
    type ReusePages' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.ReusePages", "AntDesign")>] () = inherit ReusePagesBuilder<AntDesign.ReusePages>()
...
module DslCEInstances =
    ...
    let Divider'' = Divider'()
    let DraftMonitor''<'TData> = DraftMonitor'<'TData>()
    let Drawer'' = Drawer'()
...
module DslCE =
    ...
    type OverlayTrigger' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.OverlayTrigger", "AntDesign")>] () = inherit OverlayTriggerBuilder<AntDesign.Internal.OverlayTrigger>()
    type SubMenuTrigger' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.SubMenuTrigger", "AntDesign")>] () = inherit SubMenuTriggerBuilder<AntDesign.Internal.SubMenuTrigger>()
    type PickerPanelBase' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.PickerPanelBase", "AntDesign")>] () = inherit PickerPanelBaseBuilder<AntDesign.Internal.PickerPanelBase>()
    type DatePickerDatetimePanel'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerDatetimePanel`1", "AntDesign")>] () = inherit DatePickerDatetimePanelBuilder<AntDesign.Internal.DatePickerDatetimePanel<'TValue>, 'TValue>()
    type DatePickerTemplate'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerTemplate`1", "AntDesign")>] () = inherit DatePickerTemplateBuilder<AntDesign.Internal.DatePickerTemplate<'TValue>, 'TValue>()
    type DatePickerDatePanel'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerDatePanel`1", "AntDesign")>] () = inherit DatePickerDatePanelBuilder<AntDesign.Internal.DatePickerDatePanel<'TValue>, 'TValue>()
    type DatePickerDecadePanel'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerDecadePanel`1", "AntDesign")>] () = inherit DatePickerDecadePanelBuilder<AntDesign.Internal.DatePickerDecadePanel<'TValue>, 'TValue>()
    type DatePickerFooter'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerFooter`1", "AntDesign")>] () = inherit DatePickerFooterBuilder<AntDesign.Internal.DatePickerFooter<'TValue>, 'TValue>()
    type DatePickerHeader'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerHeader`1", "AntDesign")>] () = inherit DatePickerHeaderBuilder<AntDesign.Internal.DatePickerHeader<'TValue>, 'TValue>()
    type DatePickerMonthPanel'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerMonthPanel`1", "AntDesign")>] () = inherit DatePickerMonthPanelBuilder<AntDesign.Internal.DatePickerMonthPanel<'TValue>, 'TValue>()
    type DatePickerQuarterPanel'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerQuarterPanel`1", "AntDesign")>] () = inherit DatePickerQuarterPanelBuilder<AntDesign.Internal.DatePickerQuarterPanel<'TValue>, 'TValue>()
    type DatePickerYearPanel'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerYearPanel`1", "AntDesign")>] () = inherit DatePickerYearPanelBuilder<AntDesign.Internal.DatePickerYearPanel<'TValue>, 'TValue>()
    type CalendarPanelChooser' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.CalendarPanelChooser", "AntDesign")>] () = inherit CalendarPanelChooserBuilder<AntDesign.Internal.CalendarPanelChooser>()
    type Element' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.Element", "AntDesign")>] () = inherit ElementBuilder<AntDesign.Internal.Element>()
    type Overlay' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.Overlay", "AntDesign")>] () = inherit OverlayBuilder<AntDesign.Internal.Overlay>()
    type DatePickerPanelChooser'<'TValue> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerPanelChooser`1", "AntDesign")>] () = inherit DatePickerPanelChooserBuilder<AntDesign.Internal.DatePickerPanelChooser<'TValue>, 'TValue>()
    type UploadButton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.UploadButton", "AntDesign")>] () = inherit UploadButtonBuilder<AntDesign.Internal.UploadButton>()
    type DatePickerInput' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DatePickerInput", "AntDesign")>] () = inherit DatePickerInputBuilder<AntDesign.Internal.DatePickerInput>()
    type DropdownGroupButton' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.DropdownGroupButton", "AntDesign")>] () = inherit DropdownGroupButtonBuilder<AntDesign.Internal.DropdownGroupButton>()
    type FormRulesValidator' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.FormRulesValidator", "AntDesign")>] () = inherit FormRulesValidatorBuilder<AntDesign.Internal.FormRulesValidator>()
    type TableRowWrapper'<'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.TableRowWrapper`1", "AntDesign")>] () = inherit TableRowWrapperBuilder<AntDesign.Internal.TableRowWrapper<'TItem>, 'TItem>()
...
module DslCE =
    ...
    type SelectContent'<'TItemValue, 'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Select.Internal.SelectContent`2", "AntDesign")>] () = inherit SelectContentBuilder<AntDesign.Select.Internal.SelectContent<'TItemValue, 'TItem>, 'TItemValue, 'TItem>()
    type SelectOptionGroup'<'TItemValue, 'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Select.Internal.SelectOptionGroup`2", "AntDesign")>] () = inherit SelectOptionGroupBuilder<AntDesign.Select.Internal.SelectOptionGroup<'TItemValue, 'TItem>, 'TItemValue, 'TItem>()
    type SelectSuffixIcon'<'TItemValue, 'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Select.Internal.SelectSuffixIcon`2", "AntDesign")>] () = inherit SelectSuffixIconBuilder<AntDesign.Select.Internal.SelectSuffixIcon<'TItemValue, 'TItem>, 'TItemValue, 'TItem>()
...
module DslCE =
    ...
    type ResizeObserver' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Core.Component.ResizeObserver.ResizeObserver", "AntDesign")>] () = inherit ResizeObserverBuilder<AntDesign.Core.Component.ResizeObserver.ResizeObserver>()
...
module DslCE =
    ...
    type StatisticComponentBase'<'T> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.statistic.StatisticComponentBase`1", "AntDesign")>] () = inherit StatisticComponentBaseBuilder<AntDesign.statistic.StatisticComponentBase<'T>, 'T>()
...
module DslCE =
    ...
    type FilterInputs' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Filters.FilterInputs", "AntDesign")>] () = inherit FilterInputsBuilder<AntDesign.Filters.FilterInputs>()
...
module DslCE =
    ...
    type LabelTemplateItem'<'TItemValue, 'TItem> [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Select.LabelTemplateItem`2", "AntDesign")>] () = inherit LabelTemplateItemBuilder<AntDesign.Select.LabelTemplateItem<'TItemValue, 'TItem>, 'TItemValue, 'TItem>()
...
module DslCE =
    ...
    type ModalHeader' [<DynamicDependency(DynamicallyAccessedMemberTypes.All, "AntDesign.Internal.ModalDialog.ModalHeader", "AntDesign")>] () = inherit ModalHeaderBuilder<AntDesign.Internal.ModalDialog.ModalHeader>()
