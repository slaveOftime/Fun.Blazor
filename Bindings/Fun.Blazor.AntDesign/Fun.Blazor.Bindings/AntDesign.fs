...
type OverlayTriggerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ComplexAutoCloseAndVisible")>] member inline _.ComplexAutoCloseAndVisible ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ComplexAutoCloseAndVisible" => x)
    ...
    [<CustomOperation("HiddenMode")>] member inline _.HiddenMode ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("HiddenMode" => x)
    [<CustomOperation("InlineFlexMode")>] member inline _.InlineFlexMode ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("InlineFlexMode" => x)
    [<CustomOperation("IsButton")>] member inline _.IsButton ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsButton" => x)
    ...
    [<CustomOperation("OnMaskClick")>] member inline _.OnMaskClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnMaskClick", fn)
    [<CustomOperation("OnMaskClick")>] member inline _.OnMaskClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnMaskClick", fn)
    [<CustomOperation("OnMouseEnter")>] member inline _.OnMouseEnter ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnMouseEnter", fn)
    [<CustomOperation("OnMouseEnter")>] member inline _.OnMouseEnter ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnMouseEnter", fn)
    ...
    [<CustomOperation("OnOverlayHiding")>] member inline _.OnOverlayHiding ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnOverlayHiding", fn)
    [<CustomOperation("OnOverlayHiding")>] member inline _.OnOverlayHiding ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnOverlayHiding", fn)
    ...
    [<CustomOperation("OnVisibleChange")>] member inline _.OnVisibleChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnVisibleChange", fn)
...
type DropdownBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ArrowPointAtCenter")>] member inline _.ArrowPointAtCenter ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ArrowPointAtCenter" => x)
...
type DropdownButtonBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Block")>] member inline _.Block ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Block" => x)
    ...
    [<CustomOperation("Danger")>] member inline _.Danger ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Danger" => x)
    [<CustomOperation("Ghost")>] member inline _.Ghost ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Ghost" => x)
...
type PopconfirmBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnCancel")>] member inline _.OnCancel ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnCancel", fn)
    [<CustomOperation("OnCancel")>] member inline _.OnCancel ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnCancel", fn)
    [<CustomOperation("OnConfirm")>] member inline _.OnConfirm ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnConfirm", fn)
    [<CustomOperation("OnConfirm")>] member inline _.OnConfirm ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnConfirm", fn)
    [<CustomOperation("ArrowPointAtCenter")>] member inline _.ArrowPointAtCenter ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ArrowPointAtCenter" => x)
...
type ColumnBaseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Ellipsis")>] member inline _.Ellipsis ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Ellipsis" => x)
...
type ColumnBuilder<'FunBlazorGeneric, 'TData when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit ColumnBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("FieldChanged")>] member inline _.FieldChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<'TData>("FieldChanged", fn)
    [<CustomOperation("FieldChanged")>] member inline _.FieldChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<'TData>("FieldChanged", fn)
    ...
    [<CustomOperation("ShowSorterTooltip")>] member inline _.ShowSorterTooltip ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowSorterTooltip" => x)
...
type SelectionBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("CheckStrictly")>] member inline _.CheckStrictly ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("CheckStrictly" => x)
    [<CustomOperation("CellRender")>] member inline _.CellRender ([<InlineIfLambda>] render: AttrRenderFragment, fn: AntDesign.TableModels.CellData -> NodeRenderFragment) = render ==> html.renderFragment("CellRender", fn)
...
type DatePickerPanelBaseBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("IsRange")>] member inline _.IsRange ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsRange" => x)
    [<CustomOperation("IsCalendar")>] member inline _.IsCalendar ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsCalendar" => x)
    [<CustomOperation("IsShowHeader")>] member inline _.IsShowHeader ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsShowHeader" => x)
    [<CustomOperation("IsShowTime")>] member inline _.IsShowTime ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsShowTime" => x)
    ...
    [<CustomOperation("Use12Hours")>] member inline _.Use12Hours ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Use12Hours" => x)
...
type DatePickerDatetimePanelBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowToday")>] member inline _.ShowToday ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowToday" => x)
    ...
    [<CustomOperation("OnOkClick")>] member inline _.OnOkClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnOkClick", fn)
    [<CustomOperation("OnOkClick")>] member inline _.OnOkClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnOkClick", fn)
    [<CustomOperation("OnNowClick")>] member inline _.OnNowClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnNowClick", fn)
    [<CustomOperation("OnNowClick")>] member inline _.OnNowClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnNowClick", fn)
    [<CustomOperation("OnRangeItemOver")>] member inline _.OnRangeItemOver ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Nullable<System.DateTime>[]>("OnRangeItemOver", fn)
    [<CustomOperation("OnRangeItemOver")>] member inline _.OnRangeItemOver ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Nullable<System.DateTime>[]>("OnRangeItemOver", fn)
    [<CustomOperation("OnRangeItemOut")>] member inline _.OnRangeItemOut ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Nullable<System.DateTime>[]>("OnRangeItemOut", fn)
    [<CustomOperation("OnRangeItemOut")>] member inline _.OnRangeItemOut ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Nullable<System.DateTime>[]>("OnRangeItemOut", fn)
    [<CustomOperation("OnRangeItemClicked")>] member inline _.OnRangeItemClicked ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Nullable<System.DateTime>[]>("OnRangeItemClicked", fn)
    [<CustomOperation("OnRangeItemClicked")>] member inline _.OnRangeItemClicked ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Nullable<System.DateTime>[]>("OnRangeItemClicked", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnOpenChange", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnOpenChange", fn)
...
type DatePickerTemplateBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowFooter")>] member inline _.ShowFooter ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowFooter" => x)
...
type DatePickerDatePanelBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit DatePickerPanelBaseBuilder<'FunBlazorGeneric, 'TValue>()
    [<CustomOperation("IsWeek")>] member inline _.IsWeek ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsWeek" => x)
    [<CustomOperation("ShowToday")>] member inline _.ShowToday ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowToday" => x)
...
type DatePickerHeaderBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowSuperPreChange")>] member inline _.ShowSuperPreChange ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowSuperPreChange" => x)
    [<CustomOperation("ShowPreChange")>] member inline _.ShowPreChange ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowPreChange" => x)
    [<CustomOperation("ShowNextChange")>] member inline _.ShowNextChange ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowNextChange" => x)
    [<CustomOperation("ShowSuperNextChange")>] member inline _.ShowSuperNextChange ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowSuperNextChange" => x)
...
type ButtonBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnClick", fn)
    [<CustomOperation("OnClickStopPropagation")>] member inline _.OnClickStopPropagation ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("OnClickStopPropagation" => x)
    [<CustomOperation("Shape")>] member inline _.Shape ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Shape" => x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Size" => x)
    [<CustomOperation("Type")>] member inline _.Type ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Type" => x)
    [<CustomOperation("NoSpanWrap")>] member inline _.NoSpanWrap ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("NoSpanWrap" => x)
...
type RowBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnBreakpoint")>] member inline _.OnBreakpoint ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.BreakpointType>("OnBreakpoint", fn)
    [<CustomOperation("OnBreakpoint")>] member inline _.OnBreakpoint ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.BreakpointType>("OnBreakpoint", fn)
...
type IconBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("AriaLabel")>] member inline _.AriaLabel ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("AriaLabel" => x)
    [<CustomOperation("Spin")>] member inline _.Spin ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Spin" => x)
...
type TypographyBaseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Code")>] member inline _.Code ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Code" => x)
    [<CustomOperation("Copyable")>] member inline _.Copyable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Copyable" => x)
    ...
    [<CustomOperation("Delete")>] member inline _.Delete ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Delete" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    ...
    [<CustomOperation("Mark")>] member inline _.Mark ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Mark" => x)
    [<CustomOperation("Underline")>] member inline _.Underline ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Underline" => x)
    [<CustomOperation("Strong")>] member inline _.Strong ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Strong" => x)
...
type LinkBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Keyboard")>] member inline _.Keyboard ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Keyboard" => x)
...
type AffixBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnChange", fn)

type AlertBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("AfterClose")>] member inline _.AfterClose ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("AfterClose", fn)
    [<CustomOperation("AfterClose")>] member inline _.AfterClose ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("AfterClose", fn)
    [<CustomOperation("Banner")>] member inline _.Banner ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Banner" => x)
    [<CustomOperation("Closable")>] member inline _.Closable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Closable" => x)
...
type AnchorBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Key")>] member inline _.Key ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Key" => x)
    [<CustomOperation("Affix")>] member inline _.Affix ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Affix" => x)
    ...
    [<CustomOperation("ShowInkInFixed")>] member inline _.ShowInkInFixed ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowInkInFixed" => x)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Tuple<Microsoft.AspNetCore.Components.Web.MouseEventArgs, AntDesign.AnchorLink>>("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Tuple<Microsoft.AspNetCore.Components.Web.MouseEventArgs, AntDesign.AnchorLink>>("OnClick", fn)
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String>("OnChange", fn)
...
type AvatarBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Alt")>] member inline _.Alt ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Alt" => x)
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Icon" => x)
    [<CustomOperation("OnError")>] member inline _.OnError ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.ErrorEventArgs>("OnError", fn)
    [<CustomOperation("OnError")>] member inline _.OnError ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.ErrorEventArgs>("OnError", fn)
...
type BreadcrumbBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("AutoGenerate")>] member inline _.AutoGenerate ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoGenerate" => x)
...
type CalendarBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnSelect")>] member inline _.OnSelect ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.DateTime>("OnSelect", fn)
    [<CustomOperation("OnSelect")>] member inline _.OnSelect ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.DateTime>("OnSelect", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.DateTime>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.DateTime>("OnChange", fn)
...
type CardBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Hoverable")>] member inline _.Hoverable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Hoverable" => x)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Loading" => x)
...
type CollapseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Accordion")>] member inline _.Accordion ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Accordion" => x)
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Bordered" => x)
    ...
    [<CustomOperation("Animation")>] member inline _.Animation ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Animation" => x)

type PanelBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Active")>] member inline _.Active ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Active" => x)
    [<CustomOperation("Key")>] member inline _.Key ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Key" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("ShowArrow")>] member inline _.ShowArrow ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowArrow" => x)
    ...
    [<CustomOperation("OnActiveChange")>] member inline _.OnActiveChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnActiveChange", fn)
    [<CustomOperation("OnActiveChange")>] member inline _.OnActiveChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnActiveChange", fn)
...
type AntInputBoolComponentBaseBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnChange", fn)
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("CheckedChanged", fn)
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("CheckedChanged", fn)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
...
type CheckboxBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("CheckedChange")>] member inline _.CheckedChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("CheckedChange", fn)
    [<CustomOperation("CheckedChange")>] member inline _.CheckedChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("CheckedChange", fn)
...
type SwitchBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Control")>] member inline _.Control ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Control" => x)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnClick", fn)
...
type AutoCompleteBuilder<'FunBlazorGeneric, 'TOption when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("DefaultActiveFirstOption")>] member inline _.DefaultActiveFirstOption ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DefaultActiveFirstOption" => x)
    [<CustomOperation("Backfill")>] member inline _.Backfill ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Backfill" => x)
    ...
    [<CustomOperation("OnSelectionChange")>] member inline _.OnSelectionChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.AutoCompleteOption>("OnSelectionChange", fn)
    [<CustomOperation("OnSelectionChange")>] member inline _.OnSelectionChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.AutoCompleteOption>("OnSelectionChange", fn)
    [<CustomOperation("OnActiveChange")>] member inline _.OnActiveChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.AutoCompleteOption>("OnActiveChange", fn)
    [<CustomOperation("OnActiveChange")>] member inline _.OnActiveChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.AutoCompleteOption>("OnActiveChange", fn)
    ...
    [<CustomOperation("OnPanelVisibleChange")>] member inline _.OnPanelVisibleChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnPanelVisibleChange", fn)
    [<CustomOperation("OnPanelVisibleChange")>] member inline _.OnPanelVisibleChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnPanelVisibleChange", fn)
    ...
    [<CustomOperation("AllowFilter")>] member inline _.AllowFilter ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AllowFilter" => x)
    ...
    [<CustomOperation("BoundaryAdjustMode")>] member inline _.BoundaryAdjustMode ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.TriggerBoundaryAdjustMode) = render ==> ("BoundaryAdjustMode" => x)
    [<CustomOperation("ShowPanel")>] member inline _.ShowPanel ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowPanel" => x)

type CascaderBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntInputComponentBaseBuilder<'FunBlazorGeneric, System.String>()
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AllowClear" => x)
    [<CustomOperation("BoundaryAdjustMode")>] member inline _.BoundaryAdjustMode ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.TriggerBoundaryAdjustMode) = render ==> ("BoundaryAdjustMode" => x)
    [<CustomOperation("ChangeOnSelect")>] member inline _.ChangeOnSelect ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ChangeOnSelect" => x)
    ...
    [<CustomOperation("Placeholder")>] member inline _.Placeholder ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Placeholder" => x)
    [<CustomOperation("PopupContainerSelector")>] member inline _.PopupContainerSelector ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("PopupContainerSelector" => x)
    [<CustomOperation("ShowSearch")>] member inline _.ShowSearch ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowSearch" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    ...
    [<CustomOperation("SelectedNodesChanged")>] member inline _.SelectedNodesChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.CascaderNode[]>("SelectedNodesChanged", fn)
    [<CustomOperation("SelectedNodesChanged")>] member inline _.SelectedNodesChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.CascaderNode[]>("SelectedNodesChanged", fn)
...
type DatePickerBaseBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("PrefixCls")>] member inline _.PrefixCls ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("PrefixCls" => x)
    [<CustomOperation("ChangeOnClose")>] member inline _.ChangeOnClose ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ChangeOnClose" => x)
    [<CustomOperation("Picker")>] member inline _.Picker ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Picker" => x)
    [<CustomOperation("PopupContainerSelector")>] member inline _.PopupContainerSelector ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("PopupContainerSelector" => x)
    ...
    [<CustomOperation("InputReadOnly")>] member inline _.InputReadOnly ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("InputReadOnly" => x)
    [<CustomOperation("ShowToday")>] member inline _.ShowToday ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowToday" => x)
    ...
    [<CustomOperation("RenderExtraFooter")>] member inline _.RenderExtraFooter ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("RenderExtraFooter", html.text x)
    [<CustomOperation("RenderExtraFooter")>] member inline _.RenderExtraFooter ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("RenderExtraFooter", html.text x)
    [<CustomOperation("OnClearClick")>] member inline _.OnClearClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnClearClick", fn)
    [<CustomOperation("OnClearClick")>] member inline _.OnClearClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnClearClick", fn)
    [<CustomOperation("OnClear")>] member inline _.OnClear ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnClear", fn)
    [<CustomOperation("OnClear")>] member inline _.OnClear ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnClear", fn)
    [<CustomOperation("OnOk")>] member inline _.OnOk ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnOk", fn)
    [<CustomOperation("OnOk")>] member inline _.OnOk ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnOk", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnOpenChange", fn)
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnOpenChange", fn)
    [<CustomOperation("OnPanelChange")>] member inline _.OnPanelChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.DateTimeChangedEventArgs<'TValue>>("OnPanelChange", fn)
    [<CustomOperation("OnPanelChange")>] member inline _.OnPanelChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.DateTimeChangedEventArgs<'TValue>>("OnPanelChange", fn)
    [<CustomOperation("DisabledDate")>] member inline _.DisabledDate ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledDate" => (System.Func<System.DateTime, System.Boolean>fn))
    [<CustomOperation("DisabledHours")>] member inline _.DisabledHours ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledHours" => (System.Func<System.DateTime, System.Int32[]>fn))
    [<CustomOperation("DisabledMinutes")>] member inline _.DisabledMinutes ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledMinutes" => (System.Func<System.DateTime, System.Int32[]>fn))
    [<CustomOperation("DisabledSeconds")>] member inline _.DisabledSeconds ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledSeconds" => (System.Func<System.DateTime, System.Int32[]>fn))
...
type DatePickerBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.DateTimeChangedEventArgs<'TValue>>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.DateTimeChangedEventArgs<'TValue>>("OnChange", fn)
...
type RangePickerBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit DatePickerBaseBuilder<'FunBlazorGeneric, 'TValue>()
    [<CustomOperation("Value")>] member inline _.Value ([<InlineIfLambda>] render: AttrRenderFragment, x: 'TValue) = render ==> ("Value" => x)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.DateRangeChangedEventArgs<'TValue>>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.DateRangeChangedEventArgs<'TValue>>("OnChange", fn)
    [<CustomOperation("DisabledDate")>] member inline _.DisabledDate ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DisabledDate" => (System.Func<System.DateTime, System.Boolean>fn))
...
type InputNumberBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<'TValue>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<'TValue>("OnChange", fn)
    [<CustomOperation("OnFocus")>] member inline _.OnFocus ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.FocusEventArgs>("OnFocus", fn)
    [<CustomOperation("OnFocus")>] member inline _.OnFocus ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.FocusEventArgs>("OnFocus", fn)
    [<CustomOperation("PlaceHolder")>] member inline _.PlaceHolder ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("PlaceHolder" => x)
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Bordered" => x)
...
type InputBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnClear")>] member inline _.OnClear ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnClear", fn)
    [<CustomOperation("OnClear")>] member inline _.OnClear ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnClear", fn)
    [<CustomOperation("AutoComplete")>] member inline _.AutoComplete ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoComplete" => x)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoFocus" => x)
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Bordered" => x)
    [<CustomOperation("BindOnInput")>] member inline _.BindOnInput ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("BindOnInput" => x)
    [<CustomOperation("DebounceMilliseconds")>] member inline _.DebounceMilliseconds ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("DebounceMilliseconds" => x)
    [<CustomOperation("DefaultValue")>] member inline _.DefaultValue ([<InlineIfLambda>] render: AttrRenderFragment, x: 'TValue) = render ==> ("DefaultValue" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    ...
    [<CustomOperation("OnMouseUp")>] member inline _.OnMouseUp ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnMouseUp", fn)
    [<CustomOperation("OnMouseUp")>] member inline _.OnMouseUp ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnMouseUp", fn)
    [<CustomOperation("OnPressEnter")>] member inline _.OnPressEnter ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs>("OnPressEnter", fn)
    [<CustomOperation("OnPressEnter")>] member inline _.OnPressEnter ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs>("OnPressEnter", fn)
    [<CustomOperation("Placeholder")>] member inline _.Placeholder ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Placeholder" => x)
    ...
    [<CustomOperation("ShowCount")>] member inline _.ShowCount ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowCount" => x)
...
type SearchBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ClassicSearchIcon")>] member inline _.ClassicSearchIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ClassicSearchIcon" => x)
    ...
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Loading" => x)
    [<CustomOperation("OnSearch")>] member inline _.OnSearch ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String>("OnSearch", fn)
    [<CustomOperation("OnSearch")>] member inline _.OnSearch ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String>("OnSearch", fn)
...
type InputPasswordBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowPassword")>] member inline _.ShowPassword ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowPassword" => x)
    [<CustomOperation("VisibilityToggle")>] member inline _.VisibilityToggle ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("VisibilityToggle" => x)

type TextAreaBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit InputBuilder<'FunBlazorGeneric, System.String>()
    [<CustomOperation("AutoSize")>] member inline _.AutoSize ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoSize" => x)
    [<CustomOperation("DefaultToEmptyString")>] member inline _.DefaultToEmptyString ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DefaultToEmptyString" => x)
    ...
    [<CustomOperation("OnResize")>] member inline _.OnResize ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.OnResizeEventArgs>("OnResize", fn)
    [<CustomOperation("OnResize")>] member inline _.OnResize ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.OnResizeEventArgs>("OnResize", fn)
...
type SelectBaseBuilder<'FunBlazorGeneric, 'TItemValue, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("BoundaryAdjustMode")>] member inline _.BoundaryAdjustMode ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.TriggerBoundaryAdjustMode) = render ==> ("BoundaryAdjustMode" => x)
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AllowClear" => x)
    [<CustomOperation("AutoClearSearchValue")>] member inline _.AutoClearSearchValue ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoClearSearchValue" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("Mode")>] member inline _.Mode ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Mode" => x)
    [<CustomOperation("EnableSearch")>] member inline _.EnableSearch ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("EnableSearch" => x)
    ...
    [<CustomOperation("Open")>] member inline _.Open ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Open" => x)
    [<CustomOperation("Placeholder")>] member inline _.Placeholder ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Placeholder" => x)
    [<CustomOperation("OnFocus")>] member inline _.OnFocus ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnFocus", fn)
    [<CustomOperation("OnFocus")>] member inline _.OnFocus ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnFocus", fn)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoFocus" => x)
    ...
    [<CustomOperation("HideSelected")>] member inline _.HideSelected ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("HideSelected" => x)
    [<CustomOperation("ValueChanged")>] member inline _.ValueChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<'TItemValue>("ValueChanged", fn)
    [<CustomOperation("ValueChanged")>] member inline _.ValueChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<'TItemValue>("ValueChanged", fn)
    [<CustomOperation("ValuesChanged")>] member inline _.ValuesChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Collections.Generic.IEnumerable<'TItemValue>>("ValuesChanged", fn)
    [<CustomOperation("ValuesChanged")>] member inline _.ValuesChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Collections.Generic.IEnumerable<'TItemValue>>("ValuesChanged", fn)
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragment) = render ==> html.renderFragment("SuffixIcon", fragment)
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, fragments) = render ==> html.renderFragment("SuffixIcon", fragment { yield! fragments })
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: string) = render ==> html.renderFragment("SuffixIcon", html.text x)
    [<CustomOperation("SuffixIcon")>] member inline _.SuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("SuffixIcon", html.text x)
    ...
    [<CustomOperation("OnClearSelected")>] member inline _.OnClearSelected ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnClearSelected", fn)
    [<CustomOperation("OnClearSelected")>] member inline _.OnClearSelected ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnClearSelected", fn)
    [<CustomOperation("OnSelectedItemChanged")>] member inline _.OnSelectedItemChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<'TItem>("OnSelectedItemChanged", fn)
    [<CustomOperation("OnSelectedItemChanged")>] member inline _.OnSelectedItemChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<'TItem>("OnSelectedItemChanged", fn)
    [<CustomOperation("OnSelectedItemsChanged")>] member inline _.OnSelectedItemsChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Collections.Generic.IEnumerable<'TItem>>("OnSelectedItemsChanged", fn)
    [<CustomOperation("OnSelectedItemsChanged")>] member inline _.OnSelectedItemsChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Collections.Generic.IEnumerable<'TItem>>("OnSelectedItemsChanged", fn)
    ...
    [<CustomOperation("LabelInValue")>] member inline _.LabelInValue ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("LabelInValue" => x)
...
type SelectBuilder<'FunBlazorGeneric, 'TItemValue, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Bordered")>] member inline _.Bordered ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Bordered" => x)
    [<CustomOperation("EnableVirtualization")>] member inline _.EnableVirtualization ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("EnableVirtualization" => x)
    ...
    [<CustomOperation("DropdownRender")>] member inline _.DropdownRender ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("DropdownRender" => (System.Func<Microsoft.AspNetCore.Components.RenderFragment, Microsoft.AspNetCore.Components.RenderFragment>fn))
    ...
    [<CustomOperation("IgnoreItemChanges")>] member inline _.IgnoreItemChanges ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IgnoreItemChanges" => x)
    ...
    [<CustomOperation("PopupContainerSelector")>] member inline _.PopupContainerSelector ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("PopupContainerSelector" => x)
    [<CustomOperation("ShowArrowIcon")>] member inline _.ShowArrowIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowArrowIcon" => x)
    [<CustomOperation("ShowSearchIcon")>] member inline _.ShowSearchIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowSearchIcon" => x)
...
type TreeSelectBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("TreeCheckable")>] member inline _.TreeCheckable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("TreeCheckable" => x)
    [<CustomOperation("PopupContainerSelector")>] member inline _.PopupContainerSelector ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("PopupContainerSelector" => x)
    [<CustomOperation("OnMouseEnter")>] member inline _.OnMouseEnter ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Action) = render ==> ("OnMouseEnter" => x)
    [<CustomOperation("OnMouseLeave")>] member inline _.OnMouseLeave ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Action) = render ==> ("OnMouseLeave" => x)
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Action) = render ==> ("OnBlur" => x)
    ...
    [<CustomOperation("DataSource")>] member inline _.DataSource ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.IEnumerable<'TItem>) = render ==> ("DataSource" => x)
    [<CustomOperation("TreeDefaultExpandAll")>] member inline _.TreeDefaultExpandAll ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("TreeDefaultExpandAll" => x)
    ...
    [<CustomOperation("ShowTreeLine")>] member inline _.ShowTreeLine ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowTreeLine" => x)
    [<CustomOperation("ShowLeafIcon")>] member inline _.ShowLeafIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowLeafIcon" => x)
    ...
    [<CustomOperation("OnNodeLoadDelayAsync")>] member inline _.OnNodeLoadDelayAsync ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnNodeLoadDelayAsync", fn)
    [<CustomOperation("OnNodeLoadDelayAsync")>] member inline _.OnNodeLoadDelayAsync ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnNodeLoadDelayAsync", fn)
...
type SliderBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("DefaultValue")>] member inline _.DefaultValue ([<InlineIfLambda>] render: AttrRenderFragment, x: 'TValue) = render ==> ("DefaultValue" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("Dots")>] member inline _.Dots ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Dots" => x)
    [<CustomOperation("Included")>] member inline _.Included ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Included" => x)
    ...
    [<CustomOperation("OnAfterChange")>] member inline _.OnAfterChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<'TValue>("OnAfterChange", fn)
    [<CustomOperation("OnAfterChange")>] member inline _.OnAfterChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<'TValue>("OnAfterChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<'TValue>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<'TValue>("OnChange", fn)
    [<CustomOperation("HasTooltip")>] member inline _.HasTooltip ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("HasTooltip" => x)
    ...
    [<CustomOperation("TooltipVisible")>] member inline _.TooltipVisible ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("TooltipVisible" => x)
...
type DescriptionsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: int) = render ==> html.renderFragment("TitleTemplate", html.text x)
    [<CustomOperation("TitleTemplate")>] member inline _.TitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, x: float) = render ==> html.renderFragment("TitleTemplate", html.text x)
    [<CustomOperation("Colon")>] member inline _.Colon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Colon" => x)
...
type DividerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Text")>] member inline _.Text ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Text" => x)
    [<CustomOperation("Plain")>] member inline _.Plain ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Plain" => x)
    ...
    [<CustomOperation("Dashed")>] member inline _.Dashed ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Dashed" => x)
...
type DrawerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Closable")>] member inline _.Closable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Closable" => x)
    [<CustomOperation("MaskClosable")>] member inline _.MaskClosable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("MaskClosable" => x)
    [<CustomOperation("Mask")>] member inline _.Mask ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Mask" => x)
...
type EmptyBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Small")>] member inline _.Small ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Small" => x)
    [<CustomOperation("Simple")>] member inline _.Simple ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Simple" => x)
...
type FormBuilder<'FunBlazorGeneric, 'TModel when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Loading" => x)
    [<CustomOperation("OnFinish")>] member inline _.OnFinish ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Forms.EditContext>("OnFinish", fn)
    [<CustomOperation("OnFinish")>] member inline _.OnFinish ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Forms.EditContext>("OnFinish", fn)
    [<CustomOperation("OnFinishFailed")>] member inline _.OnFinishFailed ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Forms.EditContext>("OnFinishFailed", fn)
    [<CustomOperation("OnFinishFailed")>] member inline _.OnFinishFailed ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Forms.EditContext>("OnFinishFailed", fn)
    [<CustomOperation("OnFieldChanged")>] member inline _.OnFieldChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Forms.FieldChangedEventArgs>("OnFieldChanged", fn)
    [<CustomOperation("OnFieldChanged")>] member inline _.OnFieldChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Forms.FieldChangedEventArgs>("OnFieldChanged", fn)
    [<CustomOperation("OnValidationRequested")>] member inline _.OnValidationRequested ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Forms.ValidationRequestedEventArgs>("OnValidationRequested", fn)
    [<CustomOperation("OnValidationRequested")>] member inline _.OnValidationRequested ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Forms.ValidationRequestedEventArgs>("OnValidationRequested", fn)
    [<CustomOperation("OnValidationStateChanged")>] member inline _.OnValidationStateChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Forms.ValidationStateChangedEventArgs>("OnValidationStateChanged", fn)
    [<CustomOperation("OnValidationStateChanged")>] member inline _.OnValidationStateChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Forms.ValidationStateChangedEventArgs>("OnValidationStateChanged", fn)
    ...
    [<CustomOperation("ValidateOnChange")>] member inline _.ValidateOnChange ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ValidateOnChange" => x)
...
type FormItemBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("WrapperColSpan")>] member inline _.WrapperColSpan ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<System.String, System.Int32>) = render ==> ("WrapperColSpan" => x)
    [<CustomOperation("WrapperColOffset")>] member inline _.WrapperColOffset ([<InlineIfLambda>] render: AttrRenderFragment, x: OneOf.OneOf<System.String, System.Int32>) = render ==> ("WrapperColOffset" => x)
    [<CustomOperation("NoStyle")>] member inline _.NoStyle ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("NoStyle" => x)
    ...
    [<CustomOperation("HasFeedback")>] member inline _.HasFeedback ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("HasFeedback" => x)
    [<CustomOperation("ShowFeedbackOnError")>] member inline _.ShowFeedbackOnError ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowFeedbackOnError" => x)
...
type ImageBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Preview")>] member inline _.Preview ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Preview" => x)
    [<CustomOperation("PreviewVisible")>] member inline _.PreviewVisible ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("PreviewVisible" => x)
    ...
    [<CustomOperation("PreviewVisibleChanged")>] member inline _.PreviewVisibleChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("PreviewVisibleChanged", fn)
    [<CustomOperation("PreviewVisibleChanged")>] member inline _.PreviewVisibleChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("PreviewVisibleChanged", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnClick", fn)
...
type InputGroupBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Compact")>] member inline _.Compact ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Compact" => x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Size" => x)
...
type SiderBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("NoTrigger")>] member inline _.NoTrigger ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("NoTrigger" => x)
    ...
    [<CustomOperation("CollapsedChanged")>] member inline _.CollapsedChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("CollapsedChanged", fn)
    [<CustomOperation("CollapsedChanged")>] member inline _.CollapsedChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("CollapsedChanged", fn)
    ...
    [<CustomOperation("OnCollapse")>] member inline _.OnCollapse ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnCollapse", fn)
    [<CustomOperation("OnBreakpoint")>] member inline _.OnBreakpoint ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnBreakpoint", fn)
    [<CustomOperation("OnBreakpoint")>] member inline _.OnBreakpoint ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnBreakpoint", fn)
    [<CustomOperation("DefaultCollapsed")>] member inline _.DefaultCollapsed ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DefaultCollapsed" => x)
...
type AntListBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Size" => x)
    [<CustomOperation("Split")>] member inline _.Split ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Split" => x)
...
type ListItemBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnClick", fn)
    [<CustomOperation("NoFlex")>] member inline _.NoFlex ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("NoFlex" => x)
...
type MentionsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Disable")>] member inline _.Disable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disable" => x)
    [<CustomOperation("Rows")>] member inline _.Rows ([<InlineIfLambda>] render: AttrRenderFragment, x: System.UInt32) = render ==> ("Rows" => x)
    [<CustomOperation("Focused")>] member inline _.Focused ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Focused" => x)
    [<CustomOperation("Readonly")>] member inline _.Readonly ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Readonly" => x)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Loading" => x)
...
type MenuBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnSubmenuClicked")>] member inline _.OnSubmenuClicked ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.SubMenu>("OnSubmenuClicked", fn)
    [<CustomOperation("OnSubmenuClicked")>] member inline _.OnSubmenuClicked ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.SubMenu>("OnSubmenuClicked", fn)
    [<CustomOperation("OnMenuItemClicked")>] member inline _.OnMenuItemClicked ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.MenuItem>("OnMenuItemClicked", fn)
    [<CustomOperation("OnMenuItemClicked")>] member inline _.OnMenuItemClicked ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.MenuItem>("OnMenuItemClicked", fn)
    [<CustomOperation("Accordion")>] member inline _.Accordion ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Accordion" => x)
    [<CustomOperation("Selectable")>] member inline _.Selectable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Selectable" => x)
    [<CustomOperation("Multiple")>] member inline _.Multiple ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Multiple" => x)
    [<CustomOperation("InlineCollapsed")>] member inline _.InlineCollapsed ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("InlineCollapsed" => x)
    ...
    [<CustomOperation("AutoCloseDropdown")>] member inline _.AutoCloseDropdown ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoCloseDropdown" => x)
    ...
    [<CustomOperation("OpenKeysChanged")>] member inline _.OpenKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String[]>("OpenKeysChanged", fn)
    [<CustomOperation("OpenKeysChanged")>] member inline _.OpenKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String[]>("OpenKeysChanged", fn)
    ...
    [<CustomOperation("OnOpenChange")>] member inline _.OnOpenChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String[]>("OnOpenChange", fn)
    ...
    [<CustomOperation("SelectedKeysChanged")>] member inline _.SelectedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String[]>("SelectedKeysChanged", fn)
    [<CustomOperation("SelectedKeysChanged")>] member inline _.SelectedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String[]>("SelectedKeysChanged", fn)
    ...
    [<CustomOperation("ShowCollapsedTooltip")>] member inline _.ShowCollapsedTooltip ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowCollapsedTooltip" => x)
    [<CustomOperation("Animation")>] member inline _.Animation ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Animation" => x)
...
type SubMenuBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Key")>] member inline _.Key ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Key" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("IsOpen")>] member inline _.IsOpen ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsOpen" => x)
    [<CustomOperation("OnTitleClick")>] member inline _.OnTitleClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnTitleClick", fn)
    [<CustomOperation("OnTitleClick")>] member inline _.OnTitleClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnTitleClick", fn)
...
type ConfirmBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnRemove")>] member inline _.OnRemove ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.ConfirmRef>("OnRemove", fn)
    [<CustomOperation("OnRemove")>] member inline _.OnRemove ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.ConfirmRef>("OnRemove", fn)
...
type DialogWrapperBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Config")>] member inline _.Config ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.DialogOptions) = render ==> ("Config" => x)
    [<CustomOperation("DestroyOnClose")>] member inline _.DestroyOnClose ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DestroyOnClose" => x)
    [<CustomOperation("Visible")>] member inline _.Visible ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Visible" => x)
    [<CustomOperation("OnBeforeDestroy")>] member inline _.OnBeforeDestroy ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.ComponentModel.CancelEventArgs>("OnBeforeDestroy", fn)
    [<CustomOperation("OnBeforeDestroy")>] member inline _.OnBeforeDestroy ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.ComponentModel.CancelEventArgs>("OnBeforeDestroy", fn)
    [<CustomOperation("OnAfterShow")>] member inline _.OnAfterShow ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnAfterShow", fn)
    [<CustomOperation("OnAfterShow")>] member inline _.OnAfterShow ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnAfterShow", fn)
    [<CustomOperation("OnAfterHide")>] member inline _.OnAfterHide ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnAfterHide", fn)
    [<CustomOperation("OnAfterHide")>] member inline _.OnAfterHide ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnAfterHide", fn)
...
type ModalBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("DragInViewport")>] member inline _.DragInViewport ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DragInViewport" => x)
    ...
    [<CustomOperation("ConfirmLoading")>] member inline _.ConfirmLoading ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ConfirmLoading" => x)
    [<CustomOperation("DestroyOnClose")>] member inline _.DestroyOnClose ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DestroyOnClose" => x)
    ...
    [<CustomOperation("OnCancel")>] member inline _.OnCancel ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnCancel", fn)
    [<CustomOperation("OnCancel")>] member inline _.OnCancel ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnCancel", fn)
    [<CustomOperation("OnOk")>] member inline _.OnOk ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnOk", fn)
    [<CustomOperation("OnOk")>] member inline _.OnOk ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnOk", fn)
    [<CustomOperation("OkButtonProps")>] member inline _.OkButtonProps ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ButtonProps) = render ==> ("OkButtonProps" => x)
    [<CustomOperation("CancelButtonProps")>] member inline _.CancelButtonProps ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.ButtonProps) = render ==> ("CancelButtonProps" => x)
    ...
    [<CustomOperation("Maximizable")>] member inline _.Maximizable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Maximizable" => x)
    ...
    [<CustomOperation("DefaultMaximized")>] member inline _.DefaultMaximized ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DefaultMaximized" => x)
...
type PageHeaderBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnBack")>] member inline _.OnBack ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnBack", fn)
    [<CustomOperation("OnBack")>] member inline _.OnBack ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnBack", fn)
...
type PaginationBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.PaginationEventArgs>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.PaginationEventArgs>("OnChange", fn)
    [<CustomOperation("HideOnSinglePage")>] member inline _.HideOnSinglePage ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("HideOnSinglePage" => x)
    [<CustomOperation("ShowSizeChanger")>] member inline _.ShowSizeChanger ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowSizeChanger" => x)
    ...
    [<CustomOperation("OnShowSizeChange")>] member inline _.OnShowSizeChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.PaginationEventArgs>("OnShowSizeChange", fn)
    [<CustomOperation("OnShowSizeChange")>] member inline _.OnShowSizeChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.PaginationEventArgs>("OnShowSizeChange", fn)
    [<CustomOperation("ShowQuickJumper")>] member inline _.ShowQuickJumper ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowQuickJumper" => x)
    ...
    [<CustomOperation("ShowTitle")>] member inline _.ShowTitle ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowTitle" => x)
    ...
    [<CustomOperation("Responsive")>] member inline _.Responsive ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Responsive" => x)
    [<CustomOperation("Simple")>] member inline _.Simple ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Simple" => x)
    ...
    [<CustomOperation("ShowLessItems")>] member inline _.ShowLessItems ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowLessItems" => x)
    [<CustomOperation("ShowPrevNextJumpers")>] member inline _.ShowPrevNextJumpers ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowPrevNextJumpers" => x)
...
type PaginationOptionsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("IsSmall")>] member inline _.IsSmall ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsSmall" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    ...
    [<CustomOperation("ChangeSize")>] member inline _.ChangeSize ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Int32>("ChangeSize", fn)
    [<CustomOperation("ChangeSize")>] member inline _.ChangeSize ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Int32>("ChangeSize", fn)
    [<CustomOperation("Current")>] member inline _.Current ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("Current" => x)
    [<CustomOperation("PageSize")>] member inline _.PageSize ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("PageSize" => x)
    [<CustomOperation("PageSizeOptions")>] member inline _.PageSizeOptions ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32[]) = render ==> ("PageSizeOptions" => x)
    [<CustomOperation("QuickGo")>] member inline _.QuickGo ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Int32>("QuickGo", fn)
    [<CustomOperation("QuickGo")>] member inline _.QuickGo ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Int32>("QuickGo", fn)
...
type ProgressBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowInfo")>] member inline _.ShowInfo ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowInfo" => x)
...
type RadioBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Value")>] member inline _.Value ([<InlineIfLambda>] render: AttrRenderFragment, x: 'TValue) = render ==> ("Value" => x)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoFocus" => x)
    [<CustomOperation("RadioButton")>] member inline _.RadioButton ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("RadioButton" => x)
    [<CustomOperation("Checked")>] member inline _.Checked ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Checked" => x)
    [<CustomOperation("Checked'")>] member inline _.Checked' ([<InlineIfLambda>] render: AttrRenderFragment, valueFn: System.Boolean * (System.Boolean -> unit)) = render ==> html.bind("Checked", valueFn)
    [<CustomOperation("DefaultChecked")>] member inline _.DefaultChecked ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DefaultChecked" => x)
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("CheckedChanged", fn)
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("CheckedChanged", fn)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("CheckedChange")>] member inline _.CheckedChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("CheckedChange", fn)
...
type RateBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AllowClear" => x)
    [<CustomOperation("AllowHalf")>] member inline _.AllowHalf ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AllowHalf" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoFocus" => x)
    ...
    [<CustomOperation("ValueChanged")>] member inline _.ValueChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Decimal>("ValueChanged", fn)
    [<CustomOperation("ValueChanged")>] member inline _.ValueChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Decimal>("ValueChanged", fn)
...
type RateItemBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("AllowHalf")>] member inline _.AllowHalf ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AllowHalf" => x)
    [<CustomOperation("OnItemHover")>] member inline _.OnItemHover ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnItemHover", fn)
    [<CustomOperation("OnItemHover")>] member inline _.OnItemHover ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnItemHover", fn)
    [<CustomOperation("OnItemClick")>] member inline _.OnItemClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("OnItemClick", fn)
    [<CustomOperation("OnItemClick")>] member inline _.OnItemClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("OnItemClick", fn)
    ...
    [<CustomOperation("HasHalf")>] member inline _.HasHalf ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("HasHalf" => x)
    [<CustomOperation("IsFocused")>] member inline _.IsFocused ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsFocused" => x)
...
type ResultBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Status")>] member inline _.Status ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Status" => x)
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Icon" => x)
    [<CustomOperation("IsShowIcon")>] member inline _.IsShowIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsShowIcon" => x)
...
type SkeletonBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Active")>] member inline _.Active ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Active" => x)
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Loading" => x)
    [<CustomOperation("Title")>] member inline _.Title ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Title" => x)
    ...
    [<CustomOperation("Avatar")>] member inline _.Avatar ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Avatar" => x)
    ...
    [<CustomOperation("Paragraph")>] member inline _.Paragraph ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Paragraph" => x)
...
type SpinBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Spinning")>] member inline _.Spinning ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Spinning" => x)
...
type StepsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ShowProgressDot")>] member inline _.ShowProgressDot ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowProgressDot" => x)
    [<CustomOperation("Direction")>] member inline _.Direction ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Direction" => x)
    ...
    [<CustomOperation("Status")>] member inline _.Status ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Status" => x)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Int32>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Int32>("OnChange", fn)
...
type TableBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnExpand")>] member inline _.OnExpand ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TableModels.RowData<'TItem>>("OnExpand", fn)
    [<CustomOperation("OnExpand")>] member inline _.OnExpand ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TableModels.RowData<'TItem>>("OnExpand", fn)
    [<CustomOperation("SortDirections")>] member inline _.SortDirections ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.SortDirection[]) = render ==> ("SortDirections" => x)
    ...
    [<CustomOperation("OnRowClick")>] member inline _.OnRowClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TableModels.RowData<'TItem>>("OnRowClick", fn)
    [<CustomOperation("OnRowClick")>] member inline _.OnRowClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TableModels.RowData<'TItem>>("OnRowClick", fn)
    [<CustomOperation("RemoteDataSource")>] member inline _.RemoteDataSource ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("RemoteDataSource" => x)
    [<CustomOperation("Responsive")>] member inline _.Responsive ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Responsive" => x)
    ...
    [<CustomOperation("TotalChanged")>] member inline _.TotalChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Int32>("TotalChanged", fn)
    [<CustomOperation("TotalChanged")>] member inline _.TotalChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Int32>("TotalChanged", fn)
    ...
    [<CustomOperation("PageIndexChanged")>] member inline _.PageIndexChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Int32>("PageIndexChanged", fn)
    [<CustomOperation("PageIndexChanged")>] member inline _.PageIndexChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Int32>("PageIndexChanged", fn)
    [<CustomOperation("PageSize")>] member inline _.PageSize ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("PageSize" => x)
    ...
    [<CustomOperation("PageSizeChanged")>] member inline _.PageSizeChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Int32>("PageSizeChanged", fn)
    [<CustomOperation("PageSizeChanged")>] member inline _.PageSizeChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Int32>("PageSizeChanged", fn)
    [<CustomOperation("OnPageIndexChange")>] member inline _.OnPageIndexChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.PaginationEventArgs>("OnPageIndexChange", fn)
    [<CustomOperation("OnPageIndexChange")>] member inline _.OnPageIndexChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.PaginationEventArgs>("OnPageIndexChange", fn)
    [<CustomOperation("OnPageSizeChange")>] member inline _.OnPageSizeChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.PaginationEventArgs>("OnPageSizeChange", fn)
    [<CustomOperation("OnPageSizeChange")>] member inline _.OnPageSizeChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.PaginationEventArgs>("OnPageSizeChange", fn)
    ...
    [<CustomOperation("SelectedRowsChanged")>] member inline _.SelectedRowsChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Collections.Generic.IEnumerable<'TItem>>("SelectedRowsChanged", fn)
    [<CustomOperation("SelectedRowsChanged")>] member inline _.SelectedRowsChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Collections.Generic.IEnumerable<'TItem>>("SelectedRowsChanged", fn)
...
type ReuseTabsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("HidePages")>] member inline _.HidePages ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("HidePages" => x)
...
type TabPaneBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("ForceRender")>] member inline _.ForceRender ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ForceRender" => x)
    [<CustomOperation("Key")>] member inline _.Key ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Key" => x)
...
type TabsBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ActiveKeyChanged")>] member inline _.ActiveKeyChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String>("ActiveKeyChanged", fn)
    [<CustomOperation("ActiveKeyChanged")>] member inline _.ActiveKeyChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String>("ActiveKeyChanged", fn)
    [<CustomOperation("Animated")>] member inline _.Animated ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Animated" => x)
    [<CustomOperation("InkBarAnimated")>] member inline _.InkBarAnimated ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("InkBarAnimated" => x)
    ...
    [<CustomOperation("DefaultActiveKey")>] member inline _.DefaultActiveKey ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("DefaultActiveKey" => x)
    [<CustomOperation("HideAdd")>] member inline _.HideAdd ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("HideAdd" => x)
    [<CustomOperation("Size")>] member inline _.Size ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.TabSize) = render ==> ("Size" => x)
    ...
    [<CustomOperation("OnClose")>] member inline _.OnClose ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String>("OnClose", fn)
    [<CustomOperation("OnClose")>] member inline _.OnClose ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String>("OnClose", fn)
    [<CustomOperation("OnAddClick")>] member inline _.OnAddClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnAddClick", fn)
    [<CustomOperation("OnAddClick")>] member inline _.OnAddClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnAddClick", fn)
    [<CustomOperation("AfterTabCreated")>] member inline _.AfterTabCreated ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String>("AfterTabCreated", fn)
    [<CustomOperation("AfterTabCreated")>] member inline _.AfterTabCreated ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String>("AfterTabCreated", fn)
    [<CustomOperation("OnTabClick")>] member inline _.OnTabClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String>("OnTabClick", fn)
    [<CustomOperation("OnTabClick")>] member inline _.OnTabClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String>("OnTabClick", fn)
    [<CustomOperation("Draggable")>] member inline _.Draggable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Draggable" => x)
    [<CustomOperation("Centered")>] member inline _.Centered ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Centered" => x)
...
type TagBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Closable")>] member inline _.Closable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Closable" => x)
    [<CustomOperation("Checkable")>] member inline _.Checkable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Checkable" => x)
    [<CustomOperation("Checked")>] member inline _.Checked ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Checked" => x)
    [<CustomOperation("Checked'")>] member inline _.Checked' ([<InlineIfLambda>] render: AttrRenderFragment, valueFn: System.Boolean * (System.Boolean -> unit)) = render ==> html.bind("Checked", valueFn)
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Boolean>("CheckedChanged", fn)
    [<CustomOperation("CheckedChanged")>] member inline _.CheckedChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Boolean>("CheckedChanged", fn)
    ...
    [<CustomOperation("PresetColor")>] member inline _.PresetColor ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Nullable<AntDesign.PresetColor>) = render ==> ("PresetColor" => x)
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Icon" => x)
    [<CustomOperation("NoAnimation")>] member inline _.NoAnimation ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("NoAnimation" => x)
    [<CustomOperation("OnClose")>] member inline _.OnClose ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnClose", fn)
    [<CustomOperation("OnClose")>] member inline _.OnClose ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnClose", fn)
    [<CustomOperation("OnClosing")>] member inline _.OnClosing ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.CloseEventArgs<Microsoft.AspNetCore.Components.Web.MouseEventArgs>>("OnClosing", fn)
    [<CustomOperation("OnClosing")>] member inline _.OnClosing ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.CloseEventArgs<Microsoft.AspNetCore.Components.Web.MouseEventArgs>>("OnClosing", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnClick", fn)
    [<CustomOperation("Visible")>] member inline _.Visible ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Visible" => x)
...
type TransferBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("ShowSearch")>] member inline _.ShowSearch ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowSearch" => x)
    [<CustomOperation("ShowSelectAll")>] member inline _.ShowSelectAll ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowSelectAll" => x)
    ...
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TransferChangeArgs>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TransferChangeArgs>("OnChange", fn)
    [<CustomOperation("OnScroll")>] member inline _.OnScroll ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TransferScrollArgs>("OnScroll", fn)
    [<CustomOperation("OnScroll")>] member inline _.OnScroll ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TransferScrollArgs>("OnScroll", fn)
    [<CustomOperation("OnSearch")>] member inline _.OnSearch ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TransferSearchArgs>("OnSearch", fn)
    [<CustomOperation("OnSearch")>] member inline _.OnSearch ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TransferSearchArgs>("OnSearch", fn)
    [<CustomOperation("OnSelectChange")>] member inline _.OnSelectChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TransferSelectChangeArgs>("OnSelectChange", fn)
    [<CustomOperation("OnSelectChange")>] member inline _.OnSelectChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TransferSelectChangeArgs>("OnSelectChange", fn)
...
type TreeBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("ShowExpand")>] member inline _.ShowExpand ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowExpand" => x)
    [<CustomOperation("ShowLine")>] member inline _.ShowLine ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowLine" => x)
    [<CustomOperation("ShowIcon")>] member inline _.ShowIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowIcon" => x)
    [<CustomOperation("BlockNode")>] member inline _.BlockNode ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("BlockNode" => x)
    [<CustomOperation("Draggable")>] member inline _.Draggable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Draggable" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("ShowLeafIcon")>] member inline _.ShowLeafIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowLeafIcon" => x)
    ...
    [<CustomOperation("SelectedKeyChanged")>] member inline _.SelectedKeyChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String>("SelectedKeyChanged", fn)
    [<CustomOperation("SelectedKeyChanged")>] member inline _.SelectedKeyChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String>("SelectedKeyChanged", fn)
    ...
    [<CustomOperation("SelectedNodeChanged")>] member inline _.SelectedNodeChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeNode<'TItem>>("SelectedNodeChanged", fn)
    [<CustomOperation("SelectedNodeChanged")>] member inline _.SelectedNodeChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeNode<'TItem>>("SelectedNodeChanged", fn)
    ...
    [<CustomOperation("SelectedDataChanged")>] member inline _.SelectedDataChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<'TItem>("SelectedDataChanged", fn)
    [<CustomOperation("SelectedDataChanged")>] member inline _.SelectedDataChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<'TItem>("SelectedDataChanged", fn)
    [<CustomOperation("SelectedKeys")>] member inline _.SelectedKeys ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String[]) = render ==> ("SelectedKeys" => x)
    [<CustomOperation("SelectedKeys'")>] member inline _.SelectedKeys' ([<InlineIfLambda>] render: AttrRenderFragment, valueFn: System.String[] * (System.String[] -> unit)) = render ==> html.bind("SelectedKeys", valueFn)
    [<CustomOperation("SelectedKeysChanged")>] member inline _.SelectedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String[]>("SelectedKeysChanged", fn)
    [<CustomOperation("SelectedKeysChanged")>] member inline _.SelectedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String[]>("SelectedKeysChanged", fn)
    ...
    [<CustomOperation("CheckedKeysChanged")>] member inline _.CheckedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String[]>("CheckedKeysChanged", fn)
    [<CustomOperation("CheckedKeysChanged")>] member inline _.CheckedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String[]>("CheckedKeysChanged", fn)
    ...
    [<CustomOperation("MatchedStyle")>] member inline _.MatchedStyle ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("MatchedStyle" => x)
    [<CustomOperation("MatchedClass")>] member inline _.MatchedClass ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("MatchedClass" => x)
    [<CustomOperation("HideUnmatched")>] member inline _.HideUnmatched ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("HideUnmatched" => x)
    [<CustomOperation("DataSource")>] member inline _.DataSource ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.IEnumerable<'TItem>) = render ==> ("DataSource" => x)
    [<CustomOperation("TitleExpression")>] member inline _.TitleExpression ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("TitleExpression" => (System.Func<AntDesign.TreeNode<'TItem>, System.String>fn))
    [<CustomOperation("KeyExpression")>] member inline _.KeyExpression ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("KeyExpression" => (System.Func<AntDesign.TreeNode<'TItem>, System.String>fn))
    [<CustomOperation("IconExpression")>] member inline _.IconExpression ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("IconExpression" => (System.Func<AntDesign.TreeNode<'TItem>, System.String>fn))
    ...
    [<CustomOperation("OnNodeLoadDelayAsync")>] member inline _.OnNodeLoadDelayAsync ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnNodeLoadDelayAsync", fn)
    [<CustomOperation("OnNodeLoadDelayAsync")>] member inline _.OnNodeLoadDelayAsync ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnNodeLoadDelayAsync", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnClick", fn)
    [<CustomOperation("OnDblClick")>] member inline _.OnDblClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnDblClick", fn)
    [<CustomOperation("OnDblClick")>] member inline _.OnDblClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnDblClick", fn)
    [<CustomOperation("OnContextMenu")>] member inline _.OnContextMenu ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnContextMenu", fn)
    [<CustomOperation("OnContextMenu")>] member inline _.OnContextMenu ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnContextMenu", fn)
    [<CustomOperation("OnCheck")>] member inline _.OnCheck ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnCheck", fn)
    [<CustomOperation("OnCheck")>] member inline _.OnCheck ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnCheck", fn)
    [<CustomOperation("OnSelect")>] member inline _.OnSelect ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnSelect", fn)
    [<CustomOperation("OnSelect")>] member inline _.OnSelect ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnSelect", fn)
    [<CustomOperation("OnUnselect")>] member inline _.OnUnselect ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnUnselect", fn)
    [<CustomOperation("OnUnselect")>] member inline _.OnUnselect ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnUnselect", fn)
    [<CustomOperation("OnExpandChanged")>] member inline _.OnExpandChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnExpandChanged", fn)
    [<CustomOperation("OnExpandChanged")>] member inline _.OnExpandChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnExpandChanged", fn)
    ...
    [<CustomOperation("OnDragStart")>] member inline _.OnDragStart ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnDragStart", fn)
    [<CustomOperation("OnDragStart")>] member inline _.OnDragStart ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnDragStart", fn)
    [<CustomOperation("OnDragEnter")>] member inline _.OnDragEnter ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnDragEnter", fn)
    [<CustomOperation("OnDragEnter")>] member inline _.OnDragEnter ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnDragEnter", fn)
    [<CustomOperation("OnDragLeave")>] member inline _.OnDragLeave ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnDragLeave", fn)
    [<CustomOperation("OnDragLeave")>] member inline _.OnDragLeave ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnDragLeave", fn)
    [<CustomOperation("OnDrop")>] member inline _.OnDrop ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnDrop", fn)
    [<CustomOperation("OnDrop")>] member inline _.OnDrop ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnDrop", fn)
    [<CustomOperation("OnDragEnd")>] member inline _.OnDragEnd ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.TreeEventArgs<'TItem>>("OnDragEnd", fn)
    [<CustomOperation("OnDragEnd")>] member inline _.OnDragEnd ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.TreeEventArgs<'TItem>>("OnDragEnd", fn)
    [<CustomOperation("DefaultExpandAll")>] member inline _.DefaultExpandAll ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DefaultExpandAll" => x)
    [<CustomOperation("DefaultExpandParent")>] member inline _.DefaultExpandParent ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DefaultExpandParent" => x)
    ...
    [<CustomOperation("ExpandedKeysChanged")>] member inline _.ExpandedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String[]>("ExpandedKeysChanged", fn)
    [<CustomOperation("ExpandedKeysChanged")>] member inline _.ExpandedKeysChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String[]>("ExpandedKeysChanged", fn)
    [<CustomOperation("OnExpand")>] member inline _.OnExpand ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.ValueTuple<System.String[], AntDesign.TreeNode<'TItem>, System.Boolean>>("OnExpand", fn)
    [<CustomOperation("OnExpand")>] member inline _.OnExpand ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.ValueTuple<System.String[], AntDesign.TreeNode<'TItem>, System.Boolean>>("OnExpand", fn)
    [<CustomOperation("AutoExpandParent")>] member inline _.AutoExpandParent ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoExpandParent" => x)
...
type TreeNodeBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Loading")>] member inline _.Loading ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Loading" => x)
    [<CustomOperation("IsLeaf")>] member inline _.IsLeaf ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("IsLeaf" => x)
    ...
    [<CustomOperation("Checked")>] member inline _.Checked ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Checked" => x)
    [<CustomOperation("Indeterminate")>] member inline _.Indeterminate ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Indeterminate" => x)
    [<CustomOperation("DisableCheckbox")>] member inline _.DisableCheckbox ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("DisableCheckbox" => x)
    [<CustomOperation("Draggable")>] member inline _.Draggable ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Draggable" => x)
    [<CustomOperation("Icon")>] member inline _.Icon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Icon" => x)
...
type UploadBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Directory")>] member inline _.Directory ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Directory" => x)
    [<CustomOperation("Multiple")>] member inline _.Multiple ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Multiple" => x)
    [<CustomOperation("Accept")>] member inline _.Accept ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("Accept" => x)
    [<CustomOperation("ShowUploadList")>] member inline _.ShowUploadList ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowUploadList" => x)
    ...
    [<CustomOperation("FileListChanged")>] member inline _.FileListChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Collections.Generic.List<AntDesign.UploadFileItem>>("FileListChanged", fn)
    [<CustomOperation("FileListChanged")>] member inline _.FileListChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Collections.Generic.List<AntDesign.UploadFileItem>>("FileListChanged", fn)
    ...
    [<CustomOperation("OnSingleCompleted")>] member inline _.OnSingleCompleted ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.UploadInfo>("OnSingleCompleted", fn)
    [<CustomOperation("OnSingleCompleted")>] member inline _.OnSingleCompleted ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.UploadInfo>("OnSingleCompleted", fn)
    [<CustomOperation("OnCompleted")>] member inline _.OnCompleted ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.UploadInfo>("OnCompleted", fn)
    [<CustomOperation("OnCompleted")>] member inline _.OnCompleted ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.UploadInfo>("OnCompleted", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.UploadInfo>("OnChange", fn)
    [<CustomOperation("OnChange")>] member inline _.OnChange ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.UploadInfo>("OnChange", fn)
    ...
    [<CustomOperation("OnPreview")>] member inline _.OnPreview ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.UploadFileItem>("OnPreview", fn)
    [<CustomOperation("OnPreview")>] member inline _.OnPreview ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.UploadFileItem>("OnPreview", fn)
    [<CustomOperation("OnDownload")>] member inline _.OnDownload ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.UploadFileItem>("OnDownload", fn)
    [<CustomOperation("OnDownload")>] member inline _.OnDownload ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.UploadFileItem>("OnDownload", fn)
    [<CustomOperation("ShowButton")>] member inline _.ShowButton ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowButton" => x)
    [<CustomOperation("Drag")>] member inline _.Drag ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Drag" => x)
...
type WatermarkBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Scrolling")>] member inline _.Scrolling ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Scrolling" => x)
    ...
    [<CustomOperation("Repeat")>] member inline _.Repeat ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Repeat" => x)
    [<CustomOperation("Grayscale")>] member inline _.Grayscale ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Grayscale" => x)
...
type PaginationPagerBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Active")>] member inline _.Active ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Active" => x)
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.Int32>("OnClick", fn)
    [<CustomOperation("OnClick")>] member inline _.OnClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.Int32>("OnClick", fn)
    [<CustomOperation("OnKeyPress")>] member inline _.OnKeyPress ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.ValueTuple<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs, System.Action>>("OnKeyPress", fn)
    [<CustomOperation("OnKeyPress")>] member inline _.OnKeyPress ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.ValueTuple<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs, System.Action>>("OnKeyPress", fn)
    [<CustomOperation("ItemRender")>] member inline _.ItemRender ([<InlineIfLambda>] render: AttrRenderFragment, fn: AntDesign.PaginationItemRenderContext -> NodeRenderFragment) = render ==> html.renderFragment("ItemRender", fn)
    [<CustomOperation("UnmatchedAttributes")>] member inline _.UnmatchedAttributes ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.Dictionary<System.String, System.Object>) = render ==> ("UnmatchedAttributes" => x)
...
type SelectContentBuilder<'FunBlazorGeneric, 'TItemValue, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.FocusEventArgs>("OnBlur", fn)
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.FocusEventArgs>("OnBlur", fn)
    [<CustomOperation("OnClearClick")>] member inline _.OnClearClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnClearClick", fn)
    [<CustomOperation("OnClearClick")>] member inline _.OnClearClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnClearClick", fn)
    [<CustomOperation("OnRemoveSelected")>] member inline _.OnRemoveSelected ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.Select.Internal.SelectOptionItem<'TItemValue, 'TItem>>("OnRemoveSelected", fn)
    [<CustomOperation("OnRemoveSelected")>] member inline _.OnRemoveSelected ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.Select.Internal.SelectOptionItem<'TItemValue, 'TItem>>("OnRemoveSelected", fn)
    [<CustomOperation("SearchValue")>] member inline _.SearchValue ([<InlineIfLambda>] render: AttrRenderFragment, x: System.String) = render ==> ("SearchValue" => x)
    [<CustomOperation("SearchDebounceMilliseconds")>] member inline _.SearchDebounceMilliseconds ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Int32) = render ==> ("SearchDebounceMilliseconds" => x)
...
type OverlayBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntDomComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("OnOverlayMouseEnter")>] member inline _.OnOverlayMouseEnter ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnOverlayMouseEnter", fn)
    [<CustomOperation("OnOverlayMouseEnter")>] member inline _.OnOverlayMouseEnter ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnOverlayMouseEnter", fn)
    [<CustomOperation("OnOverlayMouseLeave")>] member inline _.OnOverlayMouseLeave ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnOverlayMouseLeave", fn)
    [<CustomOperation("OnOverlayMouseLeave")>] member inline _.OnOverlayMouseLeave ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnOverlayMouseLeave", fn)
    [<CustomOperation("OnOverlayMouseUp")>] member inline _.OnOverlayMouseUp ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnOverlayMouseUp", fn)
    [<CustomOperation("OnOverlayMouseUp")>] member inline _.OnOverlayMouseUp ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnOverlayMouseUp", fn)
    [<CustomOperation("OnShow")>] member inline _.OnShow ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnShow", fn)
    [<CustomOperation("OnShow")>] member inline _.OnShow ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnShow", fn)
    [<CustomOperation("OnHide")>] member inline _.OnHide ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnHide", fn)
    [<CustomOperation("OnHide")>] member inline _.OnHide ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnHide", fn)
...
type DatePickerInputBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Disabled")>] member inline _.Disabled ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Disabled" => x)
    [<CustomOperation("AutoFocus")>] member inline _.AutoFocus ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AutoFocus" => x)
    [<CustomOperation("ShowSuffixIcon")>] member inline _.ShowSuffixIcon ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowSuffixIcon" => x)
    [<CustomOperation("ShowTime")>] member inline _.ShowTime ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("ShowTime" => x)
    ...
    [<CustomOperation("Onfocus")>] member inline _.Onfocus ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("Onfocus", fn)
    [<CustomOperation("Onfocus")>] member inline _.Onfocus ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("Onfocus", fn)
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnBlur", fn)
    [<CustomOperation("OnBlur")>] member inline _.OnBlur ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnBlur", fn)
    [<CustomOperation("Onfocusout")>] member inline _.Onfocusout ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("Onfocusout", fn)
    [<CustomOperation("Onfocusout")>] member inline _.Onfocusout ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("Onfocusout", fn)
    [<CustomOperation("OnKeyUp")>] member inline _.OnKeyUp ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs>("OnKeyUp", fn)
    [<CustomOperation("OnKeyUp")>] member inline _.OnKeyUp ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs>("OnKeyUp", fn)
    [<CustomOperation("OnKeyDown")>] member inline _.OnKeyDown ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs>("OnKeyDown", fn)
    [<CustomOperation("OnKeyDown")>] member inline _.OnKeyDown ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.KeyboardEventArgs>("OnKeyDown", fn)
    ...
    [<CustomOperation("OnInput")>] member inline _.OnInput ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.ChangeEventArgs>("OnInput", fn)
    [<CustomOperation("AllowClear")>] member inline _.AllowClear ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("AllowClear" => x)
    [<CustomOperation("OnClickClear")>] member inline _.OnClickClear ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnClickClear", fn)
    [<CustomOperation("OnClickClear")>] member inline _.OnClickClear ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnClickClear", fn)
    [<CustomOperation("OnSuffixIconClick")>] member inline _.OnSuffixIconClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback("OnSuffixIconClick", fn)
    [<CustomOperation("OnSuffixIconClick")>] member inline _.OnSuffixIconClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask("OnSuffixIconClick", fn)
...
type FormProviderBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("OnFormFinish")>] member inline _.OnFormFinish ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.FormProviderFinishEventArgs>("OnFormFinish", fn)
    [<CustomOperation("OnFormFinish")>] member inline _.OnFormFinish ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.FormProviderFinishEventArgs>("OnFormFinish", fn)
...
type ResizeObserverBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit AntComponentBaseBuilder<'FunBlazorGeneric>()
    [<CustomOperation("OnResize")>] member inline _.OnResize ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<AntDesign.JsInterop.DomRect>("OnResize", fn)
    [<CustomOperation("OnResize")>] member inline _.OnResize ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<AntDesign.JsInterop.DomRect>("OnResize", fn)
...
type TreeNodeCheckboxBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit ComponentWithDomAndChildAttrBuilder<'FunBlazorGeneric>()
    [<CustomOperation("OnCheckBoxClick")>] member inline _.OnCheckBoxClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnCheckBoxClick", fn)
    [<CustomOperation("OnCheckBoxClick")>] member inline _.OnCheckBoxClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnCheckBoxClick", fn)

type TreeNodeSwitcherBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit ComponentWithDomAndChildAttrBuilder<'FunBlazorGeneric>()
    [<CustomOperation("OnSwitcherClick")>] member inline _.OnSwitcherClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnSwitcherClick", fn)
    [<CustomOperation("OnSwitcherClick")>] member inline _.OnSwitcherClick ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<Microsoft.AspNetCore.Components.Web.MouseEventArgs>("OnSwitcherClick", fn)
...
type ReusePagesBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    inherit ComponentWithDomAndChildAttrBuilder<'FunBlazorGeneric>()
    [<CustomOperation("Reuse")>] member inline _.Reuse ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Boolean) = render ==> ("Reuse" => x)
    [<CustomOperation("Classes")>] member inline _.Classes ([<InlineIfLambda>] render: AttrRenderFragment, x: string list) = render ==> html.classes x
    [<CustomOperation("Styles")>] member inline _.Styles ([<InlineIfLambda>] render: AttrRenderFragment, x: (string * string) list) = render ==> html.styles x
    ...
    [<CustomOperation("ActivedUriChanged")>] member inline _.ActivedUriChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callback<System.String>("ActivedUriChanged", fn)
    [<CustomOperation("ActivedUriChanged")>] member inline _.ActivedUriChanged ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> html.callbackTask<System.String>("ActivedUriChanged", fn)
