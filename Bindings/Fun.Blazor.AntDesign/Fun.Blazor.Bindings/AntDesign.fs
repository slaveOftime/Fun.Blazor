...
type DatePickerPanelBaseBuilder<'FunBlazorGeneric, 'TValue when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("ChangePickerType")>] member inline _.ChangePickerType ([<InlineIfLambda>] render: AttrRenderFragment, fn) = render ==> ("ChangePickerType" => (System.Action<AntDesign.DatePickerType, System.Int32>fn))
...
type CalendarBuilder<'FunBlazorGeneric when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("Mode")>] member inline _.Mode ([<InlineIfLambda>] render: AttrRenderFragment, x: AntDesign.CalendarMode) = render ==> ("Mode" => x)
...
type TableBuilder<'FunBlazorGeneric, 'TItem when 'FunBlazorGeneric :> Microsoft.AspNetCore.Components.IComponent>() =
    ...
    [<CustomOperation("DataSource")>] member inline _.DataSource ([<InlineIfLambda>] render: AttrRenderFragment, x: System.Collections.Generic.IEnumerable<'TItem>) = render ==> ("DataSource" => x)
    [<CustomOperation("ChildContent")>] member inline _.ChildContent ([<InlineIfLambda>] render: AttrRenderFragment, fn: 'TItem -> NodeRenderFragment) = render ==> html.renderFragment("ChildContent", fn)
    [<CustomOperation("GroupTitleTemplate")>] member inline _.GroupTitleTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fn: AntDesign.TableModels.GroupResult<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("GroupTitleTemplate", fn)
    [<CustomOperation("GroupFooterTemplate")>] member inline _.GroupFooterTemplate ([<InlineIfLambda>] render: AttrRenderFragment, fn: AntDesign.TableModels.GroupResult<'TItem> -> NodeRenderFragment) = render ==> html.renderFragment("GroupFooterTemplate", fn)
    ...
    [<CustomOperation("AutoHeight")>] member inline _.AutoHeight ([<InlineIfLambda>] render: AttrRenderFragment, ?x: bool) = render ==> ("AutoHeight" => (defaultArg x true))
    ...
    [<CustomOperation("OnSelectAll")>] member inline _.OnSelectAll ([<InlineIfLambda>] render: AttrRenderFragment, fn: System.Boolean -> unit) = render ==> html.callback("OnSelectAll", fn)
    [<CustomOperation("OnSelectAll")>] member inline _.OnSelectAll ([<InlineIfLambda>] render: AttrRenderFragment, fn: System.Boolean -> Task<unit>) = render ==> html.callbackTask("OnSelectAll", fn)
