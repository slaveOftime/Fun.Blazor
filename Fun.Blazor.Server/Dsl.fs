...
#if !NET6_0
[<Obsolete "Please use html.blazor instead">]
#endif
...
type html with
    ...
    [<Obsolete "Please use html.blazor instead">]
#endif
    static member rootComp<'T when 'T :> IComponent>(ctx, ?renderMode) = rootComp<'T> ctx (defaultArg renderMode RenderMode.ServerPrerendered)
