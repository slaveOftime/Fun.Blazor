...
```bash
dotnet add package Fun.Blazor.AntDesign --version 1.1.0
dotnet add package Fun.Blazor.ApexCharts --version 5.0.0
...
dotnet add package Fun.Blazor.Microsoft.FluentUI --version 4.11.0
...
dotnet add package Fun.Blazor.Radzen --version 5.7.2
```
